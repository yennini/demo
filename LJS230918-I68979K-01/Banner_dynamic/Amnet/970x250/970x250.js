...
p.nominalBounds = new cjs.Rectangle(0.7,0.4,297.2,20.700000000000003);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(405.1,399.75,1.4591,1.4591,0,0,0,82,9.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(52,100,0.5,0.5);
	...
	this.instance_3.setTransform(693.05,224.25,0.8309,0.8309,0,0,0,268.9,86.4);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90).to({_off:false},0).to({_off:true},76).wait(178).to({_off:false,regY:86.2,scaleX:0.6735,scaleY:0.6735,x:673.8,y:186.35},0).wait(90));
	...
	this.instance_5.setTransform(176.95,216.85,0.5117,0.5117,0,0,0,261.4,171.5);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(83).to({_off:false},0).to({startPosition:49},83).to({_off:true},1).wait(88).to({_off:false,regX:581.7,regY:265.5,scaleX:0.5825,scaleY:0.5825,x:333.9,y:254.6,startPosition:0},0).to({startPosition:49},85).to({regX:581.8,regY:265.9,scaleX:0.5249,scaleY:0.5249,x:311.05,y:265.35},8).wait(86));
...
p.nominalBounds = new cjs.Rectangle(-433.1,4.5,1947.5,444.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(440.95,124.7,1,1,0,0,0,492.4,226);
