...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(169.8588,10.7609,0.9789,0.9789);
	...
	this.shape_1.setTransform(138.4602,10.7364,0.9789,0.9789);
	...
	this.shape_2.setTransform(105.8624,10.7119,0.9789,0.9789);
	...
	this.shape_3.setTransform(74.9288,10.7364,0.9789,0.9789);
	...
	this.shape_4.setTransform(43.1141,10.663,0.9789,0.9789);
	...
	this.shape_5.setTransform(11.5442,11.079,0.9789,0.9789);
	...
	this.shape_6.setTransform(291.5745,14.4537,1.308,1.308);
	...
	this.shape_7.setTransform(276.3762,14.1267,1.308,1.308);
	...
	this.shape_8.setTransform(267.8745,14.1267,1.308,1.308);
	...
	this.shape_9.setTransform(259.3988,14.1267,1.308,1.308);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgJAKQAKgEACgIIgBAAQgGAAABgGQABgHAGAAQAHAAgBALQgDANgOAHg");
	this.shape_10.setTransform(251.6992,19.2932,1.308,1.308);
	...
	this.shape_11.setTransform(246.0317,14.1267,1.308,1.308);
	...
	this.shape_12.setTransform(237.1209,14.1267,1.308,1.308);
	...
	this.shape_13.setTransform(222.2203,13.9632,1.308,1.308);
	...
	this.shape_14.setTransform(208.0617,14.0286,1.308,1.308);
	...
	this.shape_15.setTransform(193.1183,13.7344,1.308,1.308);
...
p.nominalBounds = new cjs.Rectangle(0.7,0.5,297.2,20.8);
...
if (reversed == null) { reversed = false; }
	...
	// rect
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-601.3,-0.5,-255.1,-0.5).s().p("AjwJQIF5yXIBogIIlKSfg");
	this.shape.setTransform(601.425,59.25);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-553.3,-0.5,-207.1,-0.5).s().p("ArQJOIF6yWIQngHIlLSfg");
	this.shape_1.setTransform(553.425,59.25);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-511,-0.5,-164.7,-0.5).s().p("Ax4JMIF6yVId3gGIlMSfg");
	this.shape_2.setTransform(511.075,59.25);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-473.9,-0.5,-127.7,-0.5).s().p("A3qJLIF6yVMApcgAFIlMSfg");
	this.shape_3.setTransform(474,59.25);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-441.8,-0.5,-95.5,-0.5).s().p("A8sJLIF6yXMAzfgADIlMSfg");
	this.shape_4.setTransform(441.85,59.25);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-414.2,-0.5,-68,-0.5).s().p("EghAAJKIF6yXMA8HgACIlMSfg");
	this.shape_5.setTransform(414.3,59.25);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-390.9,-0.5,-44.6,-0.5).s().p("EgkpAJJIF6yWMBDZgACIlMSfg");
	this.shape_6.setTransform(390.975,59.25);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-371.4,-0.5,-25.2,-0.5).s().p("EgnrAJJIF6yXMBJdgABIlLSfg");
	this.shape_7.setTransform(371.525,59.25);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-355.5,-0.5,-9.3,-0.5).s().p("EgqKAJIIF6yWMBOcgABIlMSfg");
	this.shape_8.setTransform(355.6,59.25);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-342.8,-0.5,3.5,-0.5).s().p("EgsKAJIIF6yXMBSbAAAIlMSfg");
	this.shape_9.setTransform(342.85,59.25);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-332.8,-0.5,13.4,-0.5).s().p("EgttAJHIF6yWMBVhAAAIlLSfg");
	this.shape_10.setTransform(332.925,59.25);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-325.4,-0.5,20.9,-0.5).s().p("Egu4AJHIF6yWMBX3AAAIlMSfg");
	this.shape_11.setTransform(325.475,59.25);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-320,-0.4,26.2,-0.4).s().p("EgvtAJHIF6yWMBZhAAAIlLSfg");
	this.shape_12.setTransform(320.125,59.225);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-316.4,-0.4,29.8,-0.4).s().p("EgwRAJHIF6yWMBapAAAIlLSfg");
	this.shape_13.setTransform(316.525,59.225);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-314.3,-0.4,32,-0.4).s().p("EgwnAJHIF6yWMBbVAAAIlMSfg");
	this.shape_14.setTransform(314.375,59.225);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-313.2,-0.4,33.1,-0.4).s().p("EgwyAJHIF6yWMBbrAAAIlMSfg");
	this.shape_15.setTransform(313.25,59.225);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-312.7,-0.4,33.5,-0.4).s().p("Egw2AJHIF6yWMBbzAAAIlLSfg");
	this.shape_16.setTransform(312.825,59.225);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.lf(["#512678","#8D295A","#C02F75"],[0.004,0.545,1],-312.7,-0.4,33.6,-0.4).s().p("Egw3AJHIF6yWMBb1AAAIlMSfg");
	this.shape_17.setTransform(312.775,59.225);
...
p.nominalBounds = new cjs.Rectangle(0,0,625.6,118.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(270.55,49.4,1,1,0,0,0,144.8,15.6);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(8).to({_off:false},0).to({y:59.15,alpha:1,startPosition:37},29,cjs.Ease.cubicOut).wait(53));

	// sb_bg_sentra
	this.instance_1 = new lib.sb_bgsentra("synched",0);
	this.instance_1.setTransform(471.5,58.6,0.0836,1,0,0,0,223.6,23.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:223.8,scaleX:1,x:223.8,y:58.65,startPosition:37},37,cjs.Ease.cubicOut).wait(53));

	// sb_tt_all
	this.instance_2 = new lib.sb_ttall("synched",0);
	this.instance_2.setTransform(270.65,3.4,1,1,0,0,0,141.6,3.4);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({y:16.4,alpha:1,startPosition:37},37,cjs.Ease.cubicOut).wait(53));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,491.7,82.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(498.8,17.3,1,1,0,0,0,137.2,10.9);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:161.45,alpha:1},23,cjs.Ease.cubicOut).wait(67));

	// sb_bg_set
	this.instance_1 = new lib.sb_bgset("synched",0);
	this.instance_1.setTransform(533.3,16.5,1,1,0,0,0,174.4,16.5);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:174.4,y:16.55,alpha:0.8984},23,cjs.Ease.quartOut).wait(67));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,707.8,33.1);
...
p.nominalBounds = new cjs.Rectangle(0,0,671.9,207.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(926.2,83.65,1,1,0,0,0,353.9,16.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_tt_free
	this.instance_1 = new lib.an_ttfree("synched",0);
	this.instance_1.setTransform(883.65,26.7,1,1,0,0,0,89.1,40.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_tt_happy
	this.instance_2 = new lib.an_tthappy("synched",0);
	this.instance_2.setTransform(580.75,31.05,1,1,0,0,0,335.9,103.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_ttsentra
	this.instance_3 = new lib.an_ttsentra("synched",0);
	this.instance_3.setTransform(335.65,21.6,1,1,0,0,0,245.8,41.1);
...
p.nominalBounds = new cjs.Rectangle(89.9,-72.7,1190.1999999999998,206.60000000000002);
...
p.nominalBounds = new cjs.Rectangle(-278.4,218.1,1155,100.50000000000003);
...
p.nominalBounds = new cjs.Rectangle(123.4,120.5,351.79999999999995,59.599999999999994);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(976.95,215.25,0.9821,0.9821,0,0,0,358.1,69.1);
	...
	this.instance_1.setTransform(-193.65,248.65,1.3442,1.3442,0,0,0,-0.1,0.1);
	...
	this.instance_2.setTransform(402.75,265,1.3985,1.3985,0,0,0,82,9.9);
	...
	this.instance_3.setTransform(-255.45,216.55,0.8993,0.8993,0,0,0,354.9,74.6);
	...
	// an_sc2_pic2
	this.instance_4 = new lib.an_sc2_pic2("synched",0,false);
	this.instance_4.setTransform(582.4,215.7,0.8993,0.8993,0,0,0,568.4,81);
	...
	// an_sc2_bg3
	this.instance_5 = new lib.an_sc2bg3("synched",0,false);
	this.instance_5.setTransform(614.4,223.3,0.8993,0.8993,0,0,0,582.6,69.1);
	...
	this.instance_6.setTransform(-287.15,217,0.8993,0.8993,0,0,0,491.7,62.1);
...
p.nominalBounds = new cjs.Rectangle(-889.5,142.9,2479.1,145.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(375.35,339.8,1.0374,1.0374,0,0,0,158.6,171.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(82).to({startPosition:44},0).to({_off:true},1).wait(6).to({_off:false},0).wait(1));

	// an_sc0_man
	this.instance_1 = new lib.an_sc0_man("synched",0,false);
	this.instance_1.setTransform(816.35,348.35,0.7484,0.7484,0,0,0,138.3,296.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(82).to({startPosition:29},0).to({_off:true},1).wait(6).to({_off:false},0).wait(1));

	// an_sc0_t2
	this.instance_2 = new lib.an_sc0t2("synched",0,false);
	this.instance_2.setTransform(514.55,261.2,1.0374,1.0374,0,0,0,200.1,67.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(82).to({startPosition:29},0).to({_off:true},1).wait(6).to({_off:false},0).wait(1));

	// an_sc0_t1
	this.instance_3 = new lib.an_sc0t1("synched",0,false);
	this.instance_3.setTransform(-10.9,254.7,1.0374,1.0374,0,0,0,396.8,87.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(82).to({startPosition:29},0).to({_off:true},1).wait(6).to({_off:false},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-493.1,126.6,1412.9,443.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(170,184,0.4162,0.4162);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(434));

	// scc4
	this.instance_1 = new lib.scc4("synched",0);
	this.instance_1.setTransform(747.5,207.1,0.464,0.464,0,0,0,387.7,152.1);
	this.instance_1._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(166).to({_off:false},0).to({mode:"single",startPosition:79},78).to({regX:0,regY:0,scaleX:0.0392,scaleY:0.0392,x:523.8,y:218.6,alpha:0},5).to({_off:true},1).wait(184));

	// title
	this.instance_3 = new lib.title("synched",0,false);
	this.instance_3.setTransform(476.9,253.25,0.6062,0.6062,0,0,0,269.1,86.7);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90).to({_off:false},0).to({_off:true},76).wait(178).to({_off:false,regX:269.2,regY:86.6,scaleX:0.4439,scaleY:0.4439,x:484.45,y:234.9},0).wait(90));

	// scc0
	this.instance_4 = new lib.scc0("synched",0,false);
	this.instance_4.setTransform(536,226,0.5,0.5,0,0,0,300,250);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:89},83).to({x:232.45,alpha:0,startPosition:29},12,cjs.Ease.cubicOut).to({_off:true},1).wait(338));

	// an_car1
	this.instance_5 = new lib.an_car1("synched",0,false);
	this.instance_5.setTransform(243.5,213.3,0.2404,0.2404,0,0,0,261.4,171.8);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(83).to({_off:false},0).to({startPosition:49},83).to({_off:true},1).wait(88).to({_off:false,regX:582.1,regY:266.3,scaleX:0.2632,scaleY:0.2632,x:352.65,y:238.5,startPosition:0},0).to({startPosition:49},85).to({regX:583,regY:266.4,scaleX:0.2243,scaleY:0.2243,x:322.2,y:237.6},8).wait(86));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(255).to({_off:false},0).to({mode:"single",startPosition:34},83).to({regX:308.4,regY:251.6,scaleX:0.5,scaleY:0.5,x:532.25,y:225.95,alpha:0,mode:"synched",loop:false},6).to({_off:true},1).wait(89));

	// sb_bg_normal
	this.instance_7 = new lib.sb_bg_normal("synched",0);
	this.instance_7.setTransform(436.55,227.4,0.2861,0.2861,0,0,0,697.2,490);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(89).to({_off:false},0).to({alpha:1},9).to({startPosition:0},68).to({regY:489.9,x:536.55,alpha:0},8).to({_off:true},1).wait(170).to({_off:false,regX:697.5,scaleX:0.3186,scaleY:0.3186,x:540.9,y:134.5,alpha:1},0).to({startPosition:0},9).wait(80));

	// sb_bg_blur
	this.instance_8 = new lib.sb_bg_blur("synched",0);
	this.instance_8.setTransform(542.85,227.25,0.2861,0.2861,0,0,0,696.6,489.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:554.85},81).to({x:454.85},8).to({x:541.35},159).to({regX:697,regY:490,scaleX:0.5,scaleY:0.5,x:450.35,y:121.3},13).to({startPosition:0},75).to({startPosition:0},2).to({startPosition:0},7).to({regX:696.6,regY:489.4,scaleX:0.2861,scaleY:0.2861,x:541.35,y:227.25},9).wait(80));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-433.1,-100.2,1725,486.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(319.95,44.7,1,1,0,0,0,492.4,226);
...
p.nominalBounds = new cjs.Rectangle(-241.6,-236.5,1361,441.3);
// library properties:
lib.properties = {
