...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(677.7883,807.7195,0.2473,1.5076,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["rgba(33,23,78,0)","#21174E"],[0,0.902],-547.1,0,547.1,0).s().p("EhVeB0qMAAAjpTMCq9AAAMAAADpTg");
	this.shape_1.setTransform(648.4227,245.6747,0.3172,1.4683,-90);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#21174E").s().p("EhVeB0qMAAAjpTMCq9AAAMAAADpTg");
	this.shape_2.setTransform(644.3712,-246.5267,1.9963,0.4268);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#080B1A").s().p("EhVeB0qMAAAjpTMCq9AAAMAAADpTg");
	this.shape_3.setTransform(644.3712,1224.2178,1.9963,0.4297);
...
p.nominalBounds = new cjs.Rectangle(-447.8,-565.2,2251.2000000000003,2110.3);
...
p.nominalBounds = new cjs.Rectangle(-523.6,-574.9,2251.2,2123.4);
...
p.nominalBounds = new cjs.Rectangle(-282.1,-27.8,1219.7,521.6);
...
p.nominalBounds = new cjs.Rectangle(129.3,0,562.8,144.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(590.55,-29.6,1.2699,1.2699,0,0,0,357.9,69);
	...
	this.instance_1.setTransform(66.7,253.35,1.2363,1.2363);
	...
	this.instance_2.setTransform(406.75,498.5,1.1647,1.1647,0,0,0,82,9.8);
	...
	this.instance_3.setTransform(-14.95,195.3,1.2333,1.2333,0,0,0,354.9,74.6);
	...
	this.instance_5.setTransform(574.35,443.9,1,1,0,0,0,568.4,81);
	...
	this.instance_6.setTransform(582.6,406.95,1,1,0,0,0,582.6,69);
...
p.nominalBounds = new cjs.Rectangle(-529,-117.2,1694.3,642.1);
...
p.nominalBounds = new cjs.Rectangle(-311.6,-24,904.6,592.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(387,-69,0.25,0.25);
	...
	this.instance_3.setTransform(526.2,146.85,0.5963,0.5963,0,0,0,268.9,86.4);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90).to({_off:false},0).to({_off:true},76).wait(178).to({_off:false,scaleX:0.5854,scaleY:0.5854,x:529.15,y:135.05},0).wait(90));
	...
	this.instance_5.setTransform(366.9,271.8,0.3876,0.3876,0,0,0,261.2,171.3);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(83).to({_off:false},0).to({startPosition:49},83).to({_off:true},1).wait(88).to({_off:false,regX:581.8,regY:265.5,scaleX:0.5,scaleY:0.5,x:447.95,y:311.2,startPosition:0},0).to({startPosition:49},85).to({regY:265.7,scaleX:0.325,scaleY:0.325,x:472,y:294.9},8).wait(86));
...
p.nominalBounds = new cjs.Rectangle(-160,-306.4,1144.8,1061.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(106.1,299.75,1.0012,1.0012,0,0,0,492.4,226);
...
p.nominalBounds = new cjs.Rectangle(-397.1,66.6,996.2,763);
// library properties:
lib.properties = {
