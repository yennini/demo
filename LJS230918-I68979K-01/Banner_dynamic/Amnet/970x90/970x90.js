...
p.nominalBounds = new cjs.Rectangle(137.3,122.8,944.2,192.39999999999998);
...
p.nominalBounds = new cjs.Rectangle(100.5,116.7,396.7,67.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1184.1,217.35,1.2906,1.2906,0,0,0,358,69);
	...
	this.instance_1.setTransform(-364.7,229.8,1.7664,1.7664,0,0,0,-0.1,0.1);
	...
	this.instance_2.setTransform(419.1,267.05,1.8379,1.8379,0,0,0,82,9.9);
	...
	this.instance_3.setTransform(-445.9,187.6,1.1818,1.1818,0,0,0,354.9,74.6);
	...
	this.instance_4.setTransform(655.15,254.8,1.1818,1.1818,0,0,0,568.4,81);
	...
	this.instance_5.setTransform(697.3,222.75,1.1818,1.1818,0,0,0,582.6,69.1);
	...
	this.instance_6.setTransform(-487.55,214.5,1.1818,1.1818,0,0,0,491.7,62.1);
...
p.nominalBounds = new cjs.Rectangle(-1279.1,99.5,3258,251);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(52,184,0.4162,0.4162);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(434));

	// scc4
	this.instance_1 = new lib.scc4("synched",0);
	this.instance_1.setTransform(782.45,207.1,0.5,0.5,0,0,0,387.6,152);
	this.instance_1._off = true;
	...
	this.instance_3.setTransform(516.8,253.25,0.6195,0.6195,0,0,0,268.9,86.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90).to({_off:false},0).to({_off:true},76).wait(178).to({_off:false,regX:269.1,regY:86.3,scaleX:0.5746,scaleY:0.5746,x:200.25},0).wait(90));
	...
	this.instance_5.setTransform(238.5,213.3,0.2404,0.2404,0,0,0,261.4,171.8);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(83).to({_off:false},0).to({startPosition:49},83).to({_off:true},1).wait(88).to({_off:false,regX:582.1,regY:266.3,scaleX:0.2632,scaleY:0.2632,x:322.65,y:238.5,startPosition:0},0).to({startPosition:49},85).to({regX:582.2,regY:266.2,scaleX:0.2417,scaleY:0.2417,x:645.8,y:235.55},8).wait(86));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(89).to({_off:false},0).to({alpha:1},9).to({startPosition:0},68).to({alpha:0},8).to({_off:true},1).wait(170).to({_off:false,regX:697.5,scaleX:0.3186,scaleY:0.3186,x:540.9,y:134.5,alpha:1},0).to({startPosition:0},9).wait(80));

	// sb_bg_blur
	this.instance_8 = new lib.sb_bg_blur("synched",0);
	this.instance_8.setTransform(542.85,227.25,0.2861,0.2861,0,0,0,696.6,489.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:554.85},81).to({startPosition:0},8).to({x:541.35},159).to({regX:697,regY:490,scaleX:0.5,scaleY:0.5,x:450.35,y:121.3},13).to({startPosition:0},75).to({startPosition:0},2).to({startPosition:0},7).to({regX:696.6,regY:489.4,scaleX:0.2861,scaleY:0.2861,x:541.35,y:227.25},9).wait(80));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-433.1,-100.2,1824.6999999999998,486.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(440.95,44.7,1,1,0,0,0,492.4,226);
...
p.nominalBounds = new cjs.Rectangle(0.4,-236.5,1339.6999999999998,441.3);
// library properties:
lib.properties = {
