...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#153184").ss(0.4).p("");
	...
	this.shape_10.graphics.f().s("#153184").ss(0.4,1,1).p("ABfBIIAAAPIi8AAIAAgPIBWAAIAAgnIhDAAIAAgPIBDAAIAAgbIAPAAIAAAbIBFAAIAAAPIhFAAIAAAngABJgDIgOgQQh9AGgIADQgBgIgEgIQAFAAAKgKQAPgMARgYIg4AAIAAgOICwAAIAAAOIhkAAQgUAbgUARIBigEIgagWIAMgIQAmAcAQAVg");
	...
	this.shape_12.graphics.f().s("#153184").ss(0.4,1,1).p("");
	...
	this.shape_14.graphics.f().s("#153184").ss(0.4,1,1).p("");
	...
	this.shape_16.graphics.f().s("#153184").ss(0.4,1,1).p("");
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(232.9565,-35.3878,0.3836,0.3836);
	...
	this.shape_1.setTransform(232.9565,-39.1661,0.3836,0.3836);
	...
	this.shape_2.setTransform(232.9565,-42.9541,0.3836,0.3836);
	...
	this.shape_3.setTransform(232.9565,-35.3878,0.3836,0.3836);
	...
	this.shape_4.setTransform(232.9565,-35.3878,0.3836,0.3836);
	...
	this.shape_5.setTransform(232.9565,-39.1661,0.3836,0.3836);
	...
	this.shape_6.setTransform(232.9565,-39.1661,0.3836,0.3836);
	...
	this.shape_7.setTransform(232.9565,-42.9541,0.3836,0.3836);
	...
	this.shape_8.setTransform(232.9565,-42.9541,0.3836,0.3836);
	...
	this.shape_9.setTransform(229.3793,-43.5753,0.3835,0.3835);
	...
	this.shape_10.setTransform(229.3218,-43.5849,0.3835,0.3835);
	...
	this.shape_11.setTransform(222.2262,-39.2892,0.3835,0.3835);
	...
	this.shape_12.setTransform(210.2116,-39.155,0.3835,0.3835);
	...
	this.shape_13.setTransform(222.2178,-39.3148,0.3835,0.3835);
	...
	this.shape_14.setTransform(222.2082,-39.3052,0.3835,0.3835);
	...
	this.shape_15.setTransform(210.1869,-39.1806,0.3835,0.3835);
	...
	this.shape_16.setTransform(210.1965,-39.171,0.3835,0.3835);
	...
	this.shape_17.setTransform(193.6094,-43.5649,0.3837,0.3837);
	...
	this.shape_18.setTransform(193.6864,-43.5583,0.3836,0.3836);
	...
	this.shape_19.setTransform(185.9744,-39.1815,0.3837,0.3837);
	...
	this.shape_20.setTransform(171.2992,-39.1911,0.3837,0.3837);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AodDzIAAnmIOOAAQBHABAzAyQAzAzAABIIAACMQAABIgzAyQgzAyhHAAg");
	this.shape_21.setTransform(219.8418,-39.2695,0.3837,0.3837);
	...
	this.shape_22.setTransform(198.0469,-39.2599,0.3837,0.3837);
	...
	this.instance.setTransform(281.3,1.75,0.4095,0.4095,0,0,0,327.2,80.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(300));

	// an_subtt
	this.instance_1 = new lib.an_subtt("synched",0,false);
	this.instance_1.setTransform(285.55,52.45,0.4287,0.4287,0,0,0,236.6,96.1);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(222.6,260.65,0.4321,0.4321,0,0,0,186.7,16.6);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(167.6,206.6,0.4213,0.4213,0,0,0,68.6,69.3);
	this.instance_3._off = true;
	...
	this.instance_4.setTransform(167.6,142.55,0.4213,0.4213,0,0,0,68.6,69.2);
	this.instance_4._off = true;
	...
	this.instance_5.setTransform(223.1,162.6,0.3542,0.3542,0,0,0,247.8,207.5);
	this.instance_5._off = true;
	...
	this.instance_6.setTransform(380.9,136.4,0.5602,0.5602,0,0,0,23.9,67.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(5).to({_off:false},0).to({scaleX:3.5233,scaleY:3.0963,x:374.95,y:54.65,alpha:0.4805,startPosition:45},45).to({scaleX:3.0295,scaleY:2.6624,x:171.1,y:-54,alpha:1,startPosition:0},49).to({scaleX:3.9769,scaleY:3.495,x:562.25,y:154.1,alpha:0},102).to({scaleX:3.0295,scaleY:2.6624,x:171.1,y:-54,alpha:1},92).to({_off:true},1).wait(6));
	...
	this.instance_12.setTransform(285.95,124.7,0.3802,0.3802,0,0,0,817.1,509.4);
...
// stage content:
(lib._250x360 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(143.45,240.1,1,1,0,0,0,298.4,172.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(450));

	// stageBackground
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,0,0,0)").ss(1,1,1,3,true).p("A1F9rMAqLAAAMAAAA7XMgqLAAAg");
	this.shape.setTransform(125,180);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("A1FdsMAAAg7XMAqLAAAMAAAA7Xg");
	this.shape_1.setTransform(125,180);
...
p.nominalBounds = new cjs.Rectangle(-95.9,100,642.5,506.1);
// library properties:
lib.properties = {
