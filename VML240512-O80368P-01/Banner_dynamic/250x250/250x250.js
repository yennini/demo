...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,1.6978,1.6978);
...
p.nominalBounds = new cjs.Rectangle(0,0,1528,1018.7);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_6.setTransform(34.975,114.4);
	...
	this.shape_7.setTransform(34.675,95.6);
	...
	this.shape_8.setTransform(34.65,76.375);
	...
	this.shape_9.setTransform(34.7,57.35);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("");
	this.shape_10.setTransform(34.8,38.35);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgHBPQgRAAgGgGQgGgGAAgRIAAhRIAWAAIAABRQAAAGACACQABACAHAAIAYAAQAGAAACgGQADgGABgVQAHAFAMADQgCAagGAJQgFAJgQAAgAhSAvQAKgbAFgoIAUAEQgEArgJAdgAApgSIATgIQARAiAFAfIgVAIQgDgagRgngAgehAIAOgOQAkAYAMAMIgQARQgPgRgfgWg");
	this.shape_11.setTransform(34.8,19.275);
	...
	// Layer_12
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#469DCC").s().p("AhbJ+QgmgmAAg2IAAxDQAAg2AmgmQAmgmA1AAQA1AAAnAmQAmAmAAA2IAARDQAAA2gmAmQgnAmg1AAQg1AAgmgmg");
	this.shape_12.setTransform(34.7,67.6);
...
p.nominalBounds = new cjs.Rectangle(0,0,47.7,135.2);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#214092","#469FE3"],[0,1],-187.7,46,-187.7,-57.3).s().p("");
	this.shape.setTransform(419.175,57.425);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#214092","#469FE3"],[0,1],-92.7,56,-92.7,-47.3).s().p("ADqGaIAEguIoPg7IgFAuIhtgMIBKr5ILdBQIg3L9gAkYDSIIMA6IAooJIoEg4gAi8B3IAdlBIFgAnIgZFCgAhSAqICYARIAMiSIiYgRg");
	this.shape_1.setTransform(324.15,47.325);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#214092","#469FE3"],[0,1],2,62.9,2,-40.4).s().p("");
	this.shape_2.setTransform(229.475,40.425);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#214092","#469FE3"],[0,1],95.6,58.9,95.6,-44.4).s().p("AgvCEIjFATIADAvIhpAKIgYmrIEqgcIgJiQIBrgKIAKCQIEugcIAhGlIhtAKIgDgqIjFASIASENIhuALgAkEiDIAKC2IDEgTIgMi1gAAqifIANC1IDEgSIgNi1g");
	this.shape_3.setTransform(135.875,44.425);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#214092","#469FE3"],[0,1],189.2,44.9,189.2,-58.4).s().p("AARDHImJBNIgMhhICKgbIgejeID9gxIgOhjIi5AjQgpBkg4BMQg9gjglgMQAzg6AnhVQAlhSARhYIBsAGQgGAigNAnIHjheIAPBfIj3AwIAPBjIDkgsIAOBdIjkAsIASCAIEpg7IAPBhIkpA7IAbC4IhsAVgAikACIASCBICVgdIgRiAg");
	this.shape_4.setTransform(42.225,58.475);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#FFFFFF").ss(7.9,1,1).p("");
	this.shape_5.setTransform(419.175,57.425);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#FFFFFF").ss(7.9,1,1).p("AGUlWIg3L9IhzgNIAEguIoPg7IgEAuIhtgMIBJr5gABShXIiXgRIgNCSICYARgADBijIgZFCIljgoIAdlBgAD1EMIAnoJIoEg4IgwIHg");
	this.shape_6.setTransform(324.15,47.325);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#FFFFFF").ss(7.9,1,1).p("");
	this.shape_7.setTransform(229.475,40.425);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#FFFFFF").ss(7.9,1,1).p("AFSkdIAhGlIhtAKIgDgqIjFASIASENIhuALIgRkOIjFATIADAvIhpAKIgYmrIEqgcIgJiQIBrgKIAKCQgAD7AEIgNi1IjEASIANC1gAg2AgIgMi1IjCASIAKC2g");
	this.shape_8.setTransform(135.875,44.425);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#FFFFFF").ss(7.9,1,1).p("AGmB3IkpA7IAbC4IhsAVIgbi4ImJBNIgMhhICKgbIgejeID9gxIgOhjIi5AjQgpBkg4BMQg9gjglgMQAzg6AnhVQAlhSARhYIBsAGQgGAigNAnIHjheIAPBfIj3AwIAPBjIDkgsIAOBdIjkAsIASCAIEpg7gAADBmIgRiAIiWAcIASCBg");
	this.shape_9.setTransform(42.225,58.475);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.lf(["#2057F5","#51A2CF"],[0,1],0,45.9,0,-45.9).s().p("");
	this.shape_10.setTransform(419.175,57.425);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.lf(["#2057F5","#51A2CF"],[0,1],0,42.3,0,-42.2).s().p("ADqGaIAEguIoPg7IgFAuIhtgMIBKr5ILdBQIg3L9gAkYDSIIMA6IAooJIoEg4gAi8B3IAdlBIFgAnIgZFCgAhSAqICYARIAMiSIiYgRg");
	this.shape_11.setTransform(324.15,47.325);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.lf(["#2057F5","#51A2CF"],[0,1],0,40.4,0,-40.4).s().p("");
	this.shape_12.setTransform(229.475,40.425);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.lf(["#2057F5","#51A2CF"],[0,1],0,40.2,0,-40.1).s().p("AgvCEIjFATIADAvIhpAKIgYmrIEqgcIgJiQIBrgKIAKCQIEugcIAhGlIhtAKIgDgqIjFASIASENIhuALgAkEiDIAKC2IDEgTIgMi1gAAqifIANC1IDEgSIgNi1g");
	this.shape_13.setTransform(135.875,44.425);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.lf(["#2057F5","#51A2CF"],[0,1],0,38.3,0,-38.3).s().p("AARDHImJBNIgMhhICKgbIgejeID9gxIgOhjIi5AjQgpBkg4BMQg9gjglgMQAzg6AnhVQAlhSARhYIBsAGQgGAigNAnIHjheIAPBfIj3AwIAPBjIDkgsIAOBdIjkAsIASCAIEpg7IAPBhIkpA7IAbC4IhsAVgAikACIASCBICVgdIgRiAg");
	this.shape_14.setTransform(42.225,58.475);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mo_sc1title, new cjs.Rectangle(-3.9,-3.9,470.79999999999995,111.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(151.66,52.875);
	...
	this.shape_1.setTransform(51.2,52.65);
	...
	this.shape_2.setTransform(151.66,52.875);
	...
	this.shape_3.setTransform(151.66,52.875);
	...
	this.shape_4.setTransform(51.2,52.65);
	...
	this.shape_5.setTransform(51.2,52.65);
...
p.nominalBounds = new cjs.Rectangle(0,0,204.5,105.8);
...
(lib.sb_linesm = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_14
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#153189").ss(21.9).p("Ehw3AbJMC2BAAAMAqXg28");
	this.shape.setTransform(733.336,188.9072);
...
p.nominalBounds = new cjs.Rectangle(0,0,1458,373.6);


(lib.sb_linelg = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_13
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#153189").ss(84.4).p("Eh1zAaWMC70AAAMAqlg3P");
	this.shape.setTransform(796.1522,227.1393);
...
p.nominalBounds = new cjs.Rectangle(0,0,1558.9,437.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(235.4,55.5,1,1,0,0,0,231.5,51.6);
	this.instance.shadow = new cjs.Shadow("rgba(21,49,129,0.749)",2,2,3);
...
p.nominalBounds = new cjs.Rectangle(0,0,478,119);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(344.85,103.75,1.2515,1.2515,0,0,0,102.2,52.9);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({_off:false},0).to({scaleX:1,scaleY:1,y:103.7,alpha:1},11,cjs.Ease.cubicOut).wait(23));
...
p.nominalBounds = new cjs.Rectangle(0,0,472.9,191.9);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:31},45).to({regX:236.3,regY:95.9,scaleX:1.1024,scaleY:1.1024,x:236.35,y:95.95,startPosition:37},6).to({regX:236.5,scaleX:0.9726,scaleY:0.9726,x:236.5,y:95.85,startPosition:39},7).wait(7));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-24.1,0,497,191.9);
...
p.nominalBounds = new cjs.Rectangle(107,0,1528,1018.7);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(218.4882,63.0931,0.3125,0.3125);
	...
	this.shape_1.setTransform(218.4882,60.0154,0.3125,0.3125);
	...
	this.shape_2.setTransform(218.4882,56.9299,0.3125,0.3125);
	...
	this.shape_3.setTransform(218.4882,63.0931,0.3125,0.3125);
	...
	this.shape_4.setTransform(218.4882,63.0931,0.3125,0.3125);
	...
	this.shape_5.setTransform(218.4882,60.0154,0.3125,0.3125);
	...
	this.shape_6.setTransform(218.4882,60.0154,0.3125,0.3125);
	...
	this.shape_7.setTransform(218.4882,56.9299,0.3125,0.3125);
	...
	this.shape_8.setTransform(218.4882,56.9299,0.3125,0.3125);
	...
	this.shape_9.setTransform(215.5791,56.4275,0.3124,0.3124);
	...
	this.shape_10.setTransform(215.5322,56.4197,0.3124,0.3124);
	...
	this.shape_11.setTransform(209.7521,59.919,0.3124,0.3124);
	...
	this.shape_12.setTransform(199.9649,60.0284,0.3124,0.3124);
	...
	this.shape_13.setTransform(209.7539,59.9059,0.3124,0.3124);
	...
	this.shape_14.setTransform(209.7461,59.9137,0.3124,0.3124);
	...
	this.shape_15.setTransform(199.9521,60.0152,0.3124,0.3124);
	...
	this.shape_16.setTransform(199.9599,60.023,0.3124,0.3124);
	...
	this.shape_17.setTransform(186.4322,56.4247,0.3125,0.3125);
	...
	this.shape_18.setTransform(186.5007,56.4378,0.3125,0.3125);
	...
	this.shape_19.setTransform(180.2141,59.9947,0.3125,0.3125);
	...
	this.shape_20.setTransform(168.2621,59.9868,0.3125,0.3125);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AodDzIAAnmIOOAAQBHABAzAyQAzAzAABIIAACMQAABIgzAyQgzAyhHAAg");
	this.shape_21.setTransform(207.7924,59.9192,0.3125,0.3125);
	...
	this.shape_22.setTransform(190.0433,59.927,0.3125,0.3125);
	...
	this.instance.setTransform(281.3,87.45,0.3125,0.3125,0,0,0,327.1,80.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(300));

	// an_subtt
	this.instance_1 = new lib.an_subtt("synched",0,false);
	this.instance_1.setTransform(244.1,127.45,0.3125,0.3125,0,0,0,236.5,96);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(347.05,271.6,0.3125,0.3125,0,0,0,186.4,16.5);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(167.7,241.55,0.3125,0.3125,0,0,0,68.3,69.1);
	this.instance_3._off = true;
	...
	this.instance_4.setTransform(167.7,194.05,0.3125,0.3125,0,0,0,68.3,69.1);
	this.instance_4._off = true;
	...
	this.instance_5.setTransform(210.9,215.85,0.3125,0.3125,0,0,0,247.8,207.5);
	this.instance_5._off = true;
	...
	this.instance_6.setTransform(371.95,153.05,0.3125,0.3125,0,0,0,23.9,67.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(300));

	// sb_line_lg
	this.instance_7 = new lib.sb_linelg("synched",0);
	this.instance_7.setTransform(243.5,238.4,0.3125,0.3125,0,0,0,779.4,219.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(300));

	// sb_doctor
	this.instance_8 = new lib.sb_doctor("synched",0);
	this.instance_8.setTransform(330.75,199.65,0.3125,0.3125,0,0,0,239.7,456);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(300));

	// sb_line_sm
	this.instance_9 = new lib.sb_linesm("synched",0);
	this.instance_9.setTransform(237.95,216.75,0.3125,0.3125,0,0,0,728.8,186.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(300));

	// sb_bg_light_copy
	this.instance_10 = new lib.sb_light("synched",0);
	this.instance_10.setTransform(562.25,154.1,3.9769,3.495,0,0,0,35.1,35.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(5).to({_off:false},0).to({scaleX:3.0295,scaleY:2.6624,x:171.1,y:-54,alpha:1},94).to({scaleX:3.9769,scaleY:3.495,x:562.25,y:154.1,alpha:0},102).to({scaleX:3.0295,scaleY:2.6624,x:171.1,y:-54,alpha:1},92).to({_off:true},1).wait(6));

	// sb_bg_light
	this.instance_11 = new lib.sb_light("synched",0);
	this.instance_11.setTransform(373.2,416.25,3.9769,3.495,0,0,0,35.1,35.1);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(5).to({_off:false},0).to({scaleX:3.0295,scaleY:2.9805,x:40.35,y:198.75,alpha:1},94).to({scaleX:3.9769,scaleY:3.495,x:373.2,y:416.25,alpha:0},102).to({scaleX:3.0295,scaleY:2.9805,x:40.35,y:198.75,alpha:1},92).to({_off:true},1).wait(6));

	// an_sc1_bg
	this.instance_12 = new lib.an_sc1bg("synched",0,false);
	this.instance_12.setTransform(341.35,159.2,0.3125,0.3125,0,0,0,817.3,509.4);
...
p.nominalBounds = new cjs.Rectangle(-65.9,-147.5,767.4,686.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(143.45,130.1,1,1,0,0,0,298.4,172.6);
...
p.nominalBounds = new cjs.Rectangle(-95.9,-65,642.5,561.1);
// library properties:
lib.properties = {
