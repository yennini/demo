...
if (reversed == null) { reversed = false; }
	...
	// Layer_14
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#153189").ss(21.9).p("EjKrAayMFppAAXMAqXg28");
	this.shape.setTransform(158.5057,188.9098);
...
p.nominalBounds = new cjs.Rectangle(-1149.6,0,2607.6,373.6);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_13
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#153189").s().p("EgjKAN8IAA73MBGVAAAIAAb3g");
	this.shape.setTransform(1383.97,374.2416,0.4205,2.609,44.9998);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#153189").ss(84.4).p("EjC6AaIMFWDAAOMAqlg3P");
	this.shape_1.setTransform(302.5892,227.1457);
...
p.nominalBounds = new cjs.Rectangle(-987.1,0,2602.5,605.7);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-60.1362,85.355,0.7131,0.7131);
	...
	this.shape_1.setTransform(-60.1362,78.3313,0.7131,0.7131);
	...
	this.shape_2.setTransform(-60.1362,71.2899,0.7131,0.7131);
	...
	this.shape_3.setTransform(-60.1362,85.355,0.7131,0.7131);
	...
	this.shape_4.setTransform(-60.1362,85.355,0.7131,0.7131);
	...
	this.shape_5.setTransform(-60.1362,78.3313,0.7131,0.7131);
	...
	this.shape_6.setTransform(-60.1362,78.3313,0.7131,0.7131);
	...
	this.shape_7.setTransform(-60.1362,71.2899,0.7131,0.7131);
	...
	this.shape_8.setTransform(-60.1362,71.2899,0.7131,0.7131);
	...
	this.shape_9.setTransform(-66.7742,70.144,0.713,0.713);
	...
	this.shape_10.setTransform(-66.8812,70.1262,0.713,0.713);
	...
	this.shape_11.setTransform(-80.0722,78.1121,0.713,0.713);
	...
	this.shape_12.setTransform(-102.4078,78.3616,0.713,0.713);
	...
	this.shape_13.setTransform(-80.0873,78.0649,0.7129,0.7129);
	...
	this.shape_14.setTransform(-80.1052,78.0827,0.7129,0.7129);
	...
	this.shape_15.setTransform(-102.4533,78.3144,0.7129,0.7129);
	...
	this.shape_16.setTransform(-102.4355,78.3322,0.7129,0.7129);
	...
	this.shape_17.setTransform(-133.2793,70.1536,0.7132,0.7132);
	...
	this.shape_18.setTransform(-133.1356,70.1668,0.7131,0.7131);
	...
	this.shape_19.setTransform(-147.4719,78.3019,0.7132,0.7132);
	...
	this.shape_20.setTransform(-174.7516,78.2841,0.7132,0.7132);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AodDzIAAnmIOOAAQBHABAzAyQAzAzAABIIAACMQAABIgzAyQgzAyhHAAg");
	this.shape_21.setTransform(-84.5178,78.137,0.7133,0.7133);
	...
	this.shape_22.setTransform(-125.0317,78.1548,0.7133,0.7133);
	...
	this.instance.setTransform(331.35,106.7,0.5671,0.5671,0,0,0,327.1,80.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(300));

	// an_subtt
	this.instance_1 = new lib.an_subtt("synched",0,false);
	this.instance_1.setTransform(335.2,173,0.5671,0.5671,0,0,0,236.7,96.1);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(330.15,242.6,0.7596,0.7596,0,0,0,186.6,16.6);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(-148.7,181.6,0.8692,0.8692,0,0,0,68.4,69.2);
	this.instance_3._off = true;
	...
	this.instance_4.setTransform(-76.95,181.6,0.8692,0.8692,0,0,0,68.5,69.2);
	this.instance_4._off = true;
	...
	this.instance_5.setTransform(50.45,165.3,0.5579,0.5579,0,0,0,247.9,207.6);
	this.instance_5._off = true;
	...
	this.instance_6.setTransform(665.35,154.7,0.7231,0.7231,0,0,0,23.9,68.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(300));

	// sb_line_lg
	this.instance_7 = new lib.sb_linelg("synched",0);
	this.instance_7.setTransform(472.55,212.3,0.46,0.46,0,0,0,779.3,219.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(300));

	// sb_doctor
	this.instance_8 = new lib.sb_doctor("synched",0);
	this.instance_8.setTransform(549.45,174.45,0.4074,0.4074,0,0,0,239.8,455.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(300));

	// sb_line_sm
	this.instance_9 = new lib.sb_linesm("synched",0);
	this.instance_9.setTransform(464.4,180.45,0.46,0.46,0,0,0,728.9,187);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(300));

	// sb_bg_light_copy
	this.instance_10 = new lib.sb_light("synched",0);
	this.instance_10.setTransform(929.75,154.1,3.9769,3.495,0,0,0,35.1,35.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(5).to({_off:false},0).to({regY:35,scaleX:5.2508,scaleY:4.6145,x:-397.35,y:-31.1,alpha:1},94).to({regY:35.1,scaleX:4.9966,scaleY:4.3911,x:948.65,y:4.95,alpha:0},102).to({regY:35,scaleX:6.4415,scaleY:5.6609,x:-94.55,y:-199.5,alpha:1},92).to({_off:true},1).wait(6));

	// sb_bg_light
	this.instance_11 = new lib.sb_light("synched",0);
	this.instance_11.setTransform(570.45,499.55,5.7949,5.0927,0,0,0,35.1,35.1);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(5).to({_off:false},0).to({regY:35.2,scaleX:4.8089,scaleY:4.7312,x:-397.2,y:226.5,alpha:1},94).to({regY:35.1,scaleX:5.3007,scaleY:4.6583,x:752.3,y:479.95,alpha:0},102).to({regX:35,regY:35.2,scaleX:5.6786,scaleY:5.5868,x:-412.85,y:293.25,alpha:1},92).to({_off:true},1).wait(6));

	// an_sc1_bg
	this.instance_12 = new lib.an_sc1bg("synched",0,false);
	this.instance_12.setTransform(242.65,291.35,0.6424,0.6424,0,0,0,817.1,509.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(503.45,130.1,1,1,0,0,0,298.4,172.6);
...
p.nominalBounds = new cjs.Rectangle(78.5,-315.2,1250.1,950.4000000000001);
// library properties:
lib.properties = {
