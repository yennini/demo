...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(665.15,372.05,1,1,0,0,0,114.9,98.5);
	...
	this.instance_3.setTransform(620.8,149.45,1,1,0,0,0,41.6,41.5);
	...
	this.instance_4.setTransform(418.75,210.4,1.1898,1.1898,0,0,0,217,16.4);
	...
	this.instance_5.setTransform(448.85,148.95,1,1,0,0,0,138.3,19.9);
	...
	// an_sc2_frame_white
	this.instance_7 = new lib.an_sc2framewhite("synched",0,false);
	this.instance_7.setTransform(852.25,258.25,1,1,0,0,0,630,195.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(93).to({startPosition:89},0).to({_off:true},1).wait(56));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,11.8,780,487.59999999999997);
...
p.nominalBounds = new cjs.Rectangle(257.3,0,430.59999999999997,284.2);
...
p.nominalBounds = new cjs.Rectangle(59.5,93.2,280.7,159.2);
// library properties:
lib.properties = {
