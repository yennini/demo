...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(88).to({_off:true},1).wait(30).to({_off:false},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:10},10).to({_off:true},1).wait(1).to({_off:false,x:331.25,startPosition:12},0).to({x:351.95,startPosition:89},77).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1,startPosition:12},11,cjs.Ease.cubicOut).to({startPosition:81},69).to({y:51.5,alpha:0,startPosition:85},5).wait(5));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:302.95,y:145.5}).wait(6).to({graphics:mask_graphics_6,x:302.95,y:145.5}).wait(1).to({graphics:null,x:0,y:0}).wait(1).to({graphics:mask_graphics_8,x:302.95,y:145.5}).wait(82));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:6},6).to({_off:true},1).wait(1).to({_off:false,x:268.75,startPosition:8},0).to({x:241.55,startPosition:119},81).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1,startPosition:8},7).to({startPosition:87},79).to({_off:true},1).wait(2));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(194.65,203.65,0.56,0.56,0,0,0,797.9,370.7);
...
p.nominalBounds = new cjs.Rectangle(-84.1,136.1,725.6,288);
// library properties:
lib.properties = {
