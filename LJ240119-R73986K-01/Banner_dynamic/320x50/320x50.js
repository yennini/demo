...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#87622D").s().p("Aj+DLQAhgjAigXQAjgWAXgCIABAAQBAgrBCg8QBAg3Axg5Ik8AXIAIhNIDJgPQgMgagYgnIBKgsQAtBCAJARIghAVIBzgJIAQgFIA4AjQg5BRhVBRQhRBQhXA/QAWAJAhACQAZABAsgDQAogEA1gIQA5gIAlgJQgZA4gFAeQhTAMhVAHQgzAEgggFQgigEgbgOIgegTQgOgKgHABQgLAAgUAaQgNAPgYAlg");
	this.shape.setTransform(84.325,37.95);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#87622D").s().p("");
	this.shape_1.setTransform(25.725,42.825);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mo_sc4t, new cjs.Rectangle(0,10.6,109.9,58.49999999999999), null);
...
(lib.sb_titlebg = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(255,255,255,0)","#FFFFFF","rgba(255,255,255,0)"],[0,0.478,1],-213.4,0,213.1,0).s().p("EghTAFHIAAqNMBCoAAAIAAKNg");
	this.shape.setTransform(192.6065,46.9505,0.9032,1.4342);
...
p.nominalBounds = new cjs.Rectangle(0,0,385.2,93.9);
...
(lib.sb_icon = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape.setTransform(50.1639,12.025);
	...
	this.shape_1.setTransform(37.6779,16.4);
	...
	this.shape_2.setTransform(46.425,15.7);
	...
	this.shape_11.setTransform(44.225,15.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(450));
	...
	this.shape_12.setTransform(15.625,15.725);
	...
	this.shape_21.setTransform(13.4,15.725);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]}).wait(450));

	// Layer_3_copy
	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.lf(["#B98551","#E8BA7E","#B98551"],[0,0.478,1],-12.3,0.2,12.2,-0.1).s().p("AhXBYQglglAAgzQAAgyAlglQAlgkAyAAQA0AAAkAkQAlAlAAAyQAAAzglAlQgkAkg0AAQgyAAglgkg");
	this.shape_22.setTransform(44.2,15.7);

	this.timeline.addTween(cjs.Tween.get(this.shape_22).wait(450));

	// Layer_3
	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.lf(["#B98551","#E8BA7E","#B98551"],[0,0.478,1],-12.3,0.2,12.2,-0.1).s().p("AhXBYQglglAAgzQAAgyAlglQAlgkAyAAQA0AAAkAkQAlAlAAAyQAAAzglAlQgkAkg0AAQgyAAglgkg");
	this.shape_23.setTransform(13.35,15.7);

	this.timeline.addTween(cjs.Tween.get(this.shape_23).wait(450));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,2.3,57.7,26.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(881,28,1.1248,1.1248);
...
p.nominalBounds = new cjs.Rectangle(881,28,248.5999999999999,249.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(354,0);
...
p.nominalBounds = new cjs.Rectangle(354,0,173,142);
...
if (reversed == null) { reversed = false; }
	...
	mask.setTransform(302.9687,139);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:239,scaleX:1,scaleY:1,x:362.9,y:140.35,alpha:1},8,cjs.Ease.cubicOut).to({startPosition:0},49).to({x:1494.85,y:226.35},4).wait(4));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,1733.9,341.4);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#87622D").s().p("AiWDoQgHgWgIgPQAmgBA6gFQARgBACgPIAHhFIjSAQIAHhNIDSgRIAFgyIisAOIAHhNICtgNIAFg1QhMAMhVAJQgBgggMgkQBogMBfgRQBogUBEgWIAyA/QhIAWhdASIgGA+ICwgOIgIBMIiwAOIgFAxIDRgPIgHBNIjRAQIgHBIQgDAhgLASQgKARgWAMQglARhZAFQgCgPgHgYg");
	this.shape.setTransform(206.925,31.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#87622D").s().p("Ai+BWQgXATgUAOQgKgigUgpQBRg1A+hmIhtAJIAHhNICQgKQAPgiAPgoIBPANIgXA1IEAgTIgIBMIkeAWQgiA/gmAwIgaEJIhQAGgAhhCqIB8gKIAKhsIhnAIIAIhJIBmgIIAIhTIBQgGIgIBTIBjgIIgHBIIhjAIIgLBsIB4gJIgHBJIlDAZg");
	this.shape_1.setTransform(147.925,36.9);
...
p.nominalBounds = new cjs.Rectangle(-5,-46.5,279.8,135.1);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_6
	this.instance = new lib.an_light("synched",0);
	this.instance.setTransform(10.4,80.2,0.9616,0.9616,0,0,0,67.2,67.5);
	...
	// sb_icon
	this.instance_1 = new lib.sb_icon("synched",0);
	this.instance_1.setTransform(233.9,-1.05,2.1586,2.1586,0,0,0,28.9,14.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(84).to({startPosition:84},0).to({_off:true},1).wait(3).to({_off:false,startPosition:88},0).wait(3).to({startPosition:91},0).to({_off:true},1).wait(358));

	// _Group_
	this.instance_2 = new lib.mo_sc4key();
	this.instance_2.setTransform(181.6,47,1.159,1.159,3.4812,0,0,116.7,19.2);
	this.instance_2.shadow = new cjs.Shadow("rgba(69,44,10,0.498)",2,2,4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(84).to({_off:true},1).wait(3).to({_off:false},0).wait(3).to({_off:true},1).wait(358));

	// Layer_5
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(244,221,155,0)","#DFB781","#BC9362","#9B7146","#88613A","#77542F"],[0.012,0.243,0.439,0.675,0.863,1],200.6,-16.3,-200.6,16.4).s().p("A80h3MA71gE3IiNIlMg70AE5g");
	this.shape.setTransform(243.0566,44.1858,1.159,1.159,3.4812);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(84).to({_off:true},1).wait(3).to({_off:false},0).wait(3).to({_off:true},1).wait(358));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-54.2,-26,529.9,170.8);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:122,y:106.85},11,cjs.Ease.cubicOut).to({startPosition:0},71).to({x:403.05,y:79.25},4).wait(3));
...
p.nominalBounds = new cjs.Rectangle(-0.9,-31.7,934.6999999999999,199.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#87622D").s().p("Aj8C3IC3gMIAGg1IiDAJIAHhEICDgJIAGgyIhoAGIAFgvQglAYghARQgQgjgYgaQBYglBUhIIg4AEIAIhKIDCgNQAdAyA0AoQA3AqBCATQgOAOgRAXQgTAYgJAQQgbgLgjgWIgFAuIhoAGIgGAyICFgIIgIBEIiFAJIgFA1IC+gNIgHBHInHAdgAh0hAIDhgQQg1glgug8IgBAAQgyA5hLA4g");
	this.shape.setTransform(203.725,30.35);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#87622D").s().p("AjpDoQgLgXgLgPQB7gRBDghQg7gVg/gSQASgXAcgsIhhAHIAIhKICIgJQAXgpARgnIBYALQgJAVgXAqIBKgFIAKgvIBLgBIAEgsIkqAUIgGA4IhPAFIAOiBIC5gMIgKgrIBagaQAKAcAJAiICwgLIgOCBIg/AEIgJAfIBMgFIgIBKIheAGQgXA0geApQBYAjAqAZIhABJQgwgfhVgkQhTA+ieAeQgEgOgMgZgAgpAgIgTAeIBHAXQAXgZAPgig");
	this.shape_1.setTransform(146.85,33.525);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	// _Group__1
	this.instance_1 = new lib.mo_sc3t1();
	this.instance_1.setTransform(60.6,40.95,1,1,0,0,0,56.6,28.6);
...
p.nominalBounds = new cjs.Rectangle(-7,1.4,288,103.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:125.2,y:55.6,alpha:1},14,cjs.Ease.cubicOut).to({startPosition:0},74).to({_off:true},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-7,1.4,572.9,118.1);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#87622D").s().p("");
	this.shape.setTransform(204.2,30.425);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#87622D").s().p("");
	this.shape_1.setTransform(145.85,33.425);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	// _Group__3
	this.instance_1 = new lib.mo_sc2t1();
	this.instance_1.setTransform(58.2,39.35,1,1,0,0,0,55.2,28.8);
	this.instance_1.shadow = new cjs.Shadow("rgba(255,255,255,0.8)",2,2,9);
...
p.nominalBounds = new cjs.Rectangle(-41.3,-24,272.2,108.6);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.an_light("synched",0);
	this.instance.setTransform(423.45,43.8,0.796,0.796,-4.2325,0,0,68.2,68.2);
...
p.nominalBounds = new cjs.Rectangle(6.6,-10.3,469.5,106.89999999999999);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:164.15,y:89.8,alpha:1},10,cjs.Ease.cubicOut).to({startPosition:0},75).to({_off:true},1).wait(3));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0.1,0,580.3,134.6);
...
p.nominalBounds = new cjs.Rectangle(6.6,-10.3,802.8,130.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(368.7,102.05,0.9322,0.9322,0,0,0,67.4,67.3);
	...
	this.instance_1.setTransform(220.45,44.2,0.9017,0.9017,0,0,0,67.3,67.2);
	...
	this.instance_2.setTransform(67.2,93.2,1.3841,1.3841,0,0,0,67.2,67.3);
...
p.nominalBounds = new cjs.Rectangle(-25.7,-16.4,457,202.8);
...
if (reversed == null) { reversed = false; }
	...
	// an_light_copy_copy
	this.instance_1 = new lib.an_light("synched",0);
	this.instance_1.setTransform(62,9.55,1.1052,1.1052,0,0,0,67.3,67.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(60));

	// Layer_3
	this.instance_2 = new lib.本月入主即享();
	this.instance_2.setTransform(92.15,53.45,1.1386,1.1386,0,0,0,67.6,31.4);
	this.instance_2.shadow = new cjs.Shadow("rgba(69,44,10,0.498)",2,2,3);

	this.instance_3 = new lib.車規免費升等();
	this.instance_3.setTransform(144.8,77.3,1.1386,1.1386,0,0,0,81.4,52.5);
	this.instance_3.shadow = new cjs.Shadow("rgba(69,44,10,0.698)",1,1,3);

	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(244,221,155,0)","#DFB781","#BC9362","#9B7146","#88613A","#77542F"],[0.012,0.243,0.439,0.675,0.863,1],119.8,0.1,-200.3,0.1).s().p("AysDUICTmqMAjGAADIiSGqg");
	this.shape.setTransform(241.335,46.3338,1.7138,1.7138);
...
p.nominalBounds = new cjs.Rectangle(-12.4,-64.6,458.9,164.5);
...
p.nominalBounds = new cjs.Rectangle(-25.7,-16.4,890.6,235.3);
...
p.nominalBounds = new cjs.Rectangle(-12.4,-64.6,810.6,164.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-618.95,118.5,1.4693,1.4693,0,0,0,206.2,96.4);
	...
	this.instance_1.setTransform(720.75,167.1,2.0153,2.0153,0,0,0,295.3,21.7);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(316,575.6,2.2155,2.2155,0,0,0,98.9,17.9);
	this.instance_2._off = true;
...
p.nominalBounds = new cjs.Rectangle(-959.8,-47.1,2275.2,661.5);
...
if (reversed == null) { reversed = false; }
	...
	// an_sc4_t
	this.instance = new lib.an_sc4t("synched",0,false);
	this.instance.setTransform(-288.55,330.35,1.2831,1.2831,4.248,0,0,119,111.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).wait(85).to({x:-288.6,startPosition:85},0).to({_off:true},1).wait(14));

	// sb_titlebg
	this.instance_1 = new lib.sb_titlebg("synched",0);
	this.instance_1.setTransform(-271.4,320.2,1.1841,1,0,0,0,192.7,47);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(89).to({startPosition:89},0).to({_off:true},1).wait(14));

	// an_sc4_key
	this.instance_2 = new lib.an_sc4key("synched",0,false);
	this.instance_2.setTransform(1001.25,313.9,1.875,1.875,0,0,0,427.7,81.7);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).wait(83).to({startPosition:83},0).to({_off:true},1).wait(14));

	// an_sc4_bg
	this.instance_3 = new lib.an_sc4bg("synched",0,false);
	this.instance_3.setTransform(-310,35.35,1.4801,1.4801,0,0,0,-0.1,0.1);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(1).to({_off:false},0).wait(88).to({startPosition:88},0).to({_off:true},1).wait(14));

	// an_pic_bg
	this.instance_4 = new lib.an_picbg("synched",0,false);
	this.instance_4.setTransform(167.45,239.75,1.5258,1.4262,0,12.4851,0,302.9,159.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(89).to({startPosition:89},0).to({_off:true},1).wait(14));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-499.5,-109.2,2449.7,584.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-352.6,379.05,1.3251,1.3251,3.195,0,0,119.5,54.6);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).wait(81).to({y:379.1,startPosition:81},0).to({_off:true},1).wait(7));

	// sb_titlebg
	this.instance_1 = new lib.sb_titlebg("synched",0);
	this.instance_1.setTransform(-350.65,375.15,1,1,0,0,0,192.6,47);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(82).to({startPosition:82},0).to({_off:true},1).wait(7));

	// an_sc3_pm
	this.instance_2 = new lib.an_sc3pm("synched",0,false);
	this.instance_2.setTransform(1146.25,353.35,1.8852,1.8852,4.685,0,0,434.1,63.5);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(7).to({_off:false},0).wait(75).to({startPosition:75},0).to({_off:true},1).wait(7));

	// an_sc3_39
	this.instance_3 = new lib.an_sc339("synched",0,false);
	this.instance_3.setTransform(1077,239.75,1.8852,1.8852,4.685,0,0,399.9,61.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(5).to({_off:false},0).wait(77).to({startPosition:77},0).to({_off:true},1).wait(7));

	// an_sc3_bg
	this.instance_4 = new lib.an_sc3bg("synched",0,false);
	this.instance_4.setTransform(114.75,300.25,1.4135,1.4135,1.7037,0,0,302.9,139.1);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(3).to({_off:false},0).wait(79).to({startPosition:79},0).to({_off:true},1).wait(7));

	// an_pic_bg
	this.instance_5 = new lib.an_picbg("synched",0,false);
	this.instance_5.setTransform(115,296.7,1.475,1.3787,0,14.1882,1.7037,302.9,159.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(82).to({startPosition:82},0).to({_off:true},1).wait(7));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-543.2,-25.1,2513.9,521.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(860.45,313.8,1.3937,1.3937,4.4437,0,0,163.8,89.7);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:false},0).wait(79).to({startPosition:79},0).to({_off:true},1).wait(7));

	// sb_titlebg
	this.instance_1 = new lib.sb_titlebg("synched",0);
	this.instance_1.setTransform(852.25,306.95,1.2212,1.0896,0,0,0,192.7,47);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(82).to({startPosition:82},0).to({_off:true},1).wait(7));

	// an_sc2_177
	this.instance_2 = new lib.an_sc2177("synched",0,false);
	this.instance_2.setTransform(-633.65,338.15,1.915,1.915,3.992,0,0,326.5,63.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).wait(70).to({startPosition:70},0).to({_off:true},1).wait(7));

	// an_sc2_1254
	this.instance_3 = new lib.an_sc21254("synched",0,false);
	this.instance_3.setTransform(-499.75,194.25,1.999,1.999,3.992,0,0,377.4,54.2);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).wait(75).to({startPosition:75},0).to({_off:true},1).wait(7));

	// an_sc2_bg
	this.instance_4 = new lib.an_sc2bg("synched",0,false);
	this.instance_4.setTransform(182.2,241.2,1.4545,1.4545,0,0,0,302.8,159.5);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(2).to({_off:false},0).wait(80).to({startPosition:80},0).to({_off:true},1).wait(7));

	// an_pic_bg
	this.instance_5 = new lib.an_picbg("synched",0,false);
	this.instance_5.setTransform(205.9,239.7,1.4921,1.3947,0,12.4848,0,302.9,159.6);
...
p.nominalBounds = new cjs.Rectangle(-1259.8,-101.5,2705.7,561.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1790,133,2.4521,2.4521,0,0,0,341.2,50.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(65).to({startPosition:65},0).to({_off:true},1).wait(24));

	// an_an_sc1_tt
	this.instance_1 = new lib.an_an_sc1tt("synched",0,false);
	this.instance_1.setTransform(303.6,126.6,1.4123,1.4123,0,0,0,206.6,112.1);
...
p.nominalBounds = new cjs.Rectangle(-24.6,-148.7,2935.1,426);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-179.2,350.35,1.2579,1.2583,0,0,0,74.7,62.8);
	...
	this.instance_6.setTransform(843.45,364,1,1,0,0,0,553.5,149.2);
	...
	this.instance_7.setTransform(833.85,364,1,1,0,0,0,553.5,149.2);
...
p.nominalBounds = new cjs.Rectangle(-1132.4,-89.5,3899.8,906.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(208.95,28.8,0.1849,0.1849,0,0,0,798.6,370.2);
...
p.nominalBounds = new cjs.Rectangle(12,-31.1,560.8,148.1);
// library properties:
lib.properties = {
