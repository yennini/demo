...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(75,26.575);
	...
	this.shape_1.setTransform(59.4,26.675);
	...
	this.shape_2.graphics.f("#2CFF00").s().p("AARBHQgBgMgHgJIAXABQAFAAACgDQAGgHABhEIgdAAQgHAPgFAHIgMgJIAABGIgnAAIAAALIgTAAIAAhwIARAAIADgZIAYADIgHAWIAVAAIAAATQALgSAGgZIAWAEIgHASIAqAAIAAAJIgEBHQgCAWgEAGQgFAIgLABIgNABIgLAAgAguAlIAUAAIAAgaIgUAAgAgugGIAUAAIAAgVIgUAAgAADgBIARgKIAVAgIgSAMQgEgIgQgag");
	this.shape_2.setTransform(44.45,26.645);
	...
	this.shape_3.setTransform(29.125,26.525);
	...
	this.shape_4.setTransform(13.575,27.025);
...
p.nominalBounds = new cjs.Rectangle(0,0,88,33.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(133,55,0.3764,0.3763);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// Layer_4
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("EhcsAmhQgwABAAgxMAAAhLhQAAgwAwgBMC5ZAAAQAwABABAwMAAABLhQgBAxgwgBg");
	this.shape_4.setTransform(374.1,210.4);
...
p.nominalBounds = new cjs.Rectangle(-224,-36.1,1216.9,493.1);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(322.8726,266.0062,0.603,0.3965,0,0,180);
	...
	this.shape_1.setTransform(436.409,266.0062,1.1883,0.3965);
	...
	this.instance.setTransform(175,222,0.1858,0.1858);
	...
	this.shape_2.setTransform(267.1657,270.713,1.1943,1.7059);
...
p.nominalBounds = new cjs.Rectangle(81.4,210.9,430.29999999999995,111.20000000000002);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#111723","rgba(17,21,31,0.365)","rgba(18,20,28,0)"],[0,0.784,1],-63.3,0,63.4,0).s().p("Ap5VuMAAAgrbITzAAMAAAArbg");
	this.shape.setTransform(-340.4776,136.1579,0.6751,1.5536,0,0,180);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#111723","rgba(17,21,31,0.365)","rgba(18,20,28,0)"],[0,0.784,1],-63.3,0,63.4,0).s().p("Ap5VuMAAAgrbITzAAMAAAArbg");
	this.shape_1.setTransform(-203.5217,136.1579,1.5536,1.5536);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(90));

	// sc2bg
	this.instance = new lib.sc2bg();
	this.instance.setTransform(-302,-96,0.6402,0.6426);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// Layer_3
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("EjI0BOfQgxAAAAgxMAAAibbQAAgxAxAAMGRpAAAQAxAAAAAxMAAACbbQAAAxgxAAg");
	this.shape_2.setTransform(314.625,81.9);
...
p.nominalBounds = new cjs.Rectangle(-975.5,-420.4,2580.3,1004.6);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("EhD7AfcMAPbg+uMCYcAAAMgPbA+ug");
	mask.setTransform(639.6077,201.25);
...
p.nominalBounds = new cjs.Rectangle(-892.5,-346.5,2590.3,1004.6);
...
if (reversed == null) { reversed = false; }
	...
	// sb_sc4_bg
	this.instance = new lib.sb_sc4bg("synched",0);
	this.instance.setTransform(496.95,211.45,1,1,0,0,0,262.9,175.3);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1,startPosition:7},1).to({x:486.95,startPosition:58},54).wait(35));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,1227,493.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(13.2,276.35,1,1,0,0,0,254.6,211);
	this.instance._off = true;
	...
	this.shape.setTransform(262.4634,215.3393,0.5146,0.3877,0,-90,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#201616","rgba(32,22,22,0)"],[0,1],0,-37.4,0,37.5).s().p("A4jF2IAArrMAxHAAAIAALrg");
	this.shape_1.setTransform(220.0508,215.4127,0.407,0.7533,90);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#201616","rgba(32,22,22,0)"],[0,1],0,-37.4,0,37.5).s().p("A4jF2IAArrMAxHAAAIAALrg");
	this.shape_2.setTransform(19.7754,215.4127,0.407,1.1104,90);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#201616","rgba(32,22,22,0)"],[0,1],0,-37.4,0,37.5).s().p("A4jF2IAArrMAxHAAAIAALrg");
	this.shape_3.setTransform(94.2809,211.3127,0.407,0.8876,0,-90,90);
	...
	this.instance_3.setTransform(61,151,0.1874,0.1874);
...
p.nominalBounds = new cjs.Rectangle(-266.4,121.8,832.5,207.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(189.5,214.2,0.6756,0.6755,0,0,0,29.8,9.6);
	this.instance._off = true;
	...
	this.instance_1.setTransform(200.3,235.4,0.5499,0.5497,0,0,0,56.4,11.8);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(124.3,235.9,0.3568,0.3568,0,0,0,602.9,246.8);
...
p.nominalBounds = new cjs.Rectangle(-90.8,147.8,437.90000000000003,176);
...
p.nominalBounds = new cjs.Rectangle(-67.5,170.6,440.3,111.20000000000002);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(110.4,244.5,0.5184,0.5184,0,0,0,91,23.8);
	this.instance._off = true;
	...
	this.instance_1.setTransform(127.75,181.8,0.7381,0.7381,0,0,0,34.8,135.8);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(221.3,222.9,0.7457,0.7456,0,0,0,29.7,9.6);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(241,243.95,0.7457,0.7456,0,0,0,56.1,11.6);
	this.instance_3._off = true;
	...
	this.instance_4.setTransform(130.2,224.45,0.2352,0.2352,0,0,0,310.4,202.2);
...
p.nominalBounds = new cjs.Rectangle(-152.7,-68.8,609.2,400.5);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.setTransform(170.9942,221.0993,0.3407,0.2957,90);
...
p.nominalBounds = new cjs.Rectangle(-112,15.6,832.5,400.5);
...
p.nominalBounds = new cjs.Rectangle(-379.7,-708.1,2217.6,1174.5);
// library properties:
lib.properties = {
