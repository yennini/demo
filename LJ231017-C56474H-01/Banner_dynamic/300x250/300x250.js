...
p.nominalBounds = new cjs.Rectangle(0,0,632,558);


(lib.sc2bg = function() {
	this.initialize(img.sc2bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,624,551);
...
p.nominalBounds = new cjs.Rectangle(0,0,500,441);
...
p.nominalBounds = new cjs.Rectangle(0,0,613,542);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_8
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(233.7,17.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(190.275,17.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(146.4,17.775);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AibB/QA4gSAZgjQAUgbAGguIg9AAIAAgXQgMAOgPALQgQgQgUgOQAegXAYgiQAXgjANgpIAtALQgVA9gkAwIC6AAQgiglgUgxIg5AAIAAgpIBZAAQANApAaAjQAcAjAkAUQgUAUgKASQgMgGgQgOQgDBSgEAiQgEAkgKAKQgLAPgVADQgRADgmgCQgBgWgMgWQAZACAWABQAJgBAFgFQAKgLAFhoIhHAAQgIA9gXAjQgeAvhBAYQgJgVgTgUg");
	this.shape_3.setTransform(103.725,17.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FAED56").s().p("");
	this.shape_4.setTransform(59.275,16.875);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FAED56").s().p("ABRCgIAAgWIifAAIAAAWIgsAAIAAjsIBZAAIAGgpIiDAAIAAgqIE9AAIAAAqIiJAAIgLApIB0AAIAADsgAhOBiICfAAIAAgwIifAAgAhOALICfAAIAAgvIifAAg");
	this.shape_5.setTransform(15.9,17.775);
...
p.nominalBounds = new cjs.Rectangle(0,0,250.2,34.7);
...
if (reversed == null) { reversed = false; }
	...
	// sc2_sharp
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(13,2,53,0.478)").s().p("EgvYgZ5MBexAAAMAAAAp0MhexAJ/g");
	this.shape.setTransform(303.25,165.775);
...
p.nominalBounds = new cjs.Rectangle(0,0,606.5,331.6);
...
p.nominalBounds = new cjs.Rectangle(0,0,651.8,34.7);
...
p.nominalBounds = new cjs.Rectangle(0,0,441.6,39);
...
p.nominalBounds = new cjs.Rectangle(0,0,141.5,141.5);
...
p.nominalBounds = new cjs.Rectangle(0,0,897.5,890.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(407.35,198.6,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_1 = new lib.sb_star("synched",0);
	this.instance_1.setTransform(399.95,219.45,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_2 = new lib.sb_star("synched",0);
	this.instance_2.setTransform(323,198.6,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_3 = new lib.sb_star("synched",0);
	this.instance_3.setTransform(334.4,176.1,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_4 = new lib.sb_star("synched",0);
	this.instance_4.setTransform(330.05,179.9,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_5 = new lib.sb_star("synched",0);
	this.instance_5.setTransform(383.2,79.35,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_6 = new lib.sb_star("synched",0);
	this.instance_6.setTransform(372.45,95.1,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_7 = new lib.sb_star("synched",0);
	this.instance_7.setTransform(278.35,80.35,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_8 = new lib.sb_star("synched",0);
	this.instance_8.setTransform(318.15,131.2,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_9 = new lib.sb_star("synched",0);
	this.instance_9.setTransform(274.5,137.75,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_10 = new lib.sb_star("synched",0);
	this.instance_10.setTransform(149.85,137.75,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_11 = new lib.sb_star("synched",0);
	this.instance_11.setTransform(159.4,165.55,0.1159,0.1159,0,0,0,11.7,11.7);
	...
	this.instance_13.setTransform(118.2,163.4,0.1159,0.1159,0,0,0,11.7,11.7);
	...
	this.instance_20.setTransform(559.25,238,0.4424,0.4424,24.5388,0,0,12.5,12.1);

	this.instance_21 = new lib.sb_star("synched",0);
	this.instance_21.setTransform(542.85,180.95,0.4424,0.4424,24.5388,0,0,12.5,12.1);

	this.instance_22 = new lib.sb_star("synched",0);
	this.instance_22.setTransform(429.2,133.75,0.4424,0.4424,24.5388,0,0,12.5,12.1);

	this.instance_23 = new lib.sb_star("synched",0);
	this.instance_23.setTransform(188.65,101.6,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_24 = new lib.sb_star("synched",0);
	this.instance_24.setTransform(228,264.5,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_25 = new lib.sb_star("synched",0);
	this.instance_25.setTransform(138.8,261.1,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_26 = new lib.sb_star("synched",0);
	this.instance_26.setTransform(216.75,203.65,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_27 = new lib.sb_star("synched",0);
	this.instance_27.setTransform(263.25,216.6,0.1613,0.1613,0,0,0,11.8,11.8);
	...
	// sc1_bg
	this.instance_28 = new lib.sc1bg();
	this.instance_28.setTransform(0,0,0.9994,0.9995);
...
p.nominalBounds = new cjs.Rectangle(0,0,631.7,557.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_5
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#009CEA").s().p("Ax9EBIiBoBMAl8AAAICBIBg");
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(351.2,404.95,1,1,0,0,0,187.7,9.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_sc4-tt-zero
	this.instance_1 = new lib.an_sc4ttzero("synched",0,false);
	this.instance_1.setTransform(512.7,375.6,1,1,0,0,0,138.6,9.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_sc4-tt-seat
	this.instance_2 = new lib.an_sc4ttseat("synched",0,false);
	this.instance_2.setTransform(531.55,331.75,1,1,0,0,0,137,19.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_sc3-tt-hear
	this.instance_3 = new lib.an_sc3tthear("synched",0,false);
	this.instance_3.setTransform(396.6,285.4,1,1,0,0,0,139.1,16.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_line_bottom
	this.instance_4 = new lib.an_linebottom("synched",0,false);
	this.instance_4.setTransform(525.7,96.45,1,1,180,0,0,1.7,143.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_line_top
	this.instance_5 = new lib.an_linetop("synched",0,false);
	this.instance_5.setTransform(525.7,530.25,1,1,180,0,0,1.7,63.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_line-yellow
	this.instance_6 = new lib.an_lineyellow("synched",0,false);
	this.instance_6.setTransform(569,510.35,1,1,0,0,0,5.7,115.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc4-sharp
	this.instance_7 = new lib.an_sc4sharp("synched",0,false);
	this.instance_7.setTransform(511.2,498.4,1,1,0,0,0,600.2,611.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// sb_star
	this.instance_8 = new lib.sb_star("synched",0);
	this.instance_8.setTransform(119.45,136.75,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_9 = new lib.sb_star("synched",0);
	this.instance_9.setTransform(14.3,124.85,0.1613,0.1613,0,0,0,11.8,11.8);
	this.instance_9.alpha = 0.4492;

	this.instance_10 = new lib.sb_star("synched",0);
	this.instance_10.setTransform(73.9,205.3,0.1613,0.1613,0,0,0,11.8,11.8);
	this.instance_10.alpha = 0.4492;

	this.instance_11 = new lib.sb_star("synched",0);
	this.instance_11.setTransform(14.3,61.75,0.1613,0.1613,0,0,0,11.8,11.8);
	this.instance_11.alpha = 0.4492;

	this.instance_12 = new lib.sb_star("synched",0);
	this.instance_12.setTransform(97.05,109.75,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_13 = new lib.sb_star("synched",0);
	this.instance_13.setTransform(78.3,57.35,0.1613,0.1613,0,0,0,11.8,11.8);
	this.instance_13.alpha = 0.4492;

	this.instance_14 = new lib.sb_star("synched",0);
	this.instance_14.setTransform(43.9,74,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_15 = new lib.sb_star("synched",0);
	this.instance_15.setTransform(149.85,58.35,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_16 = new lib.sb_star("synched",0);
	this.instance_16.setTransform(101.3,348.4,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_17 = new lib.sb_star("synched",0);
	this.instance_17.setTransform(114.05,86.3,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_18 = new lib.sb_star("synched",0);
	this.instance_18.setTransform(149.85,137.75,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_19 = new lib.sb_star("synched",0);
	this.instance_19.setTransform(159.4,165.55,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_20 = new lib.sb_star("synched",0);
	this.instance_20.setTransform(21.55,307.95,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_21 = new lib.sb_star("synched",0);
	this.instance_21.setTransform(118.2,163.4,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_22 = new lib.sb_star("synched",0);
	this.instance_22.setTransform(114.05,189.55,0.1159,0.1159,0,0,0,11.7,11.7);
	this.instance_22.alpha = 0.4492;

	this.instance_23 = new lib.sb_star("synched",0);
	this.instance_23.setTransform(38.05,210.1,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_24 = new lib.sb_star("synched",0);
	this.instance_24.setTransform(138.75,109.75,0.1613,0.1613,0,0,0,11.8,11.8);
	this.instance_24.alpha = 0.4492;

	this.instance_25 = new lib.sb_star("synched",0);
	this.instance_25.setTransform(177.5,61.75,0.1613,0.1613,0,0,0,11.8,11.8);
	this.instance_25.alpha = 0.4492;

	this.instance_26 = new lib.sb_star("synched",0);
	this.instance_26.setTransform(29.2,130.2,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_27 = new lib.sb_star("synched",0);
	this.instance_27.setTransform(338.9,153.3,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_28 = new lib.sb_star("synched",0);
	this.instance_28.setTransform(481.35,481.65,0.4424,0.4424,24.5388,0,0,12.5,12.1);

	this.instance_29 = new lib.sb_star("synched",0);
	this.instance_29.setTransform(590.35,528.45,0.4424,0.4424,24.5388,0,0,12.5,12.1);

	this.instance_30 = new lib.sb_star("synched",0);
	this.instance_30.setTransform(135.35,72.85,0.4424,0.4424,24.5388,0,0,12.5,12.1);

	this.instance_31 = new lib.sb_star("synched",0);
	this.instance_31.setTransform(151.2,128.3,0.4424,0.4424,24.5388,0,0,12.5,12.1);

	this.instance_32 = new lib.sb_star("synched",0);
	this.instance_32.setTransform(15.5,255.75,0.1159,0.1159,0,0,0,11.7,11.7);
	this.instance_32.alpha = 0.4492;

	this.instance_33 = new lib.sb_star("synched",0);
	this.instance_33.setTransform(77.05,240.3,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_34 = new lib.sb_star("synched",0);
	this.instance_34.setTransform(51.5,320.45,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_35 = new lib.sb_star("synched",0);
	this.instance_35.setTransform(29.2,273.1,0.1613,0.1613,0,0,0,11.8,11.8);
	this.instance_35.alpha = 0.4492;
	...
	// sc4_bg
	this.instance_36 = new lib.sc4bg();
	this.instance_36.setTransform(0,0,1.0007,1.0005);
...
p.nominalBounds = new cjs.Rectangle(-89,-113.3,1200.5,1223.5);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_88 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:461.1493,y:84.9962}).wait(88).to({graphics:mask_graphics_88,x:461.1493,y:84.9962}).wait(1).to({graphics:null,x:0,y:0}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(169.6,0,631.6,108.3);
...
p.nominalBounds = new cjs.Rectangle(0,0,654.9,557.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(362.45,453.9,1.0016,1.0016,0,0,0,280.9,95.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_line_red
	this.instance_1 = new lib.an_linered("synched",0,false);
	this.instance_1.setTransform(601.4,138.75,1,1,0,0,0,5.7,116.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_bottom
	this.instance_2 = new lib.an_linebottom("synched",0,false);
	this.instance_2.setTransform(567.25,556.25,1,1,0,0,0,1.7,143.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line_top
	this.instance_3 = new lib.an_linetop("synched",0,false);
	this.instance_3.setTransform(567.25,122.45,1,1,0,0,0,1.7,63.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc5-plus
	this.instance_4 = new lib.an_sc5plus("synched",0,false);
	this.instance_4.setTransform(543.05,332.85,1,1,0,0,0,220.8,20);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc5-tt-100w
	this.instance_5 = new lib.an_sc5tt100w("synched",0,false);
	this.instance_5.setTransform(690.65,329.15,1,1,0,0,0,325.9,17.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc5-tt-4w
	this.instance_6 = new lib.an_sc5tt4w("synched",0,false);
	this.instance_6.setTransform(593.7,282.2,1,1,0,0,0,328.7,17.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc5-tt-in
	this.instance_7 = new lib.an_sc5ttin("synched",0,false);
	this.instance_7.setTransform(622.3,234.2,1,1,0,0,0,356.2,14.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc5_btn
	this.instance_8 = new lib.an_sc5btn("synched",0,false);
	this.instance_8.setTransform(168.85,590.25,1.1217,1.1217);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(90));

	// an_sc2_sharp
	this.instance_9 = new lib.an_sc2sharp("synched",0);
	this.instance_9.setTransform(248.3,-3.95,1,1,0,0,0,448.7,445.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(90));

	// sb_sc1_bg
	this.instance_10 = new lib.sb_sc1bg("synched",0);
	this.instance_10.setTransform(348.95,308.65,1.1073,1.1073,0,0,0,315.6,278.9);
...
p.nominalBounds = new cjs.Rectangle(-200.4,-449.1,1216.9,1148.8000000000002);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(456.85,620.65,1,1,0,0,0,131.1,201.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_line_bottom
	this.instance_1 = new lib.an_linebottom("synched",0,false);
	this.instance_1.setTransform(673.9,658.35,1,1,0,0,0,1.7,143.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_top
	this.instance_2 = new lib.an_linetop("synched",0,false);
	this.instance_2.setTransform(673.9,224.55,1,1,0,0,0,1.7,63.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line-blue
	this.instance_3 = new lib.an_lineblue("synched",0,false);
	this.instance_3.setTransform(716.45,257.65,1,1,0,0,0,5.7,106.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc3-tt-TJP
	this.instance_4 = new lib.an_sc3ttTJP("synched",0,false);
	this.instance_4.setTransform(786.15,452.05,1,1,0,0,0,272.1,8.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc3-tt-LKA
	this.instance_5 = new lib.an_sc3ttLKA("synched",0,false);
	this.instance_5.setTransform(786.5,422.75,1,1,0,0,0,272.1,8.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc3-tt-ICC
	this.instance_6 = new lib.an_sc3ttICC("synched",0,false);
	this.instance_6.setTransform(740,394.95,1,1,0,0,0,318.8,8.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc3-tt-safe
	this.instance_7 = new lib.an_sc3ttsafe("synched",0,false);
	this.instance_7.setTransform(762.75,349.8,1,1,0,0,0,294.4,14.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc3-tt-porp
	this.instance_8 = new lib.an_sc3ttporp("synched",0,false);
	this.instance_8.setTransform(779.65,316.4,1,1,0,0,0,277.2,13.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(90));

	// an_sc2_sharp
	this.instance_9 = new lib.an_sc2sharp("synched",0,false);
	this.instance_9.setTransform(357.55,97.6,1,1,0,0,0,448.7,445.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(90));

	// sc3_bg
	this.instance_10 = new lib.sc3bg();
	this.instance_10.setTransform(0,0,1.6871,1.6871);
...
p.nominalBounds = new cjs.Rectangle(-91.1,-347.6,1149.8999999999999,1170.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(92.6,422.3,1,1,0,0,0,410.9,118.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_line-bottom
	this.instance_1 = new lib.an_linebottom("synched",0,false);
	this.instance_1.setTransform(536.75,487.35,1,1,0,0,0,1.7,143.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line-red
	this.instance_2 = new lib.an_linered("synched",0,false);
	this.instance_2.setTransform(571.2,68.95,1,1,0,0,0,5.7,116.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line-top
	this.instance_3 = new lib.an_linetop("synched",0,false);
	this.instance_3.setTransform(536.75,53.55,1,1,0,0,0,1.7,63.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc2-tt-369
	this.instance_4 = new lib.an_sc2tt369("synched",0,false);
	this.instance_4.setTransform(485.6,291.7,1,1,0,0,0,107.5,40);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc2-tt-239
	this.instance_5 = new lib.an_sc2tt239("synched",0,false);
	this.instance_5.setTransform(443.15,221.85,1,1,0,0,0,103.1,44.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc2-tt-vc
	this.instance_6 = new lib.an_sc2ttvc("synched",0,false);
	this.instance_6.setTransform(594.25,141.2,1,1,0,0,0,219.5,12.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc2-tt-change
	this.instance_7 = new lib.an_sc2ttchange("synched",0,false);
	this.instance_7.setTransform(597.95,172.6,1,1,0,0,0,326.2,11.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc2-sharp
	this.instance_8 = new lib.an_sc2sharp("synched",0,false);
	this.instance_8.setTransform(217.85,-73.6,1,1,0,0,0,448.7,445.2);
	...
	this.instance_29 = new lib.sb_star("synched",0);
	this.instance_29.setTransform(137.1,252.7,0.4424,0.4424,24.5388,0,0,12.5,12.1);

	this.instance_30 = new lib.sb_star("synched",0);
	this.instance_30.setTransform(310.85,72.8,0.4424,0.4424,24.5388,0,0,12.5,12.1);

	this.instance_31 = new lib.sb_star("synched",0);
	this.instance_31.setTransform(221.8,87.9,0.4424,0.4424,24.5388,0,0,12.5,12.1);
	...
	this.instance_36.setTransform(0,0,1.0003,1.0004);
...
p.nominalBounds = new cjs.Rectangle(-318.3,-518.8,1242.6,1149.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(327.75,420.1,1,1,0,0,0,243.6,80.6);
	...
	this.instance_1.setTransform(318.85,276.5,1,1,0,0,0,201,43.6);
	...
	this.instance_2.setTransform(320.25,519.95,1,1,0,0,0,194,12.5);
	...
	this.instance_3.setTransform(315.15,278.9,1,1,0,0,0,327.4,278.9);
...
p.nominalBounds = new cjs.Rectangle(-12.2,0,654.9000000000001,557.7);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(223.7155,353.9888,0.0749,0.0749);
	...
	this.shape_6.setTransform(212.5292,333.7183,0.0749,0.0749);
	...
	this.shape_7.setTransform(227.0587,333.7183,0.0749,0.0749);
	...
	// scc5
	this.instance = new lib.scc5("synched",0,false);
	this.instance.setTransform(318.85,381.85,0.5,0.5,0,0,0,349.4,313.9);
	this.instance.alpha = 0.4492;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(360).to({_off:false},0).to({alpha:1,startPosition:6},6).wait(84));

	// sc4
	this.instance_1 = new lib.sc4("synched",0,false);
	this.instance_1.setTransform(318.8,403.85,0.5,0.5,0,0,0,309.3,273.9);
	this.instance_1.alpha = 0.4492;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(270).to({_off:false},0).to({alpha:1,startPosition:7},7).to({_off:true},90).wait(83));

	// sc3
	this.instance_2 = new lib.sc3("synched",0,false);
	this.instance_2.setTransform(301.55,360.1,0.5,0.5,0,0,0,421.8,372.4);
	this.instance_2.alpha = 0.4492;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(180).to({_off:false},0).to({alpha:1,startPosition:7},7).to({_off:true},91).wait(172));

	// sc2
	this.instance_3 = new lib.sc2("synched",0,false);
	this.instance_3.setTransform(315.2,398.9,0.5,0.5,0,0,0,312.1,279);
	this.instance_3.alpha = 0.4492;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90).to({_off:false},0).to({alpha:1,startPosition:9},9).to({_off:true},89).wait(262));

	// sc1
	this.instance_4 = new lib.sc1("synched",0,false);
	this.instance_4.setTransform(318.55,397.85,0.5,0.5,0,0,0,315.8,278.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},100).wait(350));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,719.9,821.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(191.75,127.5,1,1,0,0,0,359.9,410.9);
...
p.nominalBounds = new cjs.Rectangle(-18.2,-158.4,570,697);
// library properties:
lib.properties = {
