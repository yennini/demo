...
if (reversed == null) { reversed = false; }
	...
	this.shape_4.setTransform(250.3007,46.2794,1.5678,1.5678);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AggAJIAAgRIBBAAIAAARg");
	this.shape_5.setTransform(228.1953,44.9468,1.5678,1.5678);
	...
	this.shape_6.setTransform(211.0282,49.6501,1.5678,1.5678);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAYBGQgagfgagXQAUgZAbgYIAcAAQglAdgPATQALAJAVAVIAXAZgAgxBGIAAiLIASAAIAACLg");
	this.shape_7.setTransform(193.7828,43.6534,1.5678,1.5678);
	...
	this.shape_8.setTransform(221.7282,11.5142,1.5678,1.5678);
	...
	this.shape_9.setTransform(195.233,11.475,1.5678,1.5678);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_3.setTransform(211.2629,55.9836,1.582,1.582);
	...
	this.shape_4.setTransform(187.018,49.2204,1.582,1.582);
	...
	this.shape_5.setTransform(218.5403,15.2459,1.582,1.582);
	...
	this.shape_6.setTransform(187.5322,15.8392,1.582,1.582);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-2248.3803,282.6303,1.6443,1.7868,0.526);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["rgba(0,0,0,0)","#000000","rgba(0,0,0,0)"],[0,0.42,1],-155.6,0,155.6,0).s().p("EgYTAuJMAAAhcRMAwnAAAMAAABcRg");
	this.shape_1.setTransform(-1591.4667,269.6569,1.2801,1.8073,-52.4458);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-1757.471,286.3017);

	// sc4_bg_copy
	this.instance_22 = new lib.sc4bg();
	this.instance_22.setTransform(-2289,-225,2.7089,2.7085);
	...
	this.instance_23.setTransform(-2045,106,1.9517,1.9514);
...
p.nominalBounds = new cjs.Rectangle(-2509.1,-328.8,3348.3999999999996,1223.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-291.25,182.85,1,1.3684,0,0,0,5.7,116.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_bottom
	this.instance_2 = new lib.an_linebottom("synched",0,false);
	this.instance_2.setTransform(-325.4,628.65,1,1.1494,0,0,0,1.7,143.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_sc5_btn
	this.instance_3 = new lib.an_sc5btn("synched",0,false);
	this.instance_3.setTransform(59.95,405.2,1.8191,1.8191,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_line_top
	this.instance_4 = new lib.an_linetop("synched",0,false);
	this.instance_4.setTransform(-325.4,220.9,1,1.3684,0,0,0,1.7,63.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc5_plus
	this.instance_5 = new lib.an_sc5plus("synched",0,false);
	this.instance_5.setTransform(-447.9,410.35,1.3867,1.3867,0,0,0,220.9,20.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc5_tt_100w
	this.instance_6 = new lib.an_sc5tt100w("synched",0,false);
	this.instance_6.setTransform(-233.25,403.65,1.3867,1.3867,0,0,0,326.1,17.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc5_tt_4w
	this.instance_7 = new lib.an_sc5tt4w("synched",0,false);
	this.instance_7.setTransform(-681.65,403.35,1.3867,1.3867,0,0,0,328.8,17.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc5_tt_in
	this.instance_8 = new lib.an_sc5ttin("synched",0,false);
	this.instance_8.setTransform(-307.95,316.4,1.9541,1.9541,0,0,0,356.2,14.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1593,531.15,1.0089,1.0089,0,0,0,131.2,201.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_line_bottom
	this.instance_1 = new lib.an_linebottom("synched",0,false);
	this.instance_1.setTransform(547.55,591,0.7472,0.6425,0,0,0,1.8,143.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_top
	this.instance_2 = new lib.an_linetop("synched",0,false);
	this.instance_2.setTransform(547.55,331.6,0.7472,1.1034,0,0,0,1.8,63.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line_blue
	this.instance_3 = new lib.an_lineblue("synched",0,false);
	this.instance_3.setTransform(579.3,384.6,0.7472,1.4564,0,0,0,5.7,106.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc3_tt_TJP
	this.instance_4 = new lib.an_sc3ttTJP("synched",0,false);
	this.instance_4.setTransform(658.05,520.45,2.2603,2.2603,0,0,0,272.1,9.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc3_tt_LKA
	this.instance_5 = new lib.an_sc3ttLKA("synched",0,false);
	this.instance_5.setTransform(145.85,518.8,2.2603,2.2603,0,0,0,272.2,8.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc3_tt_ICC
	this.instance_6 = new lib.an_sc3ttICC("synched",0,false);
	this.instance_6.setTransform(-471.55,516.2,2.2603,2.2603,0,0,0,318.9,9.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc3_tt_safe
	this.instance_7 = new lib.an_sc3ttsafe("synched",0,false);
	this.instance_7.setTransform(631.8,433.05,2.6552,2.6552,0,0,0,294.4,14.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc3_tt_porp
	this.instance_8 = new lib.an_sc3ttporp("synched",0,false);
	this.instance_8.setTransform(38.75,430.4,2.6552,2.6552,0,0,0,277.2,13.7);
	...
	this.instance_10.setTransform(-2461,86,2.4521,2.4521);
...
p.nominalBounds = new cjs.Rectangle(-2461,-86.6,4069.9,1806.6);
...
if (reversed == null) { reversed = false; }
	...
	// an_line_bottom
	this.instance_1 = new lib.an_linebottom("synched",0,false);
	this.instance_1.setTransform(319.8,394.4,0.8428,0.8993,0,0,0,1.7,143.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_red
	this.instance_2 = new lib.an_linered("synched",0,false);
	this.instance_2.setTransform(268.05,148.35,0.8428,1.476,0,0,0,5.7,116.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line_top
	this.instance_3 = new lib.an_linetop("synched",0,false);
	this.instance_3.setTransform(239.05,125.6,0.8428,1.476,0,0,0,1.7,63.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc2_tt_369
	this.instance_4 = new lib.an_sc2tt369("synched",0,false);
	this.instance_4.setTransform(-89.15,310.8,1.4099,1.4099,0,0,0,107.5,40);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc2_tt_239
	this.instance_5 = new lib.an_sc2tt239("synched",0,false);
	this.instance_5.setTransform(-453.65,312.1,1.4099,1.4099,0,0,0,103.2,44.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc2_tt_vc
	this.instance_6 = new lib.an_sc2ttvc("synched",0,false);
	this.instance_6.setTransform(-489.75,224.8,2.097,2.097,0,0,0,219.6,12.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc2_tt_change
	this.instance_7 = new lib.an_sc2ttchange("synched",0,false);
	this.instance_7.setTransform(256.95,228.3,2.4729,2.4729,0,0,0,326.3,11.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-730.8,322.15,1.474,1.474,0,0,0,243.5,80.7);
	...
	this.instance_1.setTransform(41.7,298.5,1.5789,1.5789,0,0,0,201,43.6);
	...
	this.instance_2.setTransform(-1631.7,285.6,2.1381,2.1381,0,0,0,194,12.8);
	...
	this.instance_3.setTransform(-434.2,317.6,1.4703,1.4703,0,0,0,327.4,278.8);
...
p.nominalBounds = new cjs.Rectangle(-2162.2,-109.9,3405.6,869);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1037.35,406.75,1.5767,1.5767,0,0,0,37.3,31.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(900.3,46.6,0.6018,0.6018,0,0,0,360.2,410.8);
...
p.nominalBounds = new cjs.Rectangle(459.5,-98.2,1336.4,693.8000000000001);
// library properties:
lib.properties = {
