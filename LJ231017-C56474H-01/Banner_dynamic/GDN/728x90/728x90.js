...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,1,1).p("AA0hYIhnCx");
	this.shape.setTransform(207.375,8.875);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_8
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(177,8.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(154.3,8.825);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(131.275,8.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("");
	this.shape_4.setTransform(108.3,8.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(85.375,8.75);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgJBXIAAgbIhLAAIAAgQIBLAAIAAgNIg4AAIABhJIA3AAIAAgMIhFAAIAAgQIBFAAIAAgQIARAAIAAAQIBHAAIAAAQIhHAAIAAAMIA5AAIAABJIg5AAIAAANIBNAAIAAAQIhNAAIAAAbgAAIARIAnAAIAAgQIgnAAgAgvARIAmAAIAAgQIgmAAgAAIgMIAnAAIAAgPIgnAAgAgvgMIAmAAIAAgQIgmAAg");
	this.shape_6.setTransform(62.425,8.725);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAsBNIgJgcIhIAAIgIAcIgnAAQAbhVAghEIAzAAQAjBLAYBOgAgaASIAzAAQgOgmgLgdQgLAZgPAqg");
	this.shape_7.setTransform(38.075,8.125);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAaBOQgagmgiglQARgdAmgyIAyAAQgrAxgUAbQAVAUAuA6gAhKBNIAAiaIAlAAIAACag");
	this.shape_8.setTransform(21.425,8.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("Ag2BNIABiZIAkAAIAAB6IBIAAIAAAfg");
	this.shape_9.setTransform(5.475,8.075);
...
p.nominalBounds = new cjs.Rectangle(0,-1,213.6,19.8);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,1,1).p("AA0hYIhnCx");
	this.shape.setTransform(298.475,8.925);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer_9
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(270.325,9.15);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("");
	this.shape_2.setTransform(246.575,9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("");
	this.shape_3.setTransform(222.65,9.05);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhWBMQAdgVAFg2IASACIgFAXQAKAYAVAKIAAhHIgrAAIAAgRIBpAAIAAARIgsAAIAAAaIA2AAIAAARIg2AAIAAAhQAKACARAAIAyAAQgFAHgBALIgtAAQggAAgQgIQgVgIgMgVQgKAZgRAPQgGgHgIgFgAA9gWIABgaIh6gBIAAAbIgRAAIAAgrIBHAAIgIgRIARgFQAHALADALIBDAAIgBArg");
	this.shape_4.setTransform(198.6,8.95);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("");
	this.shape_5.setTransform(174.675,8.975);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(150.7,8.95);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhPBRIAAgQIBGABIAAgcIgzAAIAAgQIAzAAIAAgYIgqAAIAAgPQgLAHgOAIQgFgIgGgHQAkgPAfggIgfAAIAAgRIA8AAQAMATAXARQAVARAXAJQgIAIgEAIQgLgFgNgIIAAAOIgrAAIAAAYIAzABIAAAPIgzAAIAAAcIBHAAIAAAQgAgzgRIBlAAQgdgUgVgbQgUAZgfAWg");
	this.shape_7.setTransform(126.7,8.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(102.675,8.625);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("");
	this.shape_9.setTransform(78.675,8.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("");
	this.shape_10.setTransform(54.15,8.725);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgpA9QgbgVAAgoQAAgmAdgWQAYgTAlAAQAZAAAWAGIAAAiQgWgIgWAAQgaAAgOAMQgOAMAAAXQAAAXAQANQANAMAZAAQAVAAAXgIIAAAjQgZAFgXAAQgnAAgXgTg");
	this.shape_11.setTransform(30.7,8.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgpA9QgbgVAAgoQABgmAcgWQAYgTAlAAQAYAAAWAHIAAAgQgWgHgVAAQg1AAgBAvQAAAXAQANQANAMAYAAQARAAAcgIIgBAjQgaAFgVAAQgnAAgXgTg");
	this.shape_12.setTransform(14.375,8.175);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgSBNIABiZIAkAAIgBCZg");
	this.shape_13.setTransform(1.875,8.125);
...
p.nominalBounds = new cjs.Rectangle(0,-0.9,304.7,19.7);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_4.setTransform(250.2661,46.3176,1.5677,1.5677);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AggAJIAAgRIBBAAIAAARg");
	this.shape_5.setTransform(228.1615,44.9851,1.5677,1.5677);
	...
	this.shape_6.setTransform(210.9952,49.6882,1.5677,1.5677);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAYBGQgagfgagXQAUgZAbgYIAcAAQglAdgPATQALAJAVAVIAXAZgAgxBGIAAiLIASAAIAACLg");
	this.shape_7.setTransform(193.7504,43.6917,1.5677,1.5677);
	...
	this.shape_8.setTransform(221.6947,11.5538,1.5677,1.5677);
	...
	this.shape_9.setTransform(195.2006,11.5146,1.5677,1.5677);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_3.setTransform(211.2314,56.026,1.582,1.582);
	...
	this.shape_4.setTransform(186.9874,49.2631,1.582,1.582);
	...
	this.shape_5.setTransform(218.5085,15.2899,1.582,1.582);
	...
	this.shape_6.setTransform(187.5016,15.8832,1.582,1.582);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.setTransform(280.571,7.4174,1.3535,1.3535);
	...
	this.shape_3.setTransform(230.4376,7.5189,1.3535,1.3535);
	...
	this.shape_4.setTransform(146.5989,7.5866,1.3535,1.3535);
	...
	this.shape_5.setTransform(96.2624,7.3497,1.3535,1.3535);
	...
	this.shape_6.setTransform(45.7567,7.5189,1.3535,1.3535);
	...
	this.shape_7.setTransform(-4.5283,7.6204,1.3535,1.3535);
...
p.nominalBounds = new cjs.Rectangle(-14.5,-2.7,405.9,20.3);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CCCCCC").s().p("");
	this.shape.setTransform(198.65,37.325);
...
p.nominalBounds = new cjs.Rectangle(-8.2,-12.6,413.7,99.89999999999999);
...
p.nominalBounds = new cjs.Rectangle(0,-1,572.4,19.8);
...
p.nominalBounds = new cjs.Rectangle(0,-0.9,663.5,19.7);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Egj1ADcIAAm4MBHrAAAIAAG4g");
	mask.setTransform(212.0779,15.05);
...
p.nominalBounds = new cjs.Rectangle(1.4,1.8,413.70000000000005,35.300000000000004);
...
p.nominalBounds = new cjs.Rectangle(5.4,0,413.70000000000005,57.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-848,-12,2.364,2.3641);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// sb_star
	this.instance_1 = new lib.sb_star("synched",0);
	this.instance_1.setTransform(497.65,132.3,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_2 = new lib.sb_star("synched",0);
	this.instance_2.setTransform(407.35,198.6,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_3 = new lib.sb_star("synched",0);
	this.instance_3.setTransform(399.95,219.45,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_4 = new lib.sb_star("synched",0);
	this.instance_4.setTransform(323,198.6,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_5 = new lib.sb_star("synched",0);
	this.instance_5.setTransform(334.4,176.1,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_6 = new lib.sb_star("synched",0);
	this.instance_6.setTransform(330.05,179.9,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_7 = new lib.sb_star("synched",0);
	this.instance_7.setTransform(383.2,79.35,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_8 = new lib.sb_star("synched",0);
	this.instance_8.setTransform(372.45,95.1,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_9 = new lib.sb_star("synched",0);
	this.instance_9.setTransform(278.35,80.35,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_10 = new lib.sb_star("synched",0);
	this.instance_10.setTransform(318.15,131.2,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_11 = new lib.sb_star("synched",0);
	this.instance_11.setTransform(274.5,137.75,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_12 = new lib.sb_star("synched",0);
	this.instance_12.setTransform(79.4,237.55,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_13 = new lib.sb_star("synched",0);
	this.instance_13.setTransform(298.8,286.55,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_14 = new lib.sb_star("synched",0);
	this.instance_14.setTransform(523.15,83.15,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_15 = new lib.sb_star("synched",0);
	this.instance_15.setTransform(20.05,191.15,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_16 = new lib.sb_star("synched",0);
	this.instance_16.setTransform(278.9,210.1,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_17 = new lib.sb_star("synched",0);
	this.instance_17.setTransform(214.75,76.8,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_18 = new lib.sb_star("synched",0);
	this.instance_18.setTransform(435.3,184.8,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_19 = new lib.sb_star("synched",0);
	this.instance_19.setTransform(338.9,153.3,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_20 = new lib.sb_star("synched",0);
	this.instance_20.setTransform(559.25,238,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_21 = new lib.sb_star("synched",0);
	this.instance_21.setTransform(542.85,180.95,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_22 = new lib.sb_star("synched",0);
	this.instance_22.setTransform(429.2,133.75,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_23 = new lib.sb_star("synched",0);
	this.instance_23.setTransform(228,264.5,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_24 = new lib.sb_star("synched",0);
	this.instance_24.setTransform(138.8,261.1,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_25 = new lib.sb_star("synched",0);
	this.instance_25.setTransform(216.75,203.65,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_26 = new lib.sb_star("synched",0);
	this.instance_26.setTransform(263.25,216.6,0.1613,0.1613,0,0,0,11.8,11.8);
...
p.nominalBounds = new cjs.Rectangle(-848,-12,2293.1,591);
...
p.nominalBounds = new cjs.Rectangle(-14.5,-2.7,405.9,30.3);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_25 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(25).to({graphics:mask_graphics_25,x:198.65,y:37.325}).wait(72));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-428.45,238.55,1.9133,1.9133,0,0,0,187.8,9.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_sc4_tt_zero
	this.instance_1 = new lib.an_sc4ttzero("synched",0,false);
	this.instance_1.setTransform(-121.95,344.65,1.9133,1.9133,0,0,0,138.7,9.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_sc4_tt_seat
	this.instance_2 = new lib.an_sc4ttseat("synched",0,false);
	this.instance_2.setTransform(-499.45,330.35,1.685,1.685,0,0,0,137.1,19.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_sc3_tt_hear
	this.instance_3 = new lib.an_sc3tthear("synched",0,false);
	this.instance_3.setTransform(-958.85,224.8,2.0393,2.0393,0,0,0,139.2,16.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_line_bottom
	this.instance_4 = new lib.an_linebottom("synched",0,false);
	this.instance_4.setTransform(35.55,136.3,0.8561,0.8684,180,0,0,1.7,143.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_line_top
	this.instance_5 = new lib.an_linetop("synched",0,false);
	this.instance_5.setTransform(35.55,415.2,0.8561,1.2537,180,0,0,1.7,63.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_line_yellow
	this.instance_6 = new lib.an_lineyellow("synched",0,false);
	this.instance_6.setTransform(72.65,406.85,0.8561,1.7988,0,0,0,5.7,115.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc4_sharp
	this.instance_7 = new lib.an_sc4sharp("synched",0,false);
	this.instance_7.setTransform(-150.85,282.85,1,1,0,0,0,600.2,611.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// sb_star
	this.instance_8 = new lib.sb_star("synched",0);
	this.instance_8.setTransform(-556.85,373.9,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_9 = new lib.sb_star("synched",0);
	this.instance_9.setTransform(-546,443.45,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_10 = new lib.sb_star("synched",0);
	this.instance_10.setTransform(313.7,298.55,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_11 = new lib.sb_star("synched",0);
	this.instance_11.setTransform(496.1,85.5,0.1159,0.1159,0,0,0,11.7,11.7);
	this.instance_11.alpha = 0.4492;

	this.instance_12 = new lib.sb_star("synched",0);
	this.instance_12.setTransform(486.75,79.35,0.1159,0.1159,0,0,0,11.7,11.7);
	this.instance_12.alpha = 0.4492;

	this.instance_13 = new lib.sb_star("synched",0);
	this.instance_13.setTransform(574.1,373.65,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_14 = new lib.sb_star("synched",0);
	this.instance_14.setTransform(494.35,333.2,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_15 = new lib.sb_star("synched",0);
	this.instance_15.setTransform(-156.65,178.55,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_16 = new lib.sb_star("synched",0);
	this.instance_16.setTransform(-14.2,506.9,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_17 = new lib.sb_star("synched",0);
	this.instance_17.setTransform(94.8,553.7,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_18 = new lib.sb_star("synched",0);
	this.instance_18.setTransform(488.3,281,0.1159,0.1159,0,0,0,11.7,11.7);
	this.instance_18.alpha = 0.4492;

	this.instance_19 = new lib.sb_star("synched",0);
	this.instance_19.setTransform(549.85,265.55,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_20 = new lib.sb_star("synched",0);
	this.instance_20.setTransform(524.3,345.7,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_21 = new lib.sb_star("synched",0);
	this.instance_21.setTransform(502,298.35,0.1613,0.1613,0,0,0,11.8,11.8);
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(0,6,32,0)","#000620","rgba(0,0,0,0)"],[0,0.42,1],-155.6,0,155.6,0).s().p("EgYTAuJMAAAhcRMAwnAAAMAAABcRg");
	this.shape.setTransform(-2116.1303,283.7803,1.6443,1.7868,0.526);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["rgba(0,0,0,0)","#000000","rgba(0,0,0,0)"],[0,0.42,1],-155.6,0,155.6,0).s().p("EgYTAuJMAAAhcRMAwnAAAMAAABcRg");
	this.shape_1.setTransform(-1423.5167,296.3069,1.2801,1.8073,-52.4458);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-1627.471,286.3017);

	// sc4_bg_copy
	this.instance_22 = new lib.sc4bg();
	this.instance_22.setTransform(-2159,-225,2.7089,2.7085);
	...
	// sc4_bg
	this.instance_23 = new lib.sc4bg();
	this.instance_23.setTransform(-2030,124,1.8579,1.8576);

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(90));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2376.8,-328.8,2954.1000000000004,1223.4);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:360.2963,y:85.0339}).wait(88).to({graphics:mask_graphics_88,x:360.2963,y:85.0339}).wait(1).to({graphics:null,x:0,y:0}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-678.4,-152.8,2293.1,282.4);
...
p.nominalBounds = new cjs.Rectangle(-848,-12,2316.4,591);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1507.5,393.15,1.1085,1.1085,0,0,0,280.6,95.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_line_red
	this.instance_1 = new lib.an_linered("synched",0,false);
	this.instance_1.setTransform(-328.15,189.7,0.9717,1.3296,0,0,0,5.7,116.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_bottom
	this.instance_2 = new lib.an_linebottom("synched",0,false);
	this.instance_2.setTransform(-361.35,622.9,0.9717,1.1169,0,0,0,1.7,143.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_sc5_btn
	this.instance_3 = new lib.an_sc5btn("synched",0,false);
	this.instance_3.setTransform(-32,405.95,1.5763,1.5763,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_line_top
	this.instance_4 = new lib.an_linetop("synched",0,false);
	this.instance_4.setTransform(-361.35,226.7,0.9717,1.3296,0,0,0,1.7,63.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc5_plus
	this.instance_5 = new lib.an_sc5plus("synched",0,false);
	this.instance_5.setTransform(-480.4,410.85,1.3474,1.3474,0,0,0,220.9,20.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc5_tt_100w
	this.instance_6 = new lib.an_sc5tt100w("synched",0,false);
	this.instance_6.setTransform(-271.8,404.3,1.3474,1.3474,0,0,0,326.1,17.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc5_tt_4w
	this.instance_7 = new lib.an_sc5tt4w("synched",0,false);
	this.instance_7.setTransform(-707.45,404,1.3474,1.3474,0,0,0,328.8,17.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc5_tt_in
	this.instance_8 = new lib.an_sc5ttin("synched",0,false);
	this.instance_8.setTransform(-344.35,319.55,1.8988,1.8988,0,0,0,356.2,14.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(90));

	// an_sc2_sharp
	this.instance_9 = new lib.an_sc2sharp("synched",0);
	this.instance_9.setTransform(-778.25,794.55,1,1.2143,180,0,0,448.7,445.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(90));

	// sb_sc1_bg
	this.instance_10 = new lib.sb_sc1bg("synched",0);
	this.instance_10.setTransform(-1396.65,403.95,0.864,0.864,0,0,0,315.7,279);
...
p.nominalBounds = new cjs.Rectangle(-2402,-92.5,4033.8,1624);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1516.55,531.15,1.0089,1.0089,0,0,0,131.2,201.9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_line_bottom
	this.instance_1 = new lib.an_linebottom("synched",0,false);
	this.instance_1.setTransform(236.3,568.05,0.6549,0.5631,0,0,0,1.8,143.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_top
	this.instance_2 = new lib.an_linetop("synched",0,false);
	this.instance_2.setTransform(236.3,340.75,0.6549,0.9671,0,0,0,1.8,63.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line_blue
	this.instance_3 = new lib.an_lineblue("synched",0,false);
	this.instance_3.setTransform(264.15,387.15,0.6549,1.2766,0,0,0,5.8,106.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc3_tt_TJP
	this.instance_4 = new lib.an_sc3ttTJP("synched",0,false);
	this.instance_4.setTransform(333.1,506.25,1.9811,1.9811,0,0,0,272.1,9.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc3_tt_LKA
	this.instance_5 = new lib.an_sc3ttLKA("synched",0,false);
	this.instance_5.setTransform(-115.8,504.8,1.9811,1.9811,0,0,0,272.2,8.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc3_tt_ICC
	this.instance_6 = new lib.an_sc3ttICC("synched",0,false);
	this.instance_6.setTransform(-656.95,502.5,1.9811,1.9811,0,0,0,318.9,9.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc3_tt_safe
	this.instance_7 = new lib.an_sc3ttsafe("synched",0,false);
	this.instance_7.setTransform(310.15,429.55,2.3273,2.3273,0,0,0,294.4,14.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc3_tt_porp
	this.instance_8 = new lib.an_sc3ttporp("synched",0,false);
	this.instance_8.setTransform(-209.65,427.25,2.3273,2.3273,0,0,0,277.2,13.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(90));

	// an_sc2_sharp
	this.instance_9 = new lib.an_sc2sharp("synched",0,false);
	this.instance_9.setTransform(-801.15,900.2,1,1.3508,180,0,0,448.7,445.1);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(0,6,32,0)","#000620","rgba(0,0,0,0)"],[0,0.42,1],-155.6,0,155.6,0).s().p("EgYTAuJMAAAhcRMAwnAAAMAAABcRg");
	this.shape.setTransform(-1016.7796,576.782,2.9041,1.7868,-14.4731);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["rgba(0,6,32,0)","#000620","rgba(0,0,0,0)"],[0,0.42,1],-155.6,0,155.6,0).s().p("EgYTAuJMAAAhcRMAwnAAAMAAABcRg");
	this.shape_1.setTransform(-1827.6796,576.782,2.9041,1.7868,-14.4731);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(90));

	// sc3_bg
	this.instance_10 = new lib.sc3bg();
	this.instance_10.setTransform(-2261,129,2.1025,2.1025);
...
p.nominalBounds = new cjs.Rectangle(-2397.1,-86.6,4006,1806.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1663.15,336.55,1.266,1.266,0,0,0,410.9,118.7);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_line_bottom
	this.instance_1 = new lib.an_linebottom("synched",0,false);
	this.instance_1.setTransform(23.05,377.3,0.7149,0.7628,0,0,0,1.8,143.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_red
	this.instance_2 = new lib.an_linered("synched",0,false);
	this.instance_2.setTransform(-20.85,168.6,0.7149,1.252,0,0,0,5.8,116.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line_top
	this.instance_3 = new lib.an_linetop("synched",0,false);
	this.instance_3.setTransform(-45.45,149.35,0.7149,1.252,0,0,0,1.8,63.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc2_tt_369
	this.instance_4 = new lib.an_sc2tt369("synched",0,false);
	this.instance_4.setTransform(-323.9,306.4,1.1959,1.1959,0,0,0,107.5,40);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc2_tt_239
	this.instance_5 = new lib.an_sc2tt239("synched",0,false);
	this.instance_5.setTransform(-633.1,307.5,1.1959,1.1959,0,0,0,103.2,44.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc2_tt_vc
	this.instance_6 = new lib.an_sc2ttvc("synched",0,false);
	this.instance_6.setTransform(-663.9,233.55,1.7789,1.7789,0,0,0,219.5,13);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc2_tt_change
	this.instance_7 = new lib.an_sc2ttchange("synched",0,false);
	this.instance_7.setTransform(-30.3,236.4,2.0977,2.0977,0,0,0,326.3,11.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc2_sharp
	this.instance_8 = new lib.an_sc2sharp("synched",0,false);
	this.instance_8.setTransform(-679.3,1037.95,1.3848,1.7951,180,0,0,448.8,445.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(90));

	// sb_star
	this.instance_9 = new lib.sb_star("synched",0);
	this.instance_9.setTransform(-1652.1,-30,0.3551,0.3551,0,0,0,11.6,12.1);

	this.instance_10 = new lib.sb_star("synched",0);
	this.instance_10.setTransform(-1668.4,15.85,0.3551,0.3551,0,0,0,11.6,12.2);

	this.instance_11 = new lib.sb_star("synched",0);
	this.instance_11.setTransform(-1837.8,-30,0.3551,0.3551,0,0,0,11.6,12.1);

	this.instance_12 = new lib.sb_star("synched",0);
	this.instance_12.setTransform(-1812.7,-79.5,0.3551,0.3551,0,0,0,11.4,12.2);

	this.instance_13 = new lib.sb_star("synched",0);
	this.instance_13.setTransform(-1822.25,-71.15,0.3551,0.3551,0,0,0,11.6,12.1);

	this.instance_14 = new lib.sb_star("synched",0);
	this.instance_14.setTransform(-1705.25,-292.6,0.3551,0.3551,0,0,0,11.6,11.2);

	this.instance_15 = new lib.sb_star("synched",0);
	this.instance_15.setTransform(-1728.9,-257.9,0.3551,0.3551,0,0,0,11.4,11.7);

	this.instance_16 = new lib.sb_star("synched",0);
	this.instance_16.setTransform(-1936.1,-290.4,0.2552,0.2552,0,0,0,11.2,11.2);

	this.instance_17 = new lib.sb_star("synched",0);
	this.instance_17.setTransform(-1848.45,-178.45,0.2552,0.2552,0,0,0,11.6,11.2);

	this.instance_18 = new lib.sb_star("synched",0);
	this.instance_18.setTransform(-1944.6,-164,0.2552,0.2552,0,0,0,11.2,11.6);

	this.instance_19 = new lib.sb_star("synched",0);
	this.instance_19.setTransform(-2218.95,-164,0.2552,0.2552,0,0,0,11,11.6);

	this.instance_20 = new lib.sb_star("synched",0);
	this.instance_20.setTransform(-2198,-102.8,0.2552,0.2552,0,0,0,11,11.6);

	this.instance_21 = new lib.sb_star("synched",0);
	this.instance_21.setTransform(-1891.05,163.55,0.2552,0.2552,0,0,0,11.6,12);

	this.instance_22 = new lib.sb_star("synched",0);
	this.instance_22.setTransform(-2288.55,-107.55,0.2552,0.2552,0,0,0,11.6,11.6);

	this.instance_23 = new lib.sb_star("synched",0);
	this.instance_23.setTransform(-2297.75,-49.9,0.2552,0.2552,0,0,0,11.3,12.3);

	this.instance_24 = new lib.sb_star("synched",0);
	this.instance_24.setTransform(-1934.85,-4.7,0.3551,0.3551,0,0,0,11.6,11.8);

	this.instance_25 = new lib.sb_star("synched",0);
	this.instance_25.setTransform(-2243.35,-225.65,0.3551,0.3551,0,0,0,11.6,11.8);

	this.instance_26 = new lib.sb_star("synched",0);
	this.instance_26.setTransform(-2076.1,-298.2,0.3551,0.3551,0,0,0,11.2,11.4);

	this.instance_27 = new lib.sb_star("synched",0);
	this.instance_27.setTransform(-1590.6,-60.4,0.3551,0.3551,0,0,0,11.4,11.8);

	this.instance_28 = new lib.sb_star("synched",0);
	this.instance_28.setTransform(-1802.75,-129.8,0.3551,0.3551,0,0,0,11.4,11.7);

	this.instance_29 = new lib.sb_star("synched",0);
	this.instance_29.setTransform(-2238.05,89.05,0.9737,0.9737,24.5349,0,0,12.5,12.2);

	this.instance_30 = new lib.sb_star("synched",0);
	this.instance_30.setTransform(-1855.65,-306.95,0.9737,0.9737,24.5349,0,0,12.3,12);

	this.instance_31 = new lib.sb_star("synched",0);
	this.instance_31.setTransform(-2051.75,-273.7,0.9737,0.9737,24.5349,0,0,12.3,12.1);

	this.instance_32 = new lib.sb_star("synched",0);
	this.instance_32.setTransform(-2046.9,115,0.2552,0.2552,0,0,0,11.2,12);

	this.instance_33 = new lib.sb_star("synched",0);
	this.instance_33.setTransform(-2243.3,107.55,0.2552,0.2552,0,0,0,11,12);

	this.instance_34 = new lib.sb_star("synched",0);
	this.instance_34.setTransform(-2071.7,-18.95,0.2552,0.2552,0,0,0,11,12);

	this.instance_35 = new lib.sb_star("synched",0);
	this.instance_35.setTransform(-1969.35,9.6,0.3551,0.3551,0,0,0,11.6,12.1);
	...
	this.instance_36.setTransform(-2605,-278,3.5423,3.5427);
...
p.nominalBounds = new cjs.Rectangle(-2605,-328.4,5263.3,2455.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1263.1,322.1,1.3609,1.3609,0,0,0,243.5,80.7);
	...
	this.instance_1.setTransform(-389.15,257.9,1.3029,1.3029,0,0,0,201,43.6);
	...
	this.instance_2.setTransform(-385.2,372.5,1.8688,1.8688,0,0,0,194,13);
	...
	this.instance_3.setTransform(-1047.55,317.55,1.0921,1.0921,0,0,0,327.4,278.8);
...
p.nominalBounds = new cjs.Rectangle(-2331.1,0,2529.6,645.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-857.45,406.8,1.3248,1.3248,0,0,0,37.2,31.4);
	...
	this.shape.setTransform(335.1401,437.6877,4.9256,0.5743);
...
p.nominalBounds = new cjs.Rectangle(-1178.1,95.2,3026.5,1228);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(779.3,46.6,0.6018,0.6018,0,0,0,360.2,410.8);
...
p.nominalBounds = new cjs.Rectangle(217.5,-98.2,1457.4,693.8000000000001);
// library properties:
lib.properties = {
