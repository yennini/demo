...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,1.2465,1.2462);
...
p.nominalBounds = new cjs.Rectangle(0,0,561,190.7);
...
p.nominalBounds = new cjs.Rectangle(0,0,487,161.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(707.55,412.8,1.8288,1.8288,0,0,0,187.8,9.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_sc4_tt_zero
	this.instance_1 = new lib.an_sc4ttzero("synched",0,false);
	this.instance_1.setTransform(1002.85,359.3,1.8288,1.8288,0,0,0,138.7,9.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_sc4_tt_seat
	this.instance_2 = new lib.an_sc4ttseat("synched",0,false);
	this.instance_2.setTransform(1044.5,280.7,1.6105,1.6105,0,0,0,137,19.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_sc3_tt_hear
	this.instance_3 = new lib.an_sc3tthear("synched",0,false);
	this.instance_3.setTransform(827.25,206.15,1.6105,1.6105,0,0,0,139.1,16.2);
	...
	this.instance_22.setTransform(-904,-19,2.4604,2.4601);
...
p.nominalBounds = new cjs.Rectangle(-904,-126.6,2575.9,1242.3999999999999);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(14.45,435.95,1.3544,1.3544,0,0,0,280.9,95.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_sc5_btn
	this.instance_1 = new lib.an_sc5btn("synched",0,false);
	this.instance_1.setTransform(901.25,478.15,1.4681,1.4681);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_red
	this.instance_2 = new lib.an_linered("synched",0,false);
	this.instance_2.setTransform(995.8,113.45,1,1.3684,0,0,0,5.7,116.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line_bottom
	this.instance_3 = new lib.an_linebottom("synched",0,false);
	this.instance_3.setTransform(961.65,628.65,1,1.1494,0,0,0,1.7,143.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_line_top
	this.instance_4 = new lib.an_linetop("synched",0,false);
	this.instance_4.setTransform(961.65,91.2,1,1.3684,0,0,0,1.7,63.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc5_plus
	this.instance_5 = new lib.an_sc5plus("synched",0,false);
	this.instance_5.setTransform(1038.05,344.15,1.2829,1.2829,0,0,0,220.8,20.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc5_tt_100w
	this.instance_6 = new lib.an_sc5tt100w("synched",0,false);
	this.instance_6.setTransform(1236.5,337.8,1.2829,1.2829,0,0,0,325.9,17.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc5_tt_4w
	this.instance_7 = new lib.an_sc5tt4w("synched",0,false);
	this.instance_7.setTransform(821.8,337.5,1.2829,1.2829,0,0,0,328.7,17.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc5_tt_in
	this.instance_8 = new lib.an_sc5ttin("synched",0,false);
	this.instance_8.setTransform(990.55,240.45,1.4093,1.4093,0,0,0,356.2,14.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(90));

	// an_sc2_sharp
	this.instance_9 = new lib.an_sc2sharp("synched",0);
	this.instance_9.setTransform(796.3,794.55,1,1.2143,180,0,0,448.7,445.1);
...
p.nominalBounds = new cjs.Rectangle(-1077.2,-92.5,4283.5,1624);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(1251.35,749.95,1,0.8599,0,0,0,1.7,143.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(90));

	// an_line_top
	this.instance_2 = new lib.an_linetop("synched",0,false);
	this.instance_2.setTransform(1251.35,168.5,1,1.4767,0,0,0,1.7,63.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line_blue
	this.instance_3 = new lib.an_lineblue("synched",0,false);
	this.instance_3.setTransform(1293.9,217.25,1,1.4767,0,0,0,5.7,106.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc3_tt_TJP
	this.instance_4 = new lib.an_sc3ttTJP("synched",0,false);
	this.instance_4.setTransform(1421.2,564.7,1.6683,1.6683,0,0,0,272.1,9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc3_tt_LKA
	this.instance_5 = new lib.an_sc3ttLKA("synched",0,false);
	this.instance_5.setTransform(1421.75,515.65,1.6683,1.6683,0,0,0,272.1,8.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc3_tt_ICC
	this.instance_6 = new lib.an_sc3ttICC("synched",0,false);
	this.instance_6.setTransform(1344.15,469.45,1.6683,1.6683,0,0,0,318.8,9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc3_tt_safe
	this.instance_7 = new lib.an_sc3ttsafe("synched",0,false);
	this.instance_7.setTransform(1382.1,394.1,1.6683,1.6683,0,0,0,294.4,14.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc3_tt_porp
	this.instance_8 = new lib.an_sc3ttporp("synched",0,false);
	this.instance_8.setTransform(1410.35,338.25,1.6683,1.6683,0,0,0,277.2,13.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(90));

	// an_sc2_sharp
	this.instance_9 = new lib.an_sc2sharp("synched",0,false);
	this.instance_9.setTransform(836.35,885.15,1,1.3508,180,0,0,448.7,445.1);
...
p.nominalBounds = new cjs.Rectangle(-745,-101.6,3991.4,1806.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-223.45,407.4,1.582,1.582,0,0,0,410.9,118.5);
	...
	this.instance_4.setTransform(993.25,324.6,1.3815,1.3815,0,0,0,107.5,40);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc2_tt_239
	this.instance_5 = new lib.an_sc2tt239("synched",0,false);
	this.instance_5.setTransform(654.3,325.8,1.3815,1.3815,0,0,0,103.2,44.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc2_tt_vc
	this.instance_6 = new lib.an_sc2ttvc("synched",0,false);
	this.instance_6.setTransform(1126.6,182.35,1.69,1.69,0,0,0,219.5,12.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc2_tt_change
	this.instance_7 = new lib.an_sc2ttchange("synched",0,false);
	this.instance_7.setTransform(1132.85,235.4,1.69,1.69,0,0,0,326.2,11.2);
...
p.nominalBounds = new cjs.Rectangle(-881,-240.5,4294.6,1733.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(828.2,256.95,1.3891,1.3891,0,0,0,201,43.6);
	...
	this.instance_2.setTransform(838.15,410.35,1.3891,1.3891,0,0,0,194.1,12.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-181.7,326.8,1.3521,1.3521,0,0,0,37.4,31.4);
...
p.nominalBounds = new cjs.Rectangle(-394.5,123.1,2260.5,903.3000000000001);


// stage content:
(lib._970x250test = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(520.35,127.1,0.836,0.836,0,0,0,359.9,410.9);
...
p.nominalBounds = new cjs.Rectangle(374.7,11.5,1404.6,630.1);
// library properties:
lib.properties = {
