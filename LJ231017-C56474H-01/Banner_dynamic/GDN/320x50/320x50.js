...
if (reversed == null) { reversed = false; }
	...
	this.instance_22.setTransform(-657,-34,2.2463,2.246);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_9.setTransform(358.65,403.95,0.864,0.864,0,0,0,315.7,279);
...
p.nominalBounds = new cjs.Rectangle(-646.7,-92.5,3806.8999999999996,1624);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_4.setTransform(1308.9,560.3,1.7931,1.7931,0,0,0,272.1,9.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc3_tt_LKA
	this.instance_5 = new lib.an_sc3ttLKA("synched",0,false);
	this.instance_5.setTransform(1309.65,507.55,1.7931,1.7931,0,0,0,272.2,8.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc3_tt_ICC
	this.instance_6 = new lib.an_sc3ttICC("synched",0,false);
	this.instance_6.setTransform(1226.2,457.75,1.7931,1.7931,0,0,0,318.9,9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc3_tt_safe
	this.instance_7 = new lib.an_sc3ttsafe("synched",0,false);
	this.instance_7.setTransform(1239.55,383.5,1.3549,1.3549,0,0,0,294.4,14.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc3_tt_porp
	this.instance_8 = new lib.an_sc3ttporp("synched",0,false);
	this.instance_8.setTransform(937.05,382.25,1.3549,1.3549,0,0,0,277.3,13.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(90));

	// an_sc2_sharp
	this.instance_9 = new lib.an_sc2sharp("synched",0,false);
	this.instance_9.setTransform(896.85,900.2,1,1.3508,180,0,0,448.7,445.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(90));

	// sc3_bg
	this.instance_10 = new lib.sc3bg();
	this.instance_10.setTransform(-735,86,2.4521,2.4521);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(1005.9,171.4,0.8428,1.476,0,0,0,5.7,116.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line_top
	this.instance_3 = new lib.an_linetop("synched",0,false);
	this.instance_3.setTransform(976.9,148.65,0.8428,1.476,0,0,0,1.7,63.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc2_tt_369
	this.instance_4 = new lib.an_sc2tt369("synched",0,false);
	this.instance_4.setTransform(817.25,347.15,1.1644,1.1644,0,0,0,107.5,40);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc2_tt_239
	this.instance_5 = new lib.an_sc2tt239("synched",0,false);
	this.instance_5.setTransform(516.2,348.3,1.1644,1.1644,0,0,0,103.2,44.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc2_tt_vc
	this.instance_6 = new lib.an_sc2ttvc("synched",0,false);
	this.instance_6.setTransform(959.1,210,1.8311,1.8311,0,0,0,219.6,12.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc2_tt_change
	this.instance_7 = new lib.an_sc2ttchange("synched",0,false);
	this.instance_7.setTransform(966.05,267.65,1.8311,1.8311,0,0,0,326.4,11.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(86.55,322.15,1.474,1.474,0,0,0,243.5,80.7);
	...
	this.instance_1.setTransform(794.05,264.7,1.2213,1.2213,0,0,0,201,43.6);
	...
	this.instance_2.setTransform(810.3,373.9,1.6413,1.6413,0,0,0,194.2,12.7);
...
p.nominalBounds = new cjs.Rectangle(-314.8,101.6,2058.9,932.3000000000001);
...
p.nominalBounds = new cjs.Rectangle(109.5,-52.5,528.4,286.6);
// library properties:
lib.properties = {
