...
p.nominalBounds = new cjs.Rectangle(0,0,461,237);
...
p.nominalBounds = new cjs.Rectangle(0,0,1000,339);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.5614,0.5615);
...
p.nominalBounds = new cjs.Rectangle(0,0,561.4,190.4);
...
p.nominalBounds = new cjs.Rectangle(0,0,72,89.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.999,0.9994);
...
p.nominalBounds = new cjs.Rectangle(0,0,460.6,236.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(385.5,454.2,3.1497,3.1485,0,0,0,113.4,141.3);
...
p.nominalBounds = new cjs.Rectangle(28.3,9.3,226.79999999999998,282.59999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(532.75,27,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_1 = new lib.sb_star("synched",0);
	this.instance_1.setTransform(442.45,93.3,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_2 = new lib.sb_star("synched",0);
	this.instance_2.setTransform(435.05,114.15,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_3 = new lib.sb_star("synched",0);
	this.instance_3.setTransform(358.1,93.3,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_4 = new lib.sb_star("synched",0);
	this.instance_4.setTransform(369.5,70.8,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_5 = new lib.sb_star("synched",0);
	this.instance_5.setTransform(365.15,74.6,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_6 = new lib.sb_star("synched",0);
	this.instance_6.setTransform(418.3,-25.95,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_7 = new lib.sb_star("synched",0);
	this.instance_7.setTransform(407.55,-10.2,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_8 = new lib.sb_star("synched",0);
	this.instance_8.setTransform(313.45,-24.95,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_9 = new lib.sb_star("synched",0);
	this.instance_9.setTransform(353.25,25.9,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_10 = new lib.sb_star("synched",0);
	this.instance_10.setTransform(309.6,32.45,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_11 = new lib.sb_star("synched",0);
	this.instance_11.setTransform(114.5,132.25,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_12 = new lib.sb_star("synched",0);
	this.instance_12.setTransform(333.9,181.25,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_13 = new lib.sb_star("synched",0);
	this.instance_13.setTransform(558.25,-22.15,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_14 = new lib.sb_star("synched",0);
	this.instance_14.setTransform(55.15,85.85,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_15 = new lib.sb_star("synched",0);
	this.instance_15.setTransform(314,104.8,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_16 = new lib.sb_star("synched",0);
	this.instance_16.setTransform(249.85,-28.5,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_17 = new lib.sb_star("synched",0);
	this.instance_17.setTransform(470.4,79.5,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_18 = new lib.sb_star("synched",0);
	this.instance_18.setTransform(374,48,0.1613,0.1613,0,0,0,11.8,11.8);

	this.instance_19 = new lib.sb_star("synched",0);
	this.instance_19.setTransform(469.65,180.9,0.4424,0.4424,24.5398,0,0,12.5,12.1);

	this.instance_20 = new lib.sb_star("synched",0);
	this.instance_20.setTransform(263.1,159.2,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_21 = new lib.sb_star("synched",0);
	this.instance_21.setTransform(173.9,155.8,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_22 = new lib.sb_star("synched",0);
	this.instance_22.setTransform(251.85,98.35,0.1159,0.1159,0,0,0,11.7,11.7);

	this.instance_23 = new lib.sb_star("synched",0);
	this.instance_23.setTransform(298.35,111.3,0.1613,0.1613,0,0,0,11.8,11.8);
	...
	// sc1_bg
	this.instance_24 = new lib.sc1bg();
	this.instance_24.setTransform(24,-146,0.8785,0.8784);
...
p.nominalBounds = new cjs.Rectangle(24,-146,562.3,843.3);
...
p.nominalBounds = new cjs.Rectangle(0,0,487.3,161.2);
...
p.nominalBounds = new cjs.Rectangle(-241.1,-466.9,1276.8,1775.8000000000002);
...
p.nominalBounds = new cjs.Rectangle(-0.1,0,262.20000000000005,403.5);
...
p.nominalBounds = new cjs.Rectangle(0,0,821.9,237.1);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_88 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:292.7561,y:139.197}).wait(88).to({graphics:mask_graphics_88,x:292.7561,y:139.197}).wait(1).to({graphics:null,x:0,y:0}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(193.6,-121.6,562.1999999999999,369.5);
...
p.nominalBounds = new cjs.Rectangle(24,-146,585.5,843.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(361.95,473.1,0.907,0.907,0,0,0,281.1,95.5);
	...
	this.instance_1.setTransform(597.45,-143.05,1,3.3824,0,0,0,5.8,116.2);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(528.949,684.6009);

	// an_line_bottom
	this.instance_2 = new lib.an_linebottom("synched",0,false);
	this.instance_2.setTransform(529.9,780.85,1,2.748,0,0,0,1.7,143.5);
	...
	this.instance_3.setTransform(563.15,-180.8,0.924,5.0347,0,0,0,1.8,63.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({_off:true},90).wait(30));

	// an_sc5_plus
	this.instance_4 = new lib.an_sc5plus("synched",0,false);
	this.instance_4.setTransform(426.95,329.05,0.9461,0.9461,0,0,0,220.8,20.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},90).wait(30));

	// an_sc5_tt_100w
	this.instance_5 = new lib.an_sc5tt100w("synched",0,false);
	this.instance_5.setTransform(567.3,323.85,0.9461,0.9461,0,0,0,325.9,17.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},90).wait(30));

	// an_sc5_tt_4w
	this.instance_6 = new lib.an_sc5tt4w("synched",0,false);
	this.instance_6.setTransform(591.05,278.3,0.9461,0.9461,0,0,0,328.8,17.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},90).wait(30));

	// an_sc5_tt_in
	this.instance_7 = new lib.an_sc5ttin("synched",0,false);
	this.instance_7.setTransform(618.2,213.5,1.1332,1.1332,0,0,0,356.2,14.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},90).wait(30));

	// an_sc5_btn
	this.instance_8 = new lib.an_sc5btn("synched",0,false);
	this.instance_8.setTransform(146.55,603.7,1.034,1.034,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({_off:true},90).wait(30));

	// an_sc2_sharp
	this.instance_9 = new lib.an_sc2sharp("synched",0);
	this.instance_9.setTransform(248.3,-72.45,1,1.2143,0,0,0,448.7,445.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:true},90).wait(30));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000620","rgba(0,6,32,0)"],[0,1],-178.9,0,179,0).s().p("Egb8AodMAAAhQ5MA36AAAMAAABQ5g");
	this.shape.setTransform(372.0737,113.5433,1.1279,1.9127,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000620","rgba(0,6,32,0)"],[0,1],-178.9,0,179,0).s().p("Egb8AodMAAAhQ5MA36AAAMAAABQ5g");
	this.shape_1.setTransform(372.0763,700.0731,0.7283,1.9127,-90);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_1},{t:this.shape}]},89).to({state:[]},1).to({state:[{t:this.shape_1},{t:this.shape}]},1).wait(29));

	// sb_sc1_bg
	this.instance_10 = new lib.sb_sc1bg("synched",0);
	this.instance_10.setTransform(357.4,442.25,1.2393,1.2393,0,0,0,315.5,279.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({_off:true},90).wait(30));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-256.2,-1033.6,1277.9,2044.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(452.95,638.15,0.8348,0.8348,0,0,0,131.2,202.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90));

	// an_line_bottom
	this.instance_1 = new lib.an_linebottom("synched",0,false);
	this.instance_1.setTransform(674,890.3,1,2.7592,0,0,0,1.8,143.5);
	...
	this.instance_4.setTransform(795.15,455.25,1.1952,1.1952,0,0,0,272.1,9);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc3_tt_LKA
	this.instance_5 = new lib.an_sc3ttLKA("synched",0,false);
	this.instance_5.setTransform(795.7,420.1,1.1952,1.1952,0,0,0,272.2,8.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc3_tt_ICC
	this.instance_6 = new lib.an_sc3ttICC("synched",0,false);
	this.instance_6.setTransform(740,387.15,1.1952,1.1952,0,0,0,318.8,9.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc3_tt_safe
	this.instance_7 = new lib.an_sc3ttsafe("synched",0,false);
	this.instance_7.setTransform(767.2,333.05,1.1952,1.1952,0,0,0,294.4,14.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(90));

	// an_sc3_tt_porp
	this.instance_8 = new lib.an_sc3ttporp("synched",0,false);
	this.instance_8.setTransform(787.5,293,1.1952,1.1952,0,0,0,277.3,13.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(90));

	// an_sc2_sharp
	this.instance_9 = new lib.an_sc2sharp("synched",0,false);
	this.instance_9.setTransform(355.4,-51.1,1,1.3509,0,0,0,448.7,445.1);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000620","rgba(0,6,32,0)"],[0,1],-178.9,0,179,0).s().p("Egb8AodMAAAhQ5MA36AAAMAAABQ5g");
	this.shape.setTransform(476.6737,264.732,1.389,1.9127,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000620","rgba(0,6,32,0)"],[0,1],-178.9,0,179,0).s().p("Egb8AodMAAAhQ5MA36AAAMAAABQ5g");
	this.shape_1.setTransform(485.0763,808.6731,0.7283,1.9127,-90);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(90));

	// sc3_bg
	this.instance_10 = new lib.sc3bg();
	this.instance_10.setTransform(149,10,0.9482,0.9482);
...
p.nominalBounds = new cjs.Rectangle(-149.1,-1120.3,1270.1,2406);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(90.6,436.5,0.96,0.96,0,0,0,410.8,118.5);
	...
	this.instance_2.setTransform(571.2,-217.2,1,3.2352,0,0,0,5.7,116.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90));

	// an_line_top
	this.instance_3 = new lib.an_linetop("synched",0,false);
	this.instance_3.setTransform(536.75,-241.05,1,5.3225,0,0,0,1.7,63.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(90));

	// an_sc2_tt_369
	this.instance_4 = new lib.an_sc2tt369("synched",0,false);
	this.instance_4.setTransform(469.15,289.7,0.993,0.993,0,0,0,107.5,40.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(90));

	// an_sc2_tt_239
	this.instance_5 = new lib.an_sc2tt239("synched",0,false);
	this.instance_5.setTransform(427.05,220.35,0.993,0.993,0,0,0,103.2,44.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(90));

	// an_sc2_tt_vc
	this.instance_6 = new lib.an_sc2ttvc("synched",0,false);
	this.instance_6.setTransform(577.1,140.25,0.993,0.993,0,0,0,219.6,12.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(90));

	// an_sc2_tt_change
	this.instance_7 = new lib.an_sc2ttchange("synched",0,false);
	this.instance_7.setTransform(580.8,171.45,0.993,0.993,0,0,0,326.3,11.3);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000620","rgba(0,6,32,0)"],[0,1],-178.9,0,179,0).s().p("Egb8AodMAAAhQ5MA36AAAMAAABQ5g");
	this.shape.setTransform(400.3737,67.3211,1.2401,1.9127,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000620","rgba(0,6,32,0)"],[0,1],-178.9,0,179,0).s().p("Egb8AodMAAAhQ5MA36AAAMAAABQ5g");
	this.shape_1.setTransform(435.5763,622.794,0.6981,1.9127,-90);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(90));

	// sc2_bg
	this.instance_36 = new lib.sc2bg();
	this.instance_36.setTransform(9,-162,0.9628,0.9629);
...
p.nominalBounds = new cjs.Rectangle(-303.7,-1173.3,1234.5,2274);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(327.85,398.4,1.0422,1.0422,0,0,0,243.7,80.7);
	...
	this.instance_1.setTransform(329.1,221.4,0.9209,0.9209,0,0,0,201,43.6);
	...
	this.instance_2.setTransform(320.25,511.55,1,1,0,0,0,194,12.5);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000620","rgba(0,6,32,0)"],[0,1],-178.9,0,179,0).s().p("Egb8AodMAAAhQ5MA36AAAMAAABQ5g");
	this.shape.setTransform(372.0737,47.1433,1.1279,1.9127,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000620","rgba(0,6,32,0)"],[0,1],-178.9,0,179,0).s().p("Egb8AodMAAAhQ5MA36AAAMAAABQ5g");
	this.shape_1.setTransform(372.0763,633.6731,0.7283,1.9127,-90);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_1},{t:this.shape}]},99).to({state:[]},1).wait(20));

	// an_sc1_bg
	this.instance_3 = new lib.an_sc1bg("synched",0,false);
	this.instance_3.setTransform(321.6,324.8,1.1288,1.1288,0,0,0,327.4,278.8);
...
p.nominalBounds = new cjs.Rectangle(-123.1,-154.7,990.4,951.9000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(206.35,313.55,0.7009,0.7009,0,0,0,37.4,31.3);
...
p.nominalBounds = new cjs.Rectangle(7.3,-386.2,674.7,1307.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(410.5,485.5,2.1401,2.1401,0,0,0,359.9,410.9);
...
p.nominalBounds = new cjs.Rectangle(-24.1,-740.3,1123.8999999999999,2318.1);
// library properties:
lib.properties = {
