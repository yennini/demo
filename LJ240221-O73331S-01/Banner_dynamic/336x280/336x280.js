...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(1440.9124,2286.15);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(419.05,234.25,1,1,0,0,0,189.4,130.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(169.15,382.2);
	this.instance._off = true;
	...
	this.instance_2.setTransform(311.6,275.7,1.0672,1.0672,0,0,0,244.1,140.4);
	this.instance_2._off = true;
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(168.65,150.3,0.56,0.56,0,0,0,1403,2201);
...
p.nominalBounds = new cjs.Rectangle(-449,-942.1,1403.4,2325);
// library properties:
lib.properties = {
