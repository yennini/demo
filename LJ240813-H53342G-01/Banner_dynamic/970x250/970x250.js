...
if (reversed == null) { reversed = false; }
	...
	// Layer_13
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#221916").s().p("EhJnAWoQiXgBhTh+QhSh/A9iKMAWNgkhQAhhLBGguQBFgsBTgBMB9EAAAQB0ABBRBRQBSBSAABzMAAAAkhQAABzhSBSQhRBSh0AAgEg1BgUuQgvAegXA0MgWNAkgQgUAtAEAuQAEAwAaAoQAbApApAXQAqAWAxABMCTRAAAQBOAAA4g4QA3g4AAhNMAAAgkhQAAhOg3g3Qg4g3hOgBMh9EAAAQg4ABgvAeg");
	this.shape.setTransform(499.3035,144.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("EhJoAVOQgwgBgqgWQgqgXgagpQgbgogEgwQgDguATgtMAWOgkgQAWg0AvgeQAvgeA4gBMB9FAAAQBOABA3A3QA3A3AABOMAAAAkhQAABNg3A4Qg3A4hOAAg");
	this.shape_1.setTransform(499.3734,144.75);
...
p.nominalBounds = new cjs.Rectangle(0,0,998.6,289.5);
...
}).prototype = getMCSymbolPrototype(lib.scbg, new cjs.Rectangle(382,238,1974,508.79999999999995), null);
...
p.nominalBounds = new cjs.Rectangle(47.1,-0.2,1035.5,300.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(2197.75,609.75,3.3658,3.3658,0,0,0,265.1,112.8);
	...
	this.instance_1.setTransform(1031.25,574.7,2.7947,2.7947,0,0,0,114.9,98.5);
	...
	this.instance_2.setTransform(863.3,220.2,3.3308,3.3308,0,0,0,99.7,25.9);
	...
	this.instance_3.setTransform(624.8,475.2,2.7947,2.7947,0,0,0,41.6,41.5);
	...
	this.instance_4.setTransform(117.95,619,2.7947,2.7947,0,0,0,217,16.4);
	...
	this.instance_5.setTransform(144.55,473.75,2.7947,2.7947,0,0,0,138.4,19.9);
	...
	this.instance_6.setTransform(1290.15,510.9,1.5808,2.1847,-56.2238,0,0,164.1,1.7);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(12).to({_off:false},0).wait(81).to({startPosition:81},0).to({_off:true},1).wait(56));

	// an_sc2_camp
	this.instance_7 = new lib.an_sc2camp("synched",0,false);
	this.instance_7.setTransform(1938.45,669.6,2.7947,2.7947,0,0,0,211.1,20.4);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(9).to({_off:false},0).wait(84).to({startPosition:84},0).to({_off:true},1).wait(56));

	// an_sc2_21
	this.instance_8 = new lib.an_sc221("synched",0,false);
	this.instance_8.setTransform(2016.45,528.05,2.7947,2.7947,0,0,0,218,24.9);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(10).to({_off:false},0).wait(83).to({startPosition:83},0).to({_off:true},1).wait(56));

	// an_sc2_limit
	this.instance_9 = new lib.an_sc2limit("synched",0,false);
	this.instance_9.setTransform(2091.75,352.65,2.7947,2.7947,0,0,0,205,26.1);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(12).to({_off:false},0).wait(81).to({startPosition:81},0).to({_off:true},1).wait(56));

	// an_sc2_frame_white
	this.instance_10 = new lib.an_sc2framewhite("synched",0,false);
	this.instance_10.setTransform(1235.85,604.45,2.1848,2.1848,0,0,0,630,195.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(93).to({startPosition:89},0).to({_off:true},1).wait(56));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-488.5,9,3578.5,979.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1766,613,1,1,0,0,0,500,295);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1,startPosition:7},7,cjs.Ease.cubicOut).to({startPosition:88},81).to({_off:true},1).wait(1));

	// sb_sc1_car1
	this.instance_1 = new lib.sb_sc1car1("synched",0);
	this.instance_1.setTransform(2524,622,1,1,0,0,0,500,242);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:1,startPosition:7},7,cjs.Ease.cubicOut).to({startPosition:88},81).to({_off:true},1).wait(1));

	// an_sc1_giftgo
	this.instance_2 = new lib.an_sc1_giftgo("synched",0,false);
	this.instance_2.setTransform(-4.05,613.05,2.6699,2.6699,0,0,0,109.1,85.9);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(14).to({_off:false},0).wait(74).to({startPosition:44},0).to({_off:true},1).wait(1));

	// an_sc1_4w
	this.instance_3 = new lib.an_sc14w("synched",0,false);
	this.instance_3.setTransform(1275.1,660.85,2.1086,2.1086,0,0,0,363.5,27.4);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(3).to({_off:false},0).wait(85).to({startPosition:48},0).to({_off:true},1).wait(1));

	// an_sc_plus_copy
	this.instance_4 = new lib.an_scplus("synched",0,false);
	this.instance_4.setTransform(478.7,658.15,2.1086,2.1086,0,0,0,28.5,28.5);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(7).to({_off:false},0).wait(81).to({startPosition:44},0).to({_off:true},1).wait(1));

	// an_sc1_high
	this.instance_5 = new lib.an_sc1high("synched",0,false);
	this.instance_5.setTransform(1257.5,787.5,2.1086,2.1086,0,0,0,386.9,27.7);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(7).to({_off:false},0).wait(81).to({startPosition:54},0).to({_off:true},1).wait(1));

	// an_sc_plus
	this.instance_6 = new lib.an_scplus("synched",0,false);
	this.instance_6.setTransform(412.2,783.5,2.1086,2.1086,0,0,0,28.5,28.5);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(8).to({_off:false},0).wait(80).to({startPosition:44},0).to({_off:true},1).wait(1));

	// an_sc_free
	this.instance_7 = new lib.an_scfree("synched",0,false);
	this.instance_7.setTransform(318.8,313.75,2.4346,2.4346,0,0,0,41.5,41.6);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(4).to({_off:false},0).wait(84).to({startPosition:44},0).to({_off:true},1).wait(1));

	// an_sc1_io
	this.instance_8 = new lib.an_sc1io("synched",0,false);
	this.instance_8.setTransform(360.25,352.95,2.4346,2.4346,0,0,0,260.6,29.9);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(3).to({_off:false},0).wait(85).to({startPosition:60},0).to({_off:true},1).wait(1));

	// an_sc1_record
	this.instance_9 = new lib.an_sc1record("synched",0,false);
	this.instance_9.setTransform(347.55,481.85,2.4346,2.4346,0,0,0,262.2,13.7);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(2).to({_off:false},0).wait(86).to({startPosition:44},0).to({_off:true},1).wait(1));

	// an_sc1_title
	this.instance_10 = new lib.an_sc1title("synched",0,false);
	this.instance_10.setTransform(610.55,148.9,2.4346,2.4346,0,0,0,157.6,29.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(88).to({startPosition:39},0).to({_off:true},1).wait(1));

	// an_sc1_frame_yellow
	this.instance_11 = new lib.an_sc1frameyellow("synched",0,false);
	this.instance_11.setTransform(1206.5,367.15,2.4346,2.4346,0,0,0,535.5,90.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(88).to({startPosition:44},0).to({_off:true},1).wait(1));

	// an_sc1_frame_white
	this.instance_12 = new lib.an_sc1framewhite("synched",0,false);
	this.instance_12.setTransform(16.4,723.45,2.1086,2.1086,0,0,0,660.9,92.1);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(7).to({_off:false},0).wait(81).to({startPosition:44},0).to({_off:true},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-295.3,2.4,3319.3,907.3000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(253.5858,149.8935,1.2537,1.2537);
	...
	this.shape_1.setTransform(147.9335,149.8935,1.2537,1.2537);
	...
	this.shape_6.setTransform(175.1237,199.5799,1.2537,1.2537);
	...
	this.shape_7.setTransform(175.1237,100.2236,1.2537,1.2537);
	...
	this.instance_2.setTransform(2454.65,601,3.129,3.129,0,0,0,1304.5,842.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(90).to({startPosition:0},0).wait(97));

	// sc_bg
	this.instance_3 = new lib.scbg();
	this.instance_3.setTransform(302.45,262.35,0.9866,0.9866,0,0,0,675.1,472.3);
...
p.nominalBounds = new cjs.Rectangle(-179.2,-339.8,2305.2,1135.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(234.35,54.75,0.5167,0.5166,0,0,0,499.1,142.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(360).to({regY:142,scaleY:0.5167,y:54.7,mode:"single",startPosition:179},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(369,-69.2,706,461.8);
// library properties:
lib.properties = {
