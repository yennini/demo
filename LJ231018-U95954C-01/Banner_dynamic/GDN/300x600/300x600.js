...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(213.262,16.5831,0.3536,0.3536);
	...
	this.shape_1.setTransform(185.5605,16.6914,0.3536,0.3536);
	...
	this.shape_2.setTransform(157.8678,17.1576,0.3536,0.3536);
	...
	this.shape_3.setTransform(130.1876,16.7051,0.7162,0.7162);
	...
	this.shape_4.setTransform(95.8998,9.9368,0.7162,0.7162);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#F3E727").s().p("AjRDpQBEhvBch6QBNhnAkgjIjvAAIARheIFwAAIgNBKQhTBfhTBxQhPBvgpBIg");
	this.shape_5.setTransform(62.1828,9.9189,0.7162,0.7162);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mo_sc42888, new cjs.Rectangle(47.2,-7.4,177.89999999999998,35.2), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1.setTransform(942.8179,959.2667,0.9044,2.5377,-90);
...
p.nominalBounds = new cjs.Rectangle(0.3,-24.8,200,56);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_20 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(20).to({graphics:mask_graphics_20,x:96.2379,y:0.6066}).wait(27));
...
p.nominalBounds = new cjs.Rectangle(0,-24.8,508.1,57.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(352.3,55.5,1.1846,1.1846,0,0,0,115.5,26);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(89));

	// an_sc4_2888
	this.instance_1 = new lib.an_sc42888("synched",0,false);
	this.instance_1.setTransform(337.55,-6.05,1.4773,1.4773,0,0,0,96.6,0.2);
...
p.nominalBounds = new cjs.Rectangle(172.8,-39.6,765.5,548.9);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:49},77).to({alpha:0.4492},8).to({_off:true},1).wait(105).to({_off:false,regX:748.5,scaleX:0.4601,scaleY:0.4601,x:523.05,y:311.35,alpha:0,startPosition:0},0).to({alpha:1,startPosition:6},6).to({startPosition:49},79).to({regX:748.6,scaleX:0.3763,scaleY:0.3763,x:547.45,y:341.15},8).to({startPosition:49},89).wait(1));
	...
	this.instance_6.setTransform(578.4,213.25,0.3644,0.3644,0,0,0,697.8,490.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({startPosition:0},77).to({alpha:0},8).to({_off:true},1).wait(190).to({_off:false},0).to({alpha:1},9).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(77).to({_off:false},0).to({startPosition:0},111).to({regX:697.1,regY:490,scaleX:0.3977,scaleY:0.3977,x:531.55,y:221.3},13).to({startPosition:0},75).to({regX:696.8,regY:489.8,scaleX:0.3732,scaleY:0.3732,x:460.85,y:214.9,alpha:0},9).wait(89));
