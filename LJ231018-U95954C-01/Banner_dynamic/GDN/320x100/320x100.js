...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(108.2563,13.3242,0.7251,0.7251);
	...
	this.shape_1.setTransform(68.9923,13.2699,0.7251,0.7251);
	...
	this.shape_2.setTransform(27.3354,13.288,0.7251,0.7251);
	...
	this.shape_3.setTransform(-11.8017,13.2699,0.7251,0.7251);
	...
	this.shape_4.setTransform(-52.1534,13.1067,0.7251,0.7251);
	...
	this.shape_5.setTransform(-91.49,13.723,0.7251,0.7251);
	...
	this.shape_6.setTransform(288.5518,13.9043,0.7251,0.7251);
	...
	this.shape_7.setTransform(251.6081,14.0856,0.7251,0.7251);
	...
	this.shape_8.setTransform(215.4076,14.0131,0.7251,0.7251);
	...
	this.shape_9.setTransform(177.7025,13.8137,0.7251,0.7251);
	...
	this.shape_10.setTransform(234.0207,13.2234,0.7251,0.7251);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#5F173B").s().p("EggDAE0IDEpnMA9DAAAIjBJng");
	this.shape_11.setTransform(5.905,13.2234,0.7251,0.7251);
...
p.nominalBounds = new cjs.Rectangle(-142.9,-9.1,470.4,44.7);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(208.7627,20.5596,0.5566,0.5566);
	...
	this.shape_1.setTransform(180.3404,20.5318,0.5566,0.5566);
	...
	this.shape_2.setTransform(150.5684,20.6153,0.5566,0.5566);
	...
	this.shape_3.setTransform(120.6989,20.8379,0.5566,0.5566);
	...
	this.shape_4.setTransform(78.4375,20.1978,0.5566,0.5566);
	...
	this.shape_5.setTransform(48.4428,21.1023,0.5566,0.5566);
	...
	this.shape_6.setTransform(20.2014,20.6431,0.5566,0.5566);
	...
	this.shape_7.setTransform(-8.3322,20.5457,0.5566,0.5566);
	...
	this.shape_8.setTransform(100.95,19.925);
...
p.nominalBounds = new cjs.Rectangle(-36,3.8,274,32.300000000000004);
...
p.nominalBounds = new cjs.Rectangle(-0.5,-2.6,507.2,46.9);
...
p.nominalBounds = new cjs.Rectangle(-77.1,-17.9,954.7,198.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(400.6,103.35,0.9241,0.9241,0,0,0,115.7,26.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(89));

	// an_sc4_2888
	this.instance_1 = new lib.an_sc42888("synched",0,false);
	this.instance_1.setTransform(438.15,118.75,1.0729,1.0729,0,0,0,299.9,25.9);
...
p.nominalBounds = new cjs.Rectangle(29.6,64.2,701.1,148.89999999999998);
