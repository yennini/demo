...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#138BA4","rgba(230,167,228,0)"],[0,1],-429.3,0,429.3,0).s().p("EhDEAxcMAAAhi3MCGJAAAMAAABi3g");
	this.shape.setTransform(942.8179,-78.5337,0.5097,2.5377,0,-90,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#06212E","rgba(6,33,46,0)"],[0,1],-429.3,0,429.3,0).s().p("EhDEAxcMAAAhi3MCGJAAAMAAABi3g");
	this.shape_1.setTransform(942.8179,996.9193,0.8167,2.5377,-90);

	this.instance = new lib.BG1();
	this.instance.setTransform(37,-404,1.7519,3.469);
...
p.nominalBounds = new cjs.Rectangle(37,-404,1708.7,1790);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#138BA4","rgba(230,167,228,0)"],[0,1],-429.3,0,429.3,0).s().p("EhDEAxcMAAAhi3MCGJAAAMAAABi3g");
	this.shape.setTransform(697.4191,-123.9378,0.5393,2.5118,0,-90,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#06212E","rgba(6,33,46,0)"],[0,1],-429.3,0,429.3,0).s().p("EhDEAxcMAAAhi3MCGJAAAMAAABi3g");
	this.shape_1.setTransform(697.4191,1013.9925,0.8642,2.5118,-90);

	this.instance = new lib.bg_blur();
	this.instance.setTransform(37,-405,1.7523,3.469);
...
p.nominalBounds = new cjs.Rectangle(-97.2,-405,1589.3,1790);
...
p.nominalBounds = new cjs.Rectangle(34.7,-44.5,964.8,553.8);
...
p.nominalBounds = new cjs.Rectangle(99.9,51.4,596.7,153);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(563.8,-82.75,1,1,0,0,0,357.9,69);
	...
	this.instance_1.setTransform(68.6,252.5);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(299.25,550.1);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(-43.55,159.45,1.6358,1.6358,0,0,0,354.9,74.7);
	...
	this.instance_4.setTransform(-39.15,252.85,1,1,0,0,0,491.8,62.1);
	this.instance_4._off = true;
	...
	this.instance_5.setTransform(548.5,424.2,0.8876,0.8876,0,0,0,568.5,81);
	...
	this.instance_6.setTransform(565.75,541,1,1,0,0,0,582.6,69);
...
p.nominalBounds = new cjs.Rectangle(-624,-151.7,1772.5,761.9000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(384,-72,0.5,0.5);
	...
	this.instance_3.setTransform(505.95,139.2,0.6559,0.6559,0,0,0,269,86.5);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).to({_off:true},76).wait(202).to({_off:false,regX:269.1,scaleX:0.6507,scaleY:0.6507,x:507.55,y:118.1},0).wait(89));

	// an_car1
	this.instance_4 = new lib.an_car1("synched",0,false);
	this.instance_4.setTransform(553.35,308.45,0.3856,0.3856,0,0,0,748.6,265.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:49},77).to({alpha:0.4492},8).to({_off:true},1).wait(105).to({_off:false,regX:748.5,scaleX:0.4601,scaleY:0.4601,x:523.05,y:311.35,alpha:0,startPosition:0},0).to({alpha:1,startPosition:6},6).to({startPosition:49},79).to({scaleX:0.3499,scaleY:0.3499,x:536.5,y:291.15},8).to({startPosition:49},89).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({startPosition:0},77).to({alpha:0.4492},8).to({_off:true},1).wait(190).to({_off:false,x:462.75,alpha:0},0).to({alpha:1},9).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(77).to({_off:false},0).to({startPosition:0},111).to({regX:697.1,regY:490,scaleX:0.3977,scaleY:0.3977,x:531.55,y:221.3},13).to({startPosition:0},75).to({regX:696.8,regY:489.8,scaleX:0.3732,scaleY:0.3732,x:460.85,y:214.9},9).to({alpha:0},9).wait(80));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(34.1,-134.5,942.3,711.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(106.2,299.75,1.0032,1.0032,0,0,0,492.2,226);
...
p.nominalBounds = new cjs.Rectangle(-203.2,238,795,414);
// library properties:
lib.properties = {
