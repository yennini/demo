...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(381.3,306.8,1,1,0,0,0,299.9,25.9);
...
p.nominalBounds = new cjs.Rectangle(2.1,0.9,780.5,358.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).to({_off:true},76).wait(242).to({_off:false},0).wait(89));

	// an_car1
	this.instance_4 = new lib.an_car1("synched",0,false);
	this.instance_4.setTransform(553.3,296,0.3856,0.3856,0,0,0,748.5,265.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:49},77).to({alpha:0.4492},8).to({_off:true},1).wait(145).to({_off:false,scaleX:0.4601,scaleY:0.4601,x:523.05,y:286.45,alpha:0,startPosition:0},0).to({alpha:1,startPosition:6},6).to({startPosition:49},79).to({scaleX:0.3499,scaleY:0.3499,x:536.5,y:291.15},8).to({startPosition:49},1).to({startPosition:49},88).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(77).to({_off:false},0).to({startPosition:0},151).to({regX:697.1,regY:490,scaleX:0.3977,scaleY:0.3977,x:531.55,y:221.3},13).to({startPosition:0},75).to({regX:696.8,regY:489.8,scaleX:0.3732,scaleY:0.3732,x:460.85,y:214.9},9).to({x:460.8,alpha:0},9).wait(80));
