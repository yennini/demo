...
p.nominalBounds = new cjs.Rectangle(0,0,260,776);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(234.6946,19.0424,1.6396,1.6396);
	...
	this.shape_1.setTransform(192.4326,19.0424,1.6396,1.6396);
	...
	this.shape_2.setTransform(148.1621,18.9604,1.6396,1.6396);
	...
	this.shape_3.setTransform(106.5971,19.0014,1.6396,1.6396);
	...
	this.shape_4.setTransform(63.5973,18.8785,1.6396,1.6396);
	...
	this.shape_5.setTransform(21.0074,19.5343,1.6396,1.6396);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(260.4406,65.5988,0.8964,0.8964);
	...
	this.shape_7.setTransform(234.4043,65.7589,1.0009,1.0009);
	...
	this.shape_8.setTransform(208.5819,65.6338,1.0009,1.0009);
	...
	this.shape_9.setTransform(181.9838,65.5087,1.0009,1.0009);
...
p.nominalBounds = new cjs.Rectangle(3.2,2.4,267.90000000000003,73.19999999999999);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(268.3413,25.3482,1.7215,1.7215);
...
p.nominalBounds = new cjs.Rectangle(-31.8,-3.1,600.4,56.9);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(126.1,47.35);
	...
	this.shape_1.setTransform(99.125,48.425);
	...
	this.shape_2.setTransform(73.775,47.9);
	...
	this.shape_3.setTransform(48.2,47.775);
...
}).prototype = getMCSymbolPrototype(lib.mo_sc42888, new cjs.Rectangle(-32.4,-2.5,212.70000000000002,62), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(104.0987,35.564,1.9154,1.9154);
	...
	this.shape_1.setTransform(77.6665,34.6063,1.9154,1.9154);
	...
	this.shape_2.setTransform(51.2822,35.133,1.9154,1.9154);
	...
	this.shape_3.setTransform(26.9569,34.6063,1.9154,1.9154);
	...
	this.shape_4.setTransform(-0.5287,34.7021,1.9154,1.9154);
	...
	this.shape_5.setTransform(-29.7381,34.2232,1.9154,1.9154);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#06212E","rgba(0,0,0,0)"],[0,1],-429.3,0,429.3,0).s().p("EhDEAxcMAAAhi3MCGJAAAMAAABi3g");
	this.shape.setTransform(942.7821,-1044.5816,1.0911,2.5377,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#06212E","rgba(6,33,46,0)"],[0,1],-429.3,0,429.3,0).s().p("EhDEAxcMAAAhi3MCGJAAAMAAABi3g");
	this.shape_1.setTransform(942.8179,2136.0316,1.0911,2.5377,-90);

	this.instance = new lib.BG1();
	this.instance.setTransform(330,-1525,3.1923,5.3215);
...
p.nominalBounds = new cjs.Rectangle(140,-1525,1605.7,4129.5);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(697.4191,2734.1622,1.4615,2.5118,-90);

	this.instance = new lib.bg_blur();
	this.instance.setTransform(139,-1488,3.2692,7.9337);
...
p.nominalBounds = new cjs.Rectangle(-97.2,-1488,1589.3,6156.6);
...
p.nominalBounds = new cjs.Rectangle(-4.4,-0.7,293,18);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(126.9,1.6,1.1493,1.1493,0,0,0,139.1,18.2);
...
p.nominalBounds = new cjs.Rectangle(-77.2,-29.1,266,93);
...
p.nominalBounds = new cjs.Rectangle(-77.1,-29.1,574.8,93.1);
...
p.nominalBounds = new cjs.Rectangle(-77.1,-20.2,1193.1,240.6);
...
p.nominalBounds = new cjs.Rectangle(35.1,-399.9,1103.6000000000001,1368.1);
...
p.nominalBounds = new cjs.Rectangle(-195.3,843.7,913,360.20000000000005);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(588.8,-354.8,1.6127,1.6127,0,0,0,357.9,69);
	...
	this.instance_1.setTransform(59.2,199.25,2.5551,2.5551);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(65.3,631.3,2.5551,2.5551);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(-43.55,26.25,1.6358,1.6358,0,0,0,354.9,74.7);
	...
	this.instance_4.setTransform(-39.15,119.65,1,1,0,0,0,491.8,62.1);
	this.instance_4._off = true;
	...
	this.instance_5.setTransform(570.25,425,0.8876,0.8876,0,0,0,568.5,81);
	...
	this.instance_6.setTransform(582.6,541.8,1,1,0,0,0,582.6,69);
...
p.nominalBounds = new cjs.Rectangle(-624,-466,1789.9,1147.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(427,-462,0.9023,0.9023);
	...
	this.instance_3.setTransform(497.75,-90.2,0.7609,0.7609,0,0,0,269.2,86.3);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).to({_off:true},76).wait(202).to({_off:false,regY:86.7,scaleX:0.7456,scaleY:0.7456,x:501.15,y:-125.55},0).wait(89));

	// an_car1
	this.instance_4 = new lib.an_car1("synched",0,false);
	this.instance_4.setTransform(509.45,396.3,0.5924,0.5924,0,0,0,748.7,265.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:49},77).to({alpha:0},8).to({_off:true},1).wait(105).to({_off:false,regX:748.5,scaleX:0.6067,scaleY:0.6067,x:504.15,y:351.55,startPosition:0},0).to({alpha:1,startPosition:6},6).to({startPosition:49},79).to({regX:748.7,regY:266,scaleX:0.4243,scaleY:0.4243,x:554.7,y:333.5},8).to({startPosition:49},89).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(77).to({_off:false},0).to({startPosition:0},111).to({regY:489.4,scaleX:0.3977,scaleY:0.4121,x:587.1,y:-206.6},13).to({startPosition:0},75).to({regY:488.5,scaleY:0.3213,y:35.95},9).to({regY:489.5,scaleY:0.4375,y:-206.6,alpha:0},9).wait(80));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-140.5,-1071.7,1282.5,3500.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(42.5,299.9,0.4012,0.4012,0,0,0,492.1,226.1);
...
p.nominalBounds = new cjs.Rectangle(-151.3,79.2,454.6,1104.5);
// library properties:
lib.properties = {
