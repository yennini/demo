...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(202.9024,22.8394,0.493,0.493);
	...
	this.shape_1.setTransform(177.751,22.8148,0.493,0.493);
	...
	this.shape_2.setTransform(151.3541,22.8887,0.493,0.493);
	...
	this.shape_3.setTransform(124.9208,23.0859,0.493,0.493);
	...
	this.shape_4.setTransform(87.4854,22.5189,0.493,0.493);
	...
	this.shape_5.setTransform(60.8913,23.3201,0.493,0.493);
	...
	this.shape_6.setTransform(35.9001,22.9134,0.493,0.493);
	...
	this.shape_7.setTransform(10.6002,22.8271,0.493,0.493);
	...
	this.shape_8.setTransform(107.3688,22.3249,0.8858,0.8858);
...
p.nominalBounds = new cjs.Rectangle(-14,8.1,242.7,28.5);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(158.312,32.7831,0.3536,0.3536);
	...
	this.shape_1.setTransform(130.6104,32.8914,0.3536,0.3536);
	...
	this.shape_2.setTransform(102.9178,33.3576,0.3536,0.3536);
	...
	this.shape_3.setTransform(75.2376,32.9051,0.7162,0.7162);
	...
	this.shape_4.setTransform(40.9498,26.1368,0.7162,0.7162);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#F3E727").s().p("AjRDpQBEhvBch6QBNhnAkgjIjvAAIARheIFwAAIgNBKQhTBfhTBxQhPBvgpBIg");
	this.shape_5.setTransform(7.2328,26.1189,0.7162,0.7162);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mo_sc42888, new cjs.Rectangle(-7.8,8.8,178,35.2), null);
...
p.nominalBounds = new cjs.Rectangle(-48.9,-16.2,225,62);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_20 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(20).to({graphics:mask_graphics_20,x:60.3567,y:11.8984}).wait(27));
...
p.nominalBounds = new cjs.Rectangle(-48.8,-16.1,534.8,62.800000000000004);
...
p.nominalBounds = new cjs.Rectangle(-77.1,-20.2,951.8000000000001,255.39999999999998);
...
p.nominalBounds = new cjs.Rectangle(27.9,561,1183.3999999999999,510.20000000000005);
...
p.nominalBounds = new cjs.Rectangle(-140.5,-1071.7,1147.5,3500.5);
...
p.nominalBounds = new cjs.Rectangle(-151.3,79.2,408.7,1104.5);
// library properties:
lib.properties = {
