...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(51,13,28,0)","#330D1C"],[0,1],-672.9,0,672.9,0).s().p("EhpIB3qMAAAjvTMDSRAAAMAAADvTg");
	this.shape.setTransform(1230.2203,694.0957,0.4515,0.9585,29.9983);
...
p.nominalBounds = new cjs.Rectangle(37,-93.4,1823.3,1575.1000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.shadow = new cjs.Shadow("rgba(33,24,22,0.8)",1,1,6);
...
p.nominalBounds = new cjs.Rectangle(1.3,-23.8,196,52);
...
p.nominalBounds = new cjs.Rectangle(0,-23.8,505.1,53.8);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:278.5,y:108.05,alpha:1},23,cjs.Ease.backOut).wait(67));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:1},31).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(8).to({_off:false},0).to({y:39.65,alpha:1},23,cjs.Ease.cubicOut).wait(59));

	// sb_bg_sentra
	this.instance_4 = new lib.sb_bgsentra("synched",0);
	this.instance_4.setTransform(561.35,39.1,0.0836,1,0,0,0,223.6,23.4);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:223.8,scaleX:1,x:313.65,y:39.15},31,cjs.Ease.cubicOut).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:-3.1,alpha:1},31,cjs.Ease.cubicOut).wait(59));
...
p.nominalBounds = new cjs.Rectangle(312.7,-6.9,588,316.09999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:49},77).to({alpha:0},8).to({_off:true},1).wait(145).to({_off:false,regX:581.8,regY:265.5,scaleX:0.4601,scaleY:0.4601,x:446.35,y:286.4,startPosition:0},0).to({alpha:1,startPosition:6},6).to({startPosition:49},79).to({regX:581.9,regY:265.8,scaleX:0.3215,scaleY:0.3215,x:458.35,y:295.8},8).to({startPosition:49},89).wait(1));
...
p.nominalBounds = new cjs.Rectangle(34.1,27.2,942.3,484.7);
...
p.nominalBounds = new cjs.Rectangle(-202.2,51,792.0999999999999,359.6);
// library properties:
lib.properties = {
