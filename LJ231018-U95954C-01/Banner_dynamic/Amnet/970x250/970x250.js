...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(208.7627,20.4596,0.5566,0.5566);
	...
	this.shape_1.setTransform(180.3404,20.4318,0.5566,0.5566);
	...
	this.shape_2.setTransform(150.5684,20.5153,0.5566,0.5566);
	...
	this.shape_3.setTransform(120.6989,20.7379,0.5566,0.5566);
	...
	this.shape_4.setTransform(78.4375,20.0978,0.5566,0.5566);
	...
	this.shape_5.setTransform(48.4428,21.0023,0.5566,0.5566);
	...
	this.shape_6.setTransform(20.2014,20.5431,0.5566,0.5566);
	...
	this.shape_7.setTransform(-8.3322,20.4457,0.5566,0.5566);
	...
	this.shape_8.setTransform(100.95,19.825);
...
p.nominalBounds = new cjs.Rectangle(-36,3.7,274,32.3);
...
p.nominalBounds = new cjs.Rectangle(-81.3,-25.4,201,57);
...
p.nominalBounds = new cjs.Rectangle(-81.3,-25.4,509.90000000000003,57.9);
...
p.nominalBounds = new cjs.Rectangle(-77.1,-17.5,946.1,186.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1025.1,177.55,1.5482,1.5482,0,0,0,115.5,26);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(89));

	// an_sc4_2888
	this.instance_1 = new lib.an_sc42888("synched",0,false);
	this.instance_1.setTransform(748.4,165.35,1.4755,1.4755,0,0,0,92.8,3.1);
...
p.nominalBounds = new cjs.Rectangle(494.8,126.6,1179.1000000000001,232.20000000000002);
...
p.nominalBounds = new cjs.Rectangle(-941.1,20.8,3571.1,452.09999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).to({_off:true},76).wait(242).to({_off:false,regX:269,scaleX:0.7567,scaleY:0.7567,x:767.05,y:196.8},0).wait(89));
