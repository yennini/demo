...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-902,54,3.6158,3.6161);
...
p.nominalBounds = new cjs.Rectangle(-902,54,3507.4,904);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1087,38,3.6159,3.6161);
...
p.nominalBounds = new cjs.Rectangle(-1087,38,3507.5,904);
...
p.nominalBounds = new cjs.Rectangle(-77.1,-17.5,1001.1,186.6);
...
p.nominalBounds = new cjs.Rectangle(520.7,90.9,1153.2,267.9);
...
p.nominalBounds = new cjs.Rectangle(-587.3,164.7,1141.6999999999998,233.10000000000002);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-243.2,237.45,1.9803,1.9803,0,0,0,162.9,68.3);
	...
	this.instance_1.setTransform(1081.15,382.85,1.5772,1.5772,0,0,0,81.9,9.8);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(561.5,220.9,1.5564,1.5564,0,0,0,258.4,128.6);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(811.1,345.6,1.8503,1.8503,0,0,0,278.9,69.4);
	...
	this.instance_4.setTransform(836,362.05,1.5569,1.5569);
	this.instance_4._off = true;
	...
	this.instance_5.setTransform(-37.3,230.9,2.5467,2.5467,0,0,0,354.9,74.7);
	...
	this.instance_6.setTransform(136.65,334.1,2.2378,2.2378,0,0,0,491.7,62.1);
...
p.nominalBounds = new cjs.Rectangle(-941.1,20.8,3571.2,452.09999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(724.9,230.2,0.9593,0.9593,0,0,0,269.1,86.5);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(7).to({_off:false},0).to({_off:true},76).wait(242).to({_off:false,regX:269,scaleX:0.7567,scaleY:0.7567,x:776.25,y:187.55},0).wait(89));

	// an_car1
	this.instance_4 = new lib.an_car1("synched",0,false);
	this.instance_4.setTransform(403.8,279.3,0.5973,0.5973,0,0,0,748.8,265.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({startPosition:49},77).to({startPosition:49},8).to({_off:true},1).wait(145).to({_off:false,regX:748.6,regY:265.6,scaleX:0.6763,scaleY:0.6763,x:746.8,y:270.3,alpha:0},0).to({alpha:1},6).to({startPosition:49},79).to({regX:748.8,regY:265.7,scaleX:0.5973,scaleY:0.5973,x:403.8,y:279.3},8).to({startPosition:49},89).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-204.9,41.6,1922.1000000000001,408.29999999999995);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(448.55,124.8,0.836,0.836,0,0,0,492.3,226);
...
p.nominalBounds = new cjs.Rectangle(350.7,95.7,1121.8,216.3);
// library properties:
lib.properties = {
