...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(308.1,79.15,0.357,0.357,0,0,0,323.1,78.2);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:323.2,scaleX:1,scaleY:1,x:308.15,y:79.2,alpha:1},11,cjs.Ease.cubicOut).wait(29));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:144.7,regY:68,scaleX:1.0001,scaleY:1.0001,x:144.7,y:68,alpha:1,startPosition:28},15,cjs.Ease.cubicOut).to({startPosition:92},64).to({_off:true},1).wait(41));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:59,scaleX:1,scaleY:1,x:56,y:183,alpha:1,startPosition:19},19,cjs.Ease.cubicOut).to({startPosition:37},60).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(8).to({_off:false},0).to({regX:44.5,regY:42.5,scaleX:1,scaleY:1,x:165.5,y:253.45,alpha:1,startPosition:19},19,cjs.Ease.cubicOut).to({startPosition:29},52).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:1,scaleY:1,x:360.5,y:73.5,alpha:1,startPosition:19},19,cjs.Ease.cubicOut).to({startPosition:37},60).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(4).to({_off:false},0).to({regX:17.5,scaleX:1,scaleY:1,x:444.5,y:108.5,alpha:1,startPosition:19},19,cjs.Ease.cubicOut).to({startPosition:33},56).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:1,scaleY:1,x:622.5,y:94,alpha:1,startPosition:19},19,cjs.Ease.cubicOut).to({startPosition:37},60).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(6).to({_off:false},0).to({scaleX:1,scaleY:1,x:557.5,y:247.5,alpha:1,startPosition:19},19,cjs.Ease.cubicOut).to({startPosition:31},54).to({_off:true},1).wait(50));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:37,scaleX:1,scaleY:1,x:494,y:21.95,alpha:1,startPosition:19},19,cjs.Ease.cubicOut).to({startPosition:37},60).to({_off:true},1).wait(50));
...
if (reversed == null) { reversed = false; }
	...
	// sb_sc2_tt
	this.instance = new lib.sb_sc2tt();
	this.instance.setTransform(307.45,78.55,0.3573,0.3573,0,0,0,322.4,77.5);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1,scaleY:1,x:307.4,y:78.5,alpha:1},11,cjs.Ease.cubicOut).wait(29));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},15,cjs.Ease.cubicOut).to({startPosition:0},84).to({_off:true},1).wait(50));
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(117.3608,61.1058);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:224.1,regY:145.2,scaleX:0.4248,scaleY:0.4248,x:197.55,y:157.9,alpha:0.2077},0).wait(1).to({scaleX:0.5617,scaleY:0.5617,x:197.1,y:148.05,alpha:0.3963},0).wait(1).to({scaleX:0.6752,scaleY:0.6752,x:196.65,y:139.95,alpha:0.5526},0).wait(1).to({scaleX:0.7637,scaleY:0.7637,x:196.35,y:133.6,alpha:0.6745},0).wait(1).to({scaleX:0.8308,scaleY:0.8308,x:196.1,y:128.75,alpha:0.7669},0).wait(1).to({scaleX:0.8812,scaleY:0.8812,x:196,y:125.25,alpha:0.8363},0).wait(1).to({scaleX:0.9189,scaleY:0.9189,x:195.85,y:122.5,alpha:0.8882},0).wait(1).to({scaleX:0.9469,scaleY:0.9469,x:195.75,y:120.55,alpha:0.9268},0).wait(1).to({scaleX:0.9673,scaleY:0.9673,x:195.7,y:119.05,alpha:0.955},0).wait(1).to({scaleX:0.9818,scaleY:0.9818,x:195.65,y:118,alpha:0.975},0).wait(1).to({scaleX:0.9916,scaleY:0.9916,x:195.6,y:117.3,alpha:0.9884},0).wait(1).to({scaleX:0.9974,scaleY:0.9974,x:195.55,y:116.9,alpha:0.9964},0).wait(1).to({regX:227.5,regY:148.5,scaleX:1,scaleY:1,x:199,y:120,alpha:1},0).wait(1).to({regX:224.1,regY:145.2,x:195.6,y:116.7},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:227.5,regY:148.5,x:199,y:120},0).to({scaleX:0.3146,scaleY:0.3146,x:198.8,y:119.65,alpha:0},8,cjs.Ease.cubicOut).wait(1).to({regX:224.1,regY:145.2,x:197.75,y:118.6},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({regX:227.5,regY:148.5,x:198.8,y:119.65},0).to({_off:true},1).wait(74));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(4).to({_off:false},0).wait(43).to({mode:"single",startPosition:43},0).wait(92).to({startPosition:43},0).to({_off:true},1).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(7).to({_off:false},0).wait(132).to({startPosition:13},0).to({_off:true},1).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:1,scaleY:1,x:322.5,alpha:1},18,cjs.Ease.cubicOut).to({mode:"synched",loop:false},12).to({startPosition:109},109).to({_off:true},1).wait(15));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(162).to({_off:false},0).to({_off:true},80).wait(207));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(162).to({_off:false},0).to({_off:true},80).wait(207));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(242).to({_off:false},0).to({_off:true},67).wait(140));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(242).to({_off:false},0).to({_off:true},67).wait(140));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(309).to({_off:false},0).wait(140));

	// an_title
	this.instance_5 = new lib.an_title("synched",0,false);
	this.instance_5.setTransform(361.95,156.75,1,1,0,0,0,196,117.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},90).wait(359));

	// an_subtitle
	this.instance_6 = new lib.an_subtitle("synched",0,false);
	this.instance_6.setTransform(626.7,303.3,1,1,0,0,0,525.8,30);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},68).wait(381));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(68).to({_off:false},0).to({_off:true},94).wait(287));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(62).to({_off:false},0).to({_off:true},100).wait(287));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({scaleX:1,scaleY:1,x:305.5,y:407.25,alpha:1},13,cjs.Ease.cubicOut).to({mode:"synched",loop:false},17).to({startPosition:0},58).to({startPosition:0},100).to({startPosition:0},77).to({mode:"single",startPosition:15},43).to({alpha:0,mode:"synched",startPosition:11,loop:false},11).to({_off:true},1).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(3).to({_off:false},0).to({scaleX:1,scaleY:1,x:165,y:402.95,alpha:1},11,cjs.Ease.cubicOut).to({mode:"synched",loop:false},16).to({startPosition:0},58).to({startPosition:0},100).to({startPosition:0},77).to({mode:"single",startPosition:15},43).to({alpha:0,mode:"synched",startPosition:11,loop:false},11).to({_off:true},1).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(68).to({_off:false},0).to({_off:true},241).wait(140));

	// bg
	this.instance_13 = new lib.sb_bg();
	this.instance_13.setTransform(351,250.05,1,1,0,0,0,561,467);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(449));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(897).to({mode:"single",startPosition:448},0).wait(1));
