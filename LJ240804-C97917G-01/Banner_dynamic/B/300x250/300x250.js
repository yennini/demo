...
p.nominalBounds = new cjs.Rectangle(0,0,1000,1076);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#3D3F66","rgba(61,63,102,0)"],[0,1],0,-63.3,0,63.4).s().p("A4jJ6IAAzzMAxHAAAIAATzg");
	this.shape.setTransform(256.1512,114.75,1.0859,1);
...
p.nominalBounds = new cjs.Rectangle(66,51.4,406.3,315);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#2A294B","rgba(45,44,79,0.906)","rgba(54,52,92,0.639)","rgba(69,66,113,0.196)","rgba(75,72,122,0)"],[0,0.275,0.576,0.886,1],0,-63.3,0,63.4).s().p("A4jJ6IAAzzMAxHAAAIAATzg");
	this.shape.setTransform(297.4218,89.15,1.0757,1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(90));

	// Layer_3
	this.instance = new lib.sc3bg();
	this.instance.setTransform(127,-3,0.4759,0.4758);
...
p.nominalBounds = new cjs.Rectangle(127,-3,475.9,317.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-20,-50,0.3549,0.355);
...
p.nominalBounds = new cjs.Rectangle(-20,-50,355,382);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(80.4,215.65,1,1,0,0,0,56.1,11.5);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:1,startPosition:7},4).to({x:154.5,startPosition:58},51).to({startPosition:83},25).to({_off:true},1).wait(9));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-42.4,-33.1,416.29999999999995,315);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(153,215.9,1,1,0,0,0,109,12.5);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({alpha:1,startPosition:4},4).to({x:128.9,startPosition:53},49).to({startPosition:15},52).to({_off:true},1).wait(26));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-21.9,-43.3,485.9,317.40000000000003);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(80.4,215.6,1,1,0,0,0,56.1,11.5);
	this.instance._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:1,startPosition:4},4).to({x:180.95,startPosition:48},44).to({startPosition:80},32).to({_off:true},1).wait(9));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-39.2,-58.1,364.9,381.90000000000003);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_7
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#624B60","rgba(93,72,91,0.655)","rgba(85,65,83,0)"],[0,0.561,1],0,-55.6,0,55.7).s().p("A5GItIAAxZMAyNAAAIAARZg");
	this.shape.setTransform(147.6,36.35);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(115).to({_off:true},1).wait(34));

	// Layer_3
	this.instance_4 = new lib.sc5bg();
	this.instance_4.setTransform(-19,-12,0.4002,0.4002);
...
p.nominalBounds = new cjs.Rectangle(-19,-19.3,400.2,288.6);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_5
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#A79190","rgba(162,141,140,0.443)","rgba(159,138,137,0)"],[0,0.729,1],-60.6,0,60.7,0).s().p("ApdUTMAAAgolIS7AAMAAAAolg");
	this.shape.setTransform(54.425,126.4);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(84).to({_off:true},1).wait(5));

	// sc1bg
	this.instance_3 = new lib.sc1bg();
	this.instance_3.setTransform(-88,-12,0.402,0.402);
...
p.nominalBounds = new cjs.Rectangle(-88,-19.3,406.9,288.6);
...
p.nominalBounds = new cjs.Rectangle(66.4,26.3,552,382);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(899).to({mode:"single"},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(62,66.9,402,256.9);
// library properties:
lib.properties = {
