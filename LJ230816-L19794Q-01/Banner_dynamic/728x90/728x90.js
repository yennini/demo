...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(310.7969,29.059,1.1685,1.1685);
	...
	this.shape_1.setTransform(254.8848,28.8837,1.1685,1.1685);
	...
	this.shape_2.setTransform(198.5345,28.1826,1.1685,1.1685);
	...
	this.shape_3.setTransform(143.7909,27.4815,1.1685,1.1685);
	...
	this.shape_4.setTransform(87.4405,27.131,1.1685,1.1685);
	...
	this.shape_5.setTransform(31.1486,27.5691,1.1685,1.1685);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.setTransform(272.2418,-81.5598,0.8923,0.8923);
...
p.nominalBounds = new cjs.Rectangle(184.9,-106.7,115.1,50.300000000000004);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(110.0746,-65.8634,0.9548,0.9548);
	...
	this.shape_1.setTransform(85.7021,-65.8873,0.9548,0.9548);
	...
	this.shape_2.setTransform(59.9928,-65.3383,0.9548,0.9548);
	...
	this.shape_3.setTransform(34.4506,-66.2931,0.9548,0.9548);
	...
	this.shape_4.setTransform(11.9161,-66.1021,0.9548,0.9548);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ah1AMIAGgYIDlAAIgHAZg");
	this.shape_5.setTransform(-13.7455,-66.2215,0.9548,0.9548);
	...
	this.shape_6.setTransform(-39.0967,-65.9589,0.9548,0.9548);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ah1ANIAHgZIDkAAIgHAZg");
	this.shape_7.setTransform(-63.1589,-66.317,0.9548,0.9548);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(43.0203,-11.3253,2.3425,2.3425);
	...
	this.shape_1.setTransform(-17.9424,-10.2127,2.3425,2.3425);
...
p.nominalBounds = new cjs.Rectangle(-32.7,-26.2,90,29.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-507,-106);
...
p.nominalBounds = new cjs.Rectangle(-507,-106,1458,180);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(-683,-92,1.014,1.014);
...
p.nominalBounds = new cjs.Rectangle(-1619.9,-1138.3,2904.2,1946.9);
...
p.nominalBounds = new cjs.Rectangle(-146.3,-91.4,338.1,167);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-11.6691,21.6444,1.2305,1.2305);
	...
	this.shape_1.setTransform(-26.3126,17.5836,1.2305,1.2305);
	...
	this.shape_2.setTransform(-6.1316,-2.2897,1.2305,1.2305);
	...
	this.shape_3.setTransform(-24.8667,-1.9267,1.2305,1.2305);
	...
	this.shape_4.setTransform(234.2213,19.4954,1.2181,1.2181);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgdAIIAAgPIA7AAIAAAPg");
	this.shape_5.setTransform(218.934,18.5818,1.2181,1.2181);
	...
	this.shape_8.setTransform(215.2538,-4.0847,1.2181,1.2181);
	...
	this.shape_9.setTransform(196.9212,-4.1151,1.2181,1.2181);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_20 = new cjs.Graphics().p("");
	var mask_graphics_22 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:181.9451,y:-84.7639}).wait(20).to({graphics:mask_graphics_20,x:181.9451,y:-84.7639}).wait(1).to({graphics:null,x:0,y:0}).wait(1).to({graphics:mask_graphics_22,x:181.9451,y:-84.7639}).wait(29));
...
p.nominalBounds = new cjs.Rectangle(-440.1,-243,1403.8000000000002,163.8);
...
p.nominalBounds = new cjs.Rectangle(-14.2,0,238.29999999999998,172.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(-112.8,-0.1,0.7688,0.7688,0,0,0,-0.1,0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(504.7716,-57.3159,0.8201,0.8201);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhnBiIAAgPIBYAAIAAi0IAPAAIAABHIBXAAIAAAQIhXAAIAABdIBnAAIAAAPg");
	this.shape_1.setTransform(465.7759,-57.5415,0.8201,0.8201);
	...
	this.shape_2.setTransform(426.8212,-57.2134,0.8201,0.8201);
	...
	this.shape_3.setTransform(388.0305,-57.1929,0.8201,0.8201);
	...
	this.shape_4.setTransform(348.8093,-57.3364,0.8201,0.8201);
	...
	this.shape_5.setTransform(309.8341,-57.2544,0.8201,0.8201);
	...
	this.shape_6.setTransform(557.4429,-11.249,0.8201,0.8201);
	...
	this.shape_7.setTransform(484.085,-11.249,0.8201,0.8201);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgXD+IAAn7IAvAAIAAH7g");
	this.shape_8.setTransform(423.9103,-11.249,0.8201,0.8201);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgYD+IAAnOIjKAAIAAgtIHEAAIAAAtIjJAAIAAHOg");
	this.shape_9.setTransform(371.2599,-11.249,0.8201,0.8201);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AixD+IAAn7IAyAAIAAHOIExAAIAAAtg");
	this.shape_10.setTransform(317.8715,-11.249,0.8201,0.8201);
	...
	this.shape_11.setTransform(251.546,-11.249,0.8201,0.8201);
	...
	this.instance.setTransform(396.05,53.45,1.2316,1.2316,0,0,0,0.1,0.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-315.5,4.75,1.3422,1.3422,0,0,0,-0.3,0);
	this.instance._off = true;
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(183.3,2.7,0.8936,0.8936,0,0,0,0.1,0.1);
	this.instance._off = true;
	...
	this.instance_1.setTransform(-396.5,-6.1,1.1035,1.1035);
	this.instance_1._off = true;
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-426,-93,0.7241,0.7241);
...
p.nominalBounds = new cjs.Rectangle(-1552.5,-1138.8,2904.2,2092.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(209.3,45.25,0.5,0.5,0,0,0,0.1,0.1);
...
p.nominalBounds = new cjs.Rectangle(-203,-479.2,1088,1001);
// library properties:
lib.properties = {
