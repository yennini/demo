...
p.nominalBounds = new cjs.Rectangle(0,0,594,570);


(lib.sc2bg = function() {
	this.initialize(img.sc2bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,726,479);


(lib.sc3bg = function() {
	this.initialize(img.sc3bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,970,351);


(lib.sc4bg = function() {
	this.initialize(img.sc4bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,457,460);


(lib.sc5bg = function() {
	this.initialize(img.sc5bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1212,239);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.setTransform(270.6918,-79.5598,0.8923,0.8923);
...
p.nominalBounds = new cjs.Rectangle(183.4,-104.7,115.1,50.300000000000004);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(110.0658,-65.864,0.9548,0.9548);
	...
	this.shape_1.setTransform(85.6944,-65.8878,0.9548,0.9548);
	...
	this.shape_2.setTransform(59.9863,-65.3388,0.9548,0.9548);
	...
	this.shape_3.setTransform(34.4453,-66.2936,0.9548,0.9548);
	...
	this.shape_4.setTransform(11.912,-66.1027,0.9548,0.9548);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ah1AMIAGgYIDlAAIgHAZg");
	this.shape_5.setTransform(-13.7484,-66.222,0.9548,0.9548);
	...
	this.shape_6.setTransform(-39.0984,-65.9594,0.9548,0.9548);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ah1ANIAHgZIDkAAIgHAZg");
	this.shape_7.setTransform(-63.1594,-66.3175,0.9548,0.9548);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(46.8703,-14.7753,2.3425,2.3425);
	...
	this.shape_1.setTransform(-14.0924,-13.6627,2.3425,2.3425);
...
p.nominalBounds = new cjs.Rectangle(-28.8,-29.6,89.9,29.700000000000003);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(189,-349,1.5277,1.5277);
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("Eh9gBB/MAAAiD9MD7BAAAMAAACD9g");
	this.shape.setTransform(224.875,36.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-236.9,0,236.9,0).s().p("EglAA6vMAAAh1dMBKBAAAMAAAB1dg");
	this.shape_1.setTransform(-144.2589,12.05,1.3181,1,0,0,180);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1},{t:this.shape}]},42).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-578.4,-386.1,1606.6,844.5);
...
if (reversed == null) { reversed = false; }
	...
	// sc3_bg
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-133.9,0,133.9,0).s().p("EgU6AmoMAAAhNPMAp1AAAMAAABNPg");
	this.shape.setTransform(245.5454,-204.9,1,2.8237,-90);

	this.instance = new lib.sc3bg();
	this.instance.setTransform(-466,-71,1.4532,1.4532);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.shape}]}).wait(84));

	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("EhvzA7jMAAAh3EMDfoAAAMAAAB3Eg");
	this.shape_1.setTransform(232.05,40.2);
...
p.nominalBounds = new cjs.Rectangle(-483.6,-340.8,1431.3000000000002,779.9000000000001);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-100.5,0,100.6,0).s().p("EgPsA/dMAAAh+5IfZAAMAAAB+5g");
	this.shape.setTransform(335.6983,399.233,0.9568,0.2369);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-100.5,0,100.6,0).s().p("EgPsA/dMAAAh+5IfZAAMAAAB+5g");
	this.shape_1.setTransform(335.6983,-280.217,0.9568,0.2369);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-100.5,0,100.6,0).s().p("EgPsA/dMAAAh+5IfZAAMAAAB+5g");
	this.shape_2.setTransform(645.075,-280.1983,0.9568,1,-90);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-100.5,0,100.6,0).s().p("EgPsA/dMAAAh+5IfZAAMAAAB+5g");
	this.shape_3.setTransform(645.075,413.8805,1.1022,1,0,-90,90);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-100.5,0,100.6,0).s().p("EgPsA/dMAAAh+5IfZAAMAAAB+5g");
	this.shape_4.setTransform(-179.8381,15.125,4.1705,1,0,0,180);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(84));

	// sc2_bg
	this.instance = new lib.sc2bg();
	this.instance.setTransform(239,-184,1.0168,1.0168);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(84));

	// Layer_3
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("Eh1VA+lMAAAh9IMDqrAAAMAAAB9Ig");
	this.shape_5.setTransform(158.925,-5.55);
...
p.nominalBounds = new cjs.Rectangle(-599.2,-406,1650.4,930.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(416,-299,0.7849,0.7849);
...
p.nominalBounds = new cjs.Rectangle(416,-299,466.20000000000005,447.4);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_20 = new cjs.Graphics().p("");
	var mask_graphics_22 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:171.8536,y:69.9573}).wait(20).to({graphics:mask_graphics_20,x:171.8536,y:69.9573}).wait(1).to({graphics:null,x:0,y:0}).wait(1).to({graphics:mask_graphics_22,x:171.8536,y:69.9573}).wait(29));

	// Layer_2
	this.instance = new lib.sc5bg();
	this.instance.setTransform(-478,-195,1.5616,1.5616);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(20).to({_off:true},1).wait(1).to({_off:false},0).wait(29));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-478,-92.1,1548.1,270.29999999999995);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-211,-183,2.4786,1.6964);
...
p.nominalBounds = new cjs.Rectangle(-211,-183,1487.2,899.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(-1159,-26,1.8102,1.8102);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(88));

	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-224.3,0,224.3,0).s().p("EgjCAt5MAAAhbxMBGFAAAMAAABbxg");
	this.shape.setTransform(239.3028,-284.0558,1.1506,2.4761,-90);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(88));

	// Layer_3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("Eh0wA+2MAAAh9sMDphAAAMAAAB9sg");
	this.shape_1.setTransform(240.6,4.4);
...
p.nominalBounds = new cjs.Rectangle(-1619.9,-1138.3,2654.8,1630.1999999999998);
...
p.nominalBounds = new cjs.Rectangle(-146.3,-94.8,338.1,170.39999999999998);
...
p.nominalBounds = new cjs.Rectangle(-638,-520.3,1772.6,1028.1999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-11.7091,21.5821,1.2304,1.2304);
	...
	this.shape_1.setTransform(-26.3509,17.5217,1.2304,1.2304);
	...
	this.shape_2.setTransform(-6.1722,-2.3494,1.2304,1.2304);
	...
	this.shape_3.setTransform(-24.9052,-1.9864,1.2304,1.2304);
	...
	this.shape_4.setTransform(234.1807,19.4615,1.218,1.218);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgdAIIAAgPIA7AAIAAAPg");
	this.shape_5.setTransform(218.8944,18.5479,1.218,1.218);
	...
	this.shape_8.setTransform(215.2143,-4.1173,1.218,1.218);
	...
	this.shape_9.setTransform(196.8829,-4.1477,1.218,1.218);
...
p.nominalBounds = new cjs.Rectangle(-234.8,-46.1,478.1,92.30000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(681.5,102.95,0.92,0.92,0,0,0,274.9,69.2);
	...
	this.instance_4.setTransform(-495,-384,149.748,78.0623);
...
p.nominalBounds = new cjs.Rectangle(-1599.9,-384,2708.8,1175);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AqSUZQhxhxAAieQAAifBxhxQBwhwCfAAQCfAABwBwQBwBxAACfQAACehwBxQhwBwifAAQifAAhwhwg");
	var mask_graphics_51 = new cjs.Graphics().p("AqSUZQhxhxAAieQAAifBxhxQBwhwCfAAQCfAABwBwQBwBxAACfQAACehwBxQhwBwifAAQifAAhwhwg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-77.155,y:141.7096}).wait(51).to({graphics:mask_graphics_51,x:-77.155,y:141.7096}).wait(1).to({graphics:null,x:0,y:0}).wait(32));
...
p.nominalBounds = new cjs.Rectangle(-154.3,206.7,76.70000000000002,76.69999999999999);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("A4CUTQhthtAAiaQAAiaBthtQBthtCaAAQCaAABtBtQBsBtAACaQAACahsBtQhtBtiaAAQiaAAhthtg");
	var mask_graphics_51 = new cjs.Graphics().p("A4CUTQhthtAAiaQAAiaBthtQBthtCaAAQCaAABtBtQBsBtAACaQAACahsBtQhtBtiaAAQiaAAhthtg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-164.7793,y:140.7614}).wait(51).to({graphics:mask_graphics_51,x:-164.7793,y:140.7614}).wait(1).to({graphics:null,x:0,y:0}).wait(32));
...
p.nominalBounds = new cjs.Rectangle(-329.5,207.2,74.30000000000001,74.30000000000001);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-307.5,244.4,1,1,0,0,0,-292.4,244.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:90,x:-307.45,y:244.45},52,cjs.Ease.cubicOut).wait(32));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-344.8,207.1,74.60000000000002,74.70000000000002);
...
p.nominalBounds = new cjs.Rectangle(-17.4,0,238.20000000000002,174.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-115.85,245.2,1,1,0,0,0,-116,245.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:90,y:245.1},52,cjs.Ease.cubicOut).wait(32));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-154.4,206.6,77.10000000000001,77.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(497.65,138.8,1.949,1.949,0,0,0,0.2,34.8);
	this.instance._off = true;
	...
	this.instance_1.setTransform(470.85,-9.1,1.7907,1.7907,0,0,0,-128.1,8.4);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(48.05,-101.55,1.3625,1.3625,0,0,0,75.2,158.7);
	...
	this.instance_3.setTransform(228.35,-163,1.3862,1.3862,0,0,0,161.1,146.6);
	...
	this.instance_4.setTransform(182.1,-145.15,0.8197,1.3464,0,0,0,185.9,21.6);
...
p.nominalBounds = new cjs.Rectangle(-1638.3,-1139.8,2893.2,1630.1999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(795.3,346.85,1.1865,1.1865,0,0,0,-12,-1.1);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(27).to({_off:false},0).wait(70).to({startPosition:70},0).to({_off:true},1).wait(9));

	// an_sc4_plan
	this.instance_1 = new lib.an_sc4plan("synched",0,false);
	this.instance_1.setTransform(249.4,138.5,1.3984,1.3984,0,0,0,176.6,28.1);
	...
	this.instance_2.setTransform(223.65,-61.9,1.6077,1.6077,0,0,0,-0.1,-0.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(432.1,34.25);
	...
	this.instance_1.setTransform(538.9,279.95,1,1,0,0,0,-115.8,245.2);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_79 = new cjs.Graphics().p("");
	var mask_graphics_83 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:50.3714,y:259.1437}).wait(79).to({graphics:mask_graphics_79,x:50.3714,y:259.1437}).wait(1).to({graphics:null,x:0,y:0}).wait(3).to({graphics:mask_graphics_83,x:50.3714,y:259.1437}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-459.9,115.5,1121.6,287.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(-23.65,24.35);
...
if (reversed == null) { reversed = false; }
	...
	// sb_circle
	this.instance_1 = new lib.sb_circle();
	this.instance_1.setTransform(13.15,-506.85,1.0902,1.108,0,0,0,0.1,-0.2);
	this.instance_1.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0,regY:0,scaleX:1.3829,scaleY:1.3829,x:629.5,y:-534},83).wait(1));

	// sc2
	this.instance_2 = new lib.sc2power();
	this.instance_2.setTransform(635,235.2,1.2279,1.2279,0,0,0,223.7,58.5);
...
p.nominalBounds = new cjs.Rectangle(-1507,-989.9,2622.2,1943.6999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(237.893,-176.1192,1.3926,1.3926);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhnBiIAAgPIBYAAIAAi0IAPAAIAABHIBXAAIAAAQIhXAAIAABdIBnAAIAAAPg");
	this.shape_1.setTransform(171.6766,-176.5022,1.3926,1.3926);
	...
	this.shape_2.setTransform(105.5299,-175.9451,1.3926,1.3926);
	...
	this.shape_3.setTransform(39.6617,-175.9103,1.3926,1.3926);
	...
	this.shape_4.setTransform(-26.9377,-176.154,1.3926,1.3926);
	...
	this.shape_5.setTransform(-93.1192,-176.0148,1.3926,1.3926);
	...
	this.shape_6.setTransform(327.3837,-97.8941,1.3926,1.3926);
	...
	this.shape_7.setTransform(202.819,-97.8941,1.3926,1.3926);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgXD+IAAn7IAvAAIAAH7g");
	this.shape_8.setTransform(100.6397,-97.8941,1.3926,1.3926);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgYD+IAAnOIjKAAIAAgtIHEAAIAAAtIjJAAIAAHOg");
	this.shape_9.setTransform(11.2371,-97.8941,1.3926,1.3926);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AixD+IAAn7IAyAAIAAHOIExAAIAAAtg");
	this.shape_10.setTransform(-79.4187,-97.8941,1.3926,1.3926);
	...
	this.shape_11.setTransform(-192.0422,-97.8941,1.3926,1.3926);
	...
	this.instance.setTransform(61.85,13.4,1.5158,1.5158,0,0,0,0.1,0.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-286.25,-64.4,1.6386,1.6386,0,0,0,-0.4,0);
	this.instance._off = true;
	...
	this.instance_1.setTransform(616.75,-251.95,1.0021,1.0021,0,0,0,278.1,46.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-100.7,206.45,1.2197,1.2197,0,0,0,0.1,0.1);
	this.instance._off = true;
	...
	this.instance_1.setTransform(-431.25,74.95,1.7819,1.7819);
	this.instance_1._off = true;
...
p.nominalBounds = new cjs.Rectangle(-1506.9,-989.9,2622.1000000000004,1943.6999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-429,-381,1.1773,1.1773);
...
p.nominalBounds = new cjs.Rectangle(-1552.5,-1138.8,2893.3,2092.1);


// stage content:
(lib._1200x627 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(348.8,313.9,0.8333,0.8333,0,0,0,0.2,0.2);
	...
	// stageBackground
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(0,0,0,0)").ss(1,1,1,3,true).p("EhfTgyiMC+nAAAMAAABlFMi+nAAAg");
	this.shape.setTransform(600,313.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("EhfTAyjMAAAhlFMC+nAAAMAAABlFg");
	this.shape_1.setTransform(600,313.5);
...
p.nominalBounds = new cjs.Rectangle(-345.1,-321.8,1810.9,1429.8999999999999);
// library properties:
lib.properties = {
