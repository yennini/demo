...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(310.851,29.0709,1.1686,1.1686);
	...
	this.shape_1.setTransform(254.9345,28.8956,1.1686,1.1686);
	...
	this.shape_2.setTransform(198.5798,28.1945,1.1686,1.1686);
	...
	this.shape_3.setTransform(143.8319,27.4934,1.1686,1.1686);
	...
	this.shape_4.setTransform(87.4771,27.1428,1.1686,1.1686);
	...
	this.shape_5.setTransform(31.1808,27.581,1.1686,1.1686);
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.setTransform(271.4918,-79.5598,0.8923,0.8923);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2,p:{x:271.4918,y:-79.5598}},{t:this.shape_1,p:{x:197.1551,y:-69.3426}},{t:this.shape,p:{x:225.9983,y:-70.5249}}]}).to({state:[{t:this.shape_2,p:{x:271.4918,y:-79.5598}},{t:this.shape_1,p:{x:197.1551,y:-69.3426}},{t:this.shape,p:{x:225.9983,y:-70.5249}}]},9).to({state:[]},1).to({state:[{t:this.shape_2,p:{x:269.9418,y:-81.0598}},{t:this.shape_1,p:{x:195.6551,y:-70.8426}},{t:this.shape,p:{x:224.4983,y:-72.0249}}]},49).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(182.7,-106.2,116.60000000000002,51.800000000000004);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(42.0203,-8.5753,2.3425,2.3425);
	...
	this.shape_1.setTransform(-18.9424,-7.4627,2.3425,2.3425);
...
p.nominalBounds = new cjs.Rectangle(-33.7,-23.4,90,29.7);
...
p.nominalBounds = new cjs.Rectangle(-770.4,-216.8,821.4,276.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(155.35,-2.25);
	this.instance._off = true;
	...
	this.instance_1.setTransform(118.35,-47.45,1.0527,1.0527);
	this.instance_1._off = true;
	...
	this.instance_3.setTransform(316.9,-121.35,1,1,0,0,0,346,21.6);
...
p.nominalBounds = new cjs.Rectangle(-187.8,-88.6,419.3,235.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(23.6,106.7,1,1,0,0,0,34,34);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:0.9999,scaleY:0.9999,rotation:45.0006,x:23.7,y:106.9,startPosition:25},55,cjs.Ease.cubicOut).to({startPosition:49},24).to({_off:true},1).wait(3).to({_off:false,startPosition:53},0).wait(1));
	...
	var mask_graphics_83 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-172.1101,y:67.975}).wait(79).to({graphics:mask_graphics_79,x:-172.1101,y:67.975}).wait(1).to({graphics:null,x:0,y:0}).wait(3).to({graphics:mask_graphics_83,x:-172.1101,y:67.975}).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-206.2,228.25);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(24).to({_off:false},0).wait(73).to({startPosition:73},0).to({_off:true},1).wait(9));
...
p.nominalBounds = new cjs.Rectangle(-346.3,-311,689.4000000000001,606.1);
...
p.nominalBounds = new cjs.Rectangle(-1142.6,-1138.8,2201.3999999999996,2109.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(130.25,140.3,0.56,0.56,0,0,0,0.2,0.2);
...
p.nominalBounds = new cjs.Rectangle(-341.7,-357.5,1064.7,1041);
// library properties:
lib.properties = {
