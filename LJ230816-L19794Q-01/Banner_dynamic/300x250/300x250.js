...
p.nominalBounds = new cjs.Rectangle(0,0,600,529);
...
p.nominalBounds = new cjs.Rectangle(0,0,600,530);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(310.8691,29.0749,1.1686,1.1686);
	...
	this.shape_1.setTransform(254.9511,28.8996,1.1686,1.1686);
	...
	this.shape_2.setTransform(198.5949,28.1985,1.1686,1.1686);
	...
	this.shape_3.setTransform(143.8455,27.4973,1.1686,1.1686);
	...
	this.shape_4.setTransform(87.4893,27.1467,1.1686,1.1686);
	...
	this.shape_5.setTransform(31.1916,27.5849,1.1686,1.1686);
...
p.nominalBounds = new cjs.Rectangle(0,0,341.6,56.2);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(110.0864,-65.8627,0.9549,0.9549);
	...
	this.shape_1.setTransform(85.7123,-65.8866,0.9549,0.9549);
	...
	this.shape_2.setTransform(60.0014,-65.3375,0.9549,0.9549);
	...
	this.shape_3.setTransform(34.4575,-66.2924,0.9549,0.9549);
	...
	this.shape_4.setTransform(11.9216,-66.1014,0.9549,0.9549);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ah1AMIAGgYIDlAAIgHAZg");
	this.shape_5.setTransform(-13.7416,-66.2208,0.9549,0.9549);
	...
	this.shape_6.setTransform(-39.0944,-65.9582,0.9549,0.9549);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("Ah1ANIAHgZIDkAAIgHAZg");
	this.shape_7.setTransform(-63.1582,-66.3163,0.9549,0.9549);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-300,-269);
...
p.nominalBounds = new cjs.Rectangle(-300,-269,600,530);
...
p.nominalBounds = new cjs.Rectangle(-300,-250,600,529);
...
p.nominalBounds = new cjs.Rectangle(-300,-250,600,530);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-281,-263,0.9364,0.9364);
...
p.nominalBounds = new cjs.Rectangle(-281,-263,561.9,496.3);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(11).to({_off:true},1).wait(8).to({_off:false},0).wait(68));
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(506.1431,21.575,1,1.0627,0,-19.785,0);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#1350AD").s().p("A6nDYIibmvMA3qAAAICbGvg");
	this.shape_1.setTransform(483.3,21.575);
	this.shape_1._off = true;

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#1350AD").s().p("A6mDYIicmvMA3pAAAICcGvg");
	this.shape_2.setTransform(460.4,21.575);
	this.shape_2._off = true;

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#1350AD").s().p("A6mDYIicmvMA3qAAAICbGvg");
	this.shape_3.setTransform(254.5,21.575);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape}]},1).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},1).wait(13).to({_off:false,x:185.8931},0).wait(74));
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1).to({_off:false},0).to({_off:true},1).wait(2).to({_off:false,x:414.65},0).wait(1).to({x:391.75},0).wait(1).to({x:368.9},0).wait(1).to({x:346.05},0).to({_off:true},1).wait(2).to({_off:false,x:277.4},0).to({_off:true},1).wait(1).to({_off:false,x:231.65},0).to({_off:true},1).wait(75));
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(2).to({_off:false},0).wait(1).to({x:437.55},0).to({_off:true},1).wait(4).to({_off:false,x:323.15},0).wait(1).to({x:300.3},0).to({_off:true},1).wait(3).to({_off:false,x:208.75},0).to({_off:true},1).wait(74));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,692.1,43.2);
...
p.nominalBounds = new cjs.Rectangle(-190,-8.2,355,69);
...
p.nominalBounds = new cjs.Rectangle(-770.4,-229.3,821.4,288.8);
...
p.nominalBounds = new cjs.Rectangle(-1210,-1138.3,2018.2,1483.9);
...
p.nominalBounds = new cjs.Rectangle(-343,-311,686.1,606.1);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_79 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-172.1101,y:67.975}).wait(79).to({graphics:mask_graphics_79,x:-172.1101,y:67.975}).wait(1).to({graphics:null,x:0,y:0}).wait(4));
...
p.nominalBounds = new cjs.Rectangle(-276.3,-30.2,402.8,196.39999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},11).to({x:-7.65},80,cjs.Ease.cubicOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-11.6202,21.7206,1.2307,1.2307);
	...
	this.shape_1.setTransform(-26.2657,17.6592,1.2307,1.2307);
	...
	this.shape_2.setTransform(-6.082,-2.2168,1.2307,1.2307);
	...
	this.shape_3.setTransform(-24.8196,-1.8537,1.2307,1.2307);
	...
	this.shape_4.setTransform(234.2863,19.5497,1.2182,1.2182);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgdAIIAAgPIA7AAIAAAPg");
	this.shape_5.setTransform(218.9975,18.636,1.2182,1.2182);
	...
	this.shape_6.setTransform(207.0893,21.8948,1.2182,1.2182);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAVA+QgbgfgTgQQAUgYAWgUIAYAAQgeAXgPAUQAJAIATATQAQAQAEAFgAgrA+IAAh8IAQAAIAAB8g");
	this.shape_7.setTransform(195.1506,17.6919,1.2182,1.2182);
	...
	this.shape_8.setTransform(215.3169,-4.0325,1.2182,1.2182);
	...
	this.shape_9.setTransform(196.9825,-4.063,1.2182,1.2182);
...
p.nominalBounds = new cjs.Rectangle(-234.8,-46.1,478.3,92.30000000000001);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_67 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-9.31,y:-3.45}).wait(67).to({graphics:mask_graphics_67,x:-9.31,y:-3.45}).wait(1).to({graphics:null,x:0,y:0}).wait(16));
...
p.nominalBounds = new cjs.Rectangle(-190.1,-96.6,361.6,186.3);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_20 = new cjs.Graphics().p("");
	var mask_graphics_22 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:0.9666,y:-37.9602}).wait(20).to({graphics:mask_graphics_20,x:0.9666,y:-37.9602}).wait(1).to({graphics:null,x:0,y:0}).wait(1).to({graphics:mask_graphics_22,x:0.9666,y:-37.9602}).wait(29));
...
p.nominalBounds = new cjs.Rectangle(-214.1,-155,561.9,234.2);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.1685,scaleY:1.0273,x:-185.1,y:427.45},22).to({scaleX:1.2068,scaleY:1.0335,x:-425.45,y:304},5).to({scaleX:1.3829,scaleY:1.3829,x:-499.4,y:262},23).wait(1));
	...
	this.instance_2.setTransform(2.65,-2.45,1,1,0,0,0,274.8,69.3);
...
p.nominalBounds = new cjs.Rectangle(-955.3,-266.1,1560.8,1057.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:176.45,alpha:1,startPosition:20},8).wait(80));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-296.5,189.25);
	this.instance._off = true;
	...
	this.instance_1.setTransform(32.5,208.2,1,1,0,0,0,278.1,46.4);
	this.instance_1.alpha = 0.1016;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(91).to({_off:true},1).wait(10));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(42.7,193.6);
	this.instance._off = true;
	...
	this.instance_1.setTransform(-70.7,115.45);
	this.instance_1._off = true;
...
if (reversed == null) { reversed = false; }
	...
	this.shape_2.setTransform(29.55,-78.525);
	...
	this.shape_3.setTransform(-17.75,-78.5);
	...
	this.shape_4.setTransform(-65.575,-78.675);
	...
	this.shape_5.setTransform(-113.1,-78.575);
	...
	this.shape_6.setTransform(188.825,-22.475);
	...
	this.shape_11.setTransform(-184.175,-22.475);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]}).to({state:[{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6}]},63).to({state:[]},1).wait(2));

	// an_sc1_heart
	this.instance = new lib.an_sc1heart("synched",0,false);
	this.instance.setTransform(7.65,221.15);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12},{t:this.instance_1,p:{startPosition:0}}]}).to({state:[{t:this.shape_12},{t:this.instance_1,p:{startPosition:50}}]},63).to({state:[]},1).wait(2));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-206.2,224.25);
	this.instance._off = true;
	...
	this.instance_1.setTransform(155.35,-2.25);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(118.35,-47.45,1.0527,1.0527);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(4).to({_off:false},0).wait(84));

	// an_man
	this.instance_3 = new lib.an_man("synched",0);
	this.instance_3.setTransform(168.9,-85.05,1.404,1.404,0,0,0,75,158.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(88));

	// an_sc5_line
	this.instance_4 = new lib.an_sc5line("synched",0);
	this.instance_4.setTransform(316.9,-121.35,1,1,0,0,0,346,21.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(88));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1228.5,-1139.8,2018.2,1483.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-5.2,18.25);
	this.instance._off = true;
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-249.6,-252.5);
...
p.nominalBounds = new cjs.Rectangle(-1142.6,-1138.8,2153.5,2109.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(116.3,125.25,0.5,0.5,0,0,0,0.1,0.1);
...
p.nominalBounds = new cjs.Rectangle(-303.1,-314.9,924.7,925.1999999999999);
// library properties:
lib.properties = {
