...
p.nominalBounds = new cjs.Rectangle(0,0,558,500);
...
p.nominalBounds = new cjs.Rectangle(0,0,1455,375);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-970,-250,1.3333,1.3333);
...
p.nominalBounds = new cjs.Rectangle(-970,-250,1940,500);
...
p.nominalBounds = new cjs.Rectangle(-300,-250,558,500);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-900,-250,1.8567,1.8567);
...
p.nominalBounds = new cjs.Rectangle(-900,-250,1801,464.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(414.35,-1155.75,3.5215,3.5215,0,0,0,0.1,-0.1);
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:3.0169,scaleY:1.6914,rotation:19.9911,x:-201,y:-651.65},87).wait(1));

	// sb_circle
	this.instance_1 = new lib.sb_circle2();
	this.instance_1.setTransform(1767.55,-344.7,3.661,3.661);
	this.instance_1.compositeOperation = "lighten";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0.1,regY:-0.2,scaleX:3.8788,scaleY:3.344,x:709.3,y:-1074.75},87).wait(1));

	// sc5_bg
	this.instance_2 = new lib.sc5bg();
	this.instance_2.setTransform(-971,-250,1.3349,1.3347);
...
p.nominalBounds = new cjs.Rectangle(-1326.7,-2316.4,4301.3,3178.8);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_42 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(42).to({graphics:mask_graphics_42,x:-554.0554,y:-36.3767}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-833.3,-276.6,780.6999999999999,546.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-108,-10.9,0.9663,0.9663);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-96},55).wait(1));

	// sb_sc4_bg
	this.instance_1 = new lib.sb_sc4bg("single",42);
	this.instance_1.setTransform(74.4,0,1.0933,1.0933);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:62.4},55).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-998.1,-278.2,2133,551.5999999999999);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_79 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:552.6565,y:80.5453}).wait(79).to({graphics:mask_graphics_79,x:552.6565,y:80.5453}).wait(1).to({graphics:null,x:0,y:0}).wait(4));
...
p.nominalBounds = new cjs.Rectangle(373.7,-69.4,357.90000000000003,293.20000000000005);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_67 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:364.0864,y:41.0831}).wait(67).to({graphics:mask_graphics_67,x:538.9818,y:41.0726}).wait(1).to({graphics:null,x:0,y:0}).wait(16));
...
p.nominalBounds = new cjs.Rectangle(349.8,-104,378.40000000000003,290.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1270.55,58.35,1.6203,2.421,0,0,0,-0.1,-0.1);
	this.instance.compositeOperation = "lighten";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0,regY:0,scaleX:2.0509,scaleY:2.0509,x:-789.25,y:578.95},83).wait(1));

	// sb_circle
	this.instance_1 = new lib.sb_circle();
	this.instance_1.setTransform(885.6,-143.95,0.7995,1.1946,0,0,0,0,-0.1);
	this.instance_1.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regY:0,scaleX:1.3829,scaleY:1.3829,x:1055.5,y:-440.75},83).wait(1));

	// an_sc2_car
	this.instance_2 = new lib.an_sc2car("synched",0);
	this.instance_2.setTransform(495.15,72.3,1,1,0,0,0,539,41.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},7,cjs.Ease.cubicOut).to({regX:538.9,regY:41.2,scaleX:1.2224,scaleY:1.2224,x:495.1,y:72.45},68,cjs.Ease.cubicOut).wait(9));
...
p.nominalBounds = new cjs.Rectangle(-1804.6,-896.7,3316.1,2151.9);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_20 = new cjs.Graphics().p("");
	var mask_graphics_22 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-496.5,y:-121.9016}).wait(20).to({graphics:mask_graphics_20,x:-496.5,y:-121.9016}).wait(1).to({graphics:null,x:0,y:0}).wait(1).to({graphics:mask_graphics_22,x:-496.5,y:-121.9016}).wait(29));
...
p.nominalBounds = new cjs.Rectangle(-833.1,-261.4,845.4,279);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-69.85,198.45,1.1701,1.1701,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-54.25},50).wait(1));

	// sb_sc1_bg
	this.instance_2 = new lib.sb_sc1bg("synched",21);
	this.instance_2.setTransform(4.1,21.55,1.0938,1.0938);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-3.5,mode:"single",startPosition:43},50).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1044.6,-986,2034.3,1241.9);


(lib.an_sc3bgline = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(474.8,2.45,1.4352,1.4352,0,0,0,0,0.1);
	this.instance._off = true;
	...
	this.instance_1.setTransform(-148.95,0);
...
p.nominalBounds = new cjs.Rectangle(-1147,-278.2,2133,551.5999999999999);
...
if (reversed == null) { reversed = false; }
	...
	// sb_circle_copy
	this.instance = new lib.sb_circle();
	this.instance.setTransform(-1142.8,181.65,2.4098,1.7973,0,0,0,-0.2,-0.1);
	this.instance.alpha = 0.5508;
	this.instance.compositeOperation = "screen";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-0.1,regY:0,scaleX:2.2424,scaleY:1.4861,x:-590.25,y:539.05,alpha:1},91).wait(1));

	// sb_circle
	this.instance_1 = new lib.sb_circle();
	this.instance_1.setTransform(978.2,-295.3,0.5383,1.4543,-14.998,0,0,0.1,-0.1);
	this.instance_1.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0.5,scaleX:0.7561,scaleY:2.0426,rotation:-2.7819,x:907.35,y:-398.45},91).wait(1));

	// sb_sc3_bgfront
	this.instance_2 = new lib.sb_sc3bgfront();
	this.instance_2.setTransform(726.15,-7.95,1.0318,1.0318);
	this.instance_2.compositeOperation = "lighten";

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(92));

	// sb_sc3_car
	this.instance_3 = new lib.sb_sc3car("synched",0);
	this.instance_3.setTransform(-23.65,26.25);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({startPosition:0},11).to({y:-7.6},80,cjs.Ease.cubicOut).wait(1));

	// an_sc3-bgline
	this.instance_4 = new lib.an_sc3bgline("synched",0,false);
	this.instance_4.setTransform(456.3,-125.9,1.39,1.39,0,0,0,40.3,62.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(92));

	// sb_sc3_bg
	this.instance_5 = new lib.sb_sc3bg("synched",23);
...
p.nominalBounds = new cjs.Rectangle(-1936.8,-1083,3210.6,2112);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(864.7,-47.7,1.7492,1.7492,0,0,0,18.2,96.9);
	...
	this.instance_1.setTransform(-316.7,55,1.6721,1.6721);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(-679.6,-81.7,1.6721,1.6721);
	this.instance_2._off = true;
...
p.nominalBounds = new cjs.Rectangle(-1804.6,-896.7,3316,2151.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(316.55,113.8,1.4523,1.4523);
	...
	this.shape.setTransform(512.3622,-59.9742,1.4523,1.4523);
	...
	this.shape_1.setTransform(416.837,-59.9742,1.4523,1.4523);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgfDeIAAm7IA/AAIAAG7g");
	this.shape_2.setTransform(341.6079,-59.9742,1.4523,1.4523);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgfDeIAAmAIioAAIAAg7IGPAAIAAA7IioAAIAAGAg");
	this.shape_3.setTransform(278.1423,-59.9742,1.4523,1.4523);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AieDeIAAm7IBAAAIAAGAID9AAIAAA7g");
	this.shape_4.setTransform(213.4423,-59.9742,1.4523,1.4523);
	...
	this.shape_5.setTransform(129.6808,-59.9742,1.4523,1.4523);
	...
	this.shape_6.setTransform(539.0119,-130.1203,1.4523,1.4523);
	...
	this.shape_7.setTransform(486.257,-133.4243,1.4523,1.4523);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhfBcIAAgPIBRAAIAAinIAOAAIAABCIBSAAIAAAPIhSAAIAABWIBgAAIAAAPg");
	this.shape_8.setTransform(421.8838,-133.8237,1.4523,1.4523);
	...
	this.shape_9.setTransform(357.6195,-133.2427,1.4523,1.4523);
	...
	this.shape_10.setTransform(293.6456,-133.2064,1.4523,1.4523);
	...
	this.shape_11.setTransform(228.9819,-133.4606,1.4523,1.4523);
	...
	this.shape_12.setTransform(164.645,-133.3154,1.4523,1.4523);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgFB4IAAjvIALAAIAADvg");
	this.shape_13.setTransform(111.7449,-130.1203,1.4523,1.4523);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(827.45,220.95,1.1277,1.1277);
	this.instance._off = true;
	...
	this.instance_1.setTransform(491,134.3,1.6532,1.6532);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(382.35,-114.95,1.6532,1.6532);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(606.8,-14.3,1.6532,1.6532);
...
p.nominalBounds = new cjs.Rectangle(-1175.5,-2318,4131.7,3178.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(840.25,-49.65,1.6578,1.6578,0,0,0,18.2,97.6);
	this.instance.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);
	...
	this.instance_1.setTransform(-713.55,8.4,2.2219,2.2219,0,0,0,-0.1,0.1);
	this.instance_1._off = true;
...
p.nominalBounds = new cjs.Rectangle(-1936.8,-1071.1,3126.8999999999996,2100.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-904,-251);
...
p.nominalBounds = new cjs.Rectangle(-1869.4,-2317,4911.4,3528.5);
...
p.nominalBounds = new cjs.Rectangle(1.6,-908.3,1970.5,1639.1999999999998);
// library properties:
lib.properties = {
