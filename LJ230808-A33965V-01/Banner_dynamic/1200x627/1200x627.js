...
p.nominalBounds = new cjs.Rectangle(0,0,596,502);


(lib.sc2bg = function() {
	this.initialize(img.sc2bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,869,627);


(lib.sc3bg = function() {
	this.initialize(img.sc3bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,893,627);
...
p.nominalBounds = new cjs.Rectangle(0,0,650,416);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(69).to({_off:true},1).wait(14));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-818,-254,2.5432,2.5432);
...
p.nominalBounds = new cjs.Rectangle(-818,-254,2271.1,1594.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-228,-260,0.8251,0.8251);
...
p.nominalBounds = new cjs.Rectangle(-228,-260,717,517.3);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-107.2,0,107.2,0).s().p("EgQvAhgMAAAhC/MAhfAAAMAAABC/g");
	this.shape.setTransform(27.1726,-116.4513,1.1828,1.4374,90);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,1],-24,0,24,0).s().p("EgDvAjvMAAAhHdIHfAAMAAABHdg");
	this.shape_1.setTransform(-256.925,-5.275);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(44));

	// sc1_bg
	this.instance = new lib.sc1bg();
	this.instance.setTransform(-281,-234,0.8687,0.8687);
...
p.nominalBounds = new cjs.Rectangle(-281,-243.2,616.3,466.6);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.rf(["#7FBDF2","#194F7F","rgba(0,0,0,0)","rgba(0,0,0,0)","rgba(0,0,0,0)"],[0,0.451,1,1,1],0,0,0,0,0,333.3).s().p("EgkaAkbQvGvFAA1WQAA1VPGvFQPFvGVVAAQVWAAPFPGQPGPFAAVVQAAVWvGPFQvFPG1WAAQ1VAAvFvGg");
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(390.05,-526.85,1.5246,1.5246);
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0.1,regY:-0.1,scaleX:1.7375,scaleY:1.498,x:-52.05,y:-667.05},87).wait(1));

	// sb_circle
	this.instance_1 = new lib.sb_circle2();
	this.instance_1.setTransform(871.25,-599.5,1.3042,1.3042);
	this.instance_1.compositeOperation = "lighten";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1.5184,scaleY:1.5184,x:536.25,y:-520.35},43).to({regX:0.1,regY:-0.1,scaleX:1.7375,scaleY:1.498,x:705.65,y:-457.05},44).wait(1));

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,0.969],-57.8,0.1,57.9,0.1).s().p("EgJBAtUMAAAhanISDAAMAAABang");
	this.shape.setTransform(227.6653,-20.7,0.5804,1,180);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,0.969],-515.1,0,515.2,0).s().p("EhQfALkIAA3HMCg/AAAIAAXHg");
	this.shape_1.setTransform(-114.0622,-254.8381,0.0756,7.1073,90);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,0.969],-57.8,0.1,57.9,0.1).s().p("EgJBAtUMAAAhanISDAAMAAABang");
	this.shape_2.setTransform(-542.025,-20.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(88));

	// sc5_bg
	this.instance_2 = new lib.sc5bg();
	this.instance_2.setTransform(-586,-292,1.3035,1.3035);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(88));

	// Layer_2
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("EiCaBE5MAAAiJyMEE1AAAMAAACJyg");
	this.shape_3.setTransform(126.275,-171.65);

	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(88));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-708.4,-1160.8,2009.6999999999998,1430.1);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_42 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(42).to({graphics:mask_graphics_42,x:-28.3609,y:-0.0077}).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-100.8,-276.6,183.1,546.6);
...
p.nominalBounds = new cjs.Rectangle(-333.5,-278.2,672,551.5999999999999);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_79 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:718.2676,y:901.1754}).wait(79).to({graphics:mask_graphics_79,x:718.2676,y:901.1754}).wait(1).to({graphics:null,x:0,y:0}).wait(4));
...
p.nominalBounds = new cjs.Rectangle(464.4,621.8,507.80000000000007,558.8);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_67 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:187.6417,y:36.717}).wait(67).to({graphics:mask_graphics_67,x:267.8397,y:36.7271}).wait(1).to({graphics:null,x:0,y:0}).wait(16));
...
p.nominalBounds = new cjs.Rectangle(160.4,-45.7,214.9,164.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-671.75,34.6,0.7995,1.1946,0,0,0,0,-0.1);
	this.instance.compositeOperation = "lighten";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:0,scaleX:1.7514,scaleY:1.7514,x:-342.3,y:531.5},83).wait(1));

	// sb_circle
	this.instance_1 = new lib.sb_circle();
	this.instance_1.setTransform(355.2,-414.75,0.7995,1.1946,0,0,0,0,-0.1);
	this.instance_1.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1.3267,scaleY:1.3647,x:586.1,y:-282.1},75).to({regY:0,scaleX:1.3829,scaleY:1.3829,x:635.65,y:-210.85},8).wait(1));

	// an_sc2_car
	this.instance_2 = new lib.an_sc2car("synched",0);
	this.instance_2.setTransform(232.05,74.4,1,1,0,0,0,275.9,43.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},7,cjs.Ease.cubicOut).to({scaleX:1.1361,scaleY:1.1361,x:232.1,y:81.75},68,cjs.Ease.cubicOut).wait(9));
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("EhN3Ao7MAAAhR1MCbvAAAMAAABR1g");
	this.shape.setTransform(3.125,0.075);
...
p.nominalBounds = new cjs.Rectangle(-935.3,-808.5,2026.8999999999999,1917.5);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_20 = new cjs.Graphics().p("");
	var mask_graphics_22 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-47.7835,y:-4.4719}).wait(20).to({graphics:mask_graphics_20,x:-47.7835,y:-4.4719}).wait(1).to({graphics:null,x:0,y:0}).wait(1).to({graphics:mask_graphics_22,x:-47.7835,y:-4.4719}).wait(29));
...
p.nominalBounds = new cjs.Rectangle(-214.1,-113.1,616.3,183.3);
...
if (reversed == null) { reversed = false; }
	...
	// sb_circle
	this.instance = new lib.sb_circle();
	this.instance.setTransform(437.05,-281,1.2355,1.2355);
	...
	this.instance_1.setTransform(-56.4,185.4,1.1669,1.1669,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-51.45},50).wait(1));

	// sb_sc1_bg
	this.instance_2 = new lib.sb_sc1bg("synched",21);
	this.instance_2.setTransform(29.7,21.55,1.0938,1.0938);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:2.9,mode:"single",startPosition:43},50).wait(1));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("EhmHAudMAAAhc5MDMPAAAMAAABc5g");
	this.shape.setTransform(-223.175,24.125);
...
p.nominalBounds = new cjs.Rectangle(-876.7,-986,1721.1,1307.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},27).to({regY:-0.6,y:62.3,alpha:1,startPosition:23},10).to({regY:-0.4,y:62.4,alpha:0.4609,startPosition:0},4).to({alpha:1,startPosition:13,loop:false},8).to({startPosition:24},11).to({_off:true},1).wait(45));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-5.2,18.25,1.5938,1.5938);
	this.instance._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("EAoOgK6MAAABD6MhQbAAAMAAAgkFEgoNggdIAA4iIOKAA");
	this.shape.setTransform(-418.525,38.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#000000","rgba(0,0,0,0)"],[0,0.969],-222.8,-128.6,223,128.7).s().p("EgoNAqmI3HtWMAXHgoBIOL4iMATugiLMBFpAoOMgXHAoBMgh5A6tg");
	this.shape_1.setTransform(-418.55,-100.75);
	...
	this.instance_1.setTransform(0,135.55,1.9034,1.9034);
...
p.nominalBounds = new cjs.Rectangle(-823.9,-545.4,1468,1201.1999999999998);
...
if (reversed == null) { reversed = false; }
	...
	// sb_circle_copy
	this.instance = new lib.sb_circle();
	this.instance.setTransform(-1739.4,453.6,3.044,3.0715,0,0,0,-0.2,0);
	this.instance.alpha = 0.5508;
	this.instance.compositeOperation = "screen";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-0.1,regY:0.1,scaleX:3.2358,scaleY:3.2358,x:-858.65,y:1588.7,alpha:1},91).wait(1));

	// sb_circle
	this.instance_1 = new lib.sb_circle();
	this.instance_1.setTransform(1711.95,4.25,0.8989,2.4285,-14.9982,0,0,0.1,-0.1);
	this.instance_1.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0.2,regY:-0.2,scaleX:1.2033,scaleY:3.251,rotation:-2.7821,x:1411.25,y:125.5},91).wait(1));

	// sb_sc3_car
	this.instance_2 = new lib.sb_sc3car("synched",0);
	this.instance_2.setTransform(231.65,74.45,1,1,0,0,0,255.3,48.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},11).to({y:-0.35},80,cjs.Ease.quadOut).wait(1));

	// an_sc3_line
	this.instance_3 = new lib.an_sc3line("synched",0,false);
	this.instance_3.setTransform(636.95,497,2.557,2.557,0,0,0,40.4,63);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(60).to({mode:"single",startPosition:60},0).wait(32));

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(0,0,0,0)","#000000"],[0,1],-438.4,0,438.4,0).s().p("EhEfCV1MAAAkrqMCI/AAAMAAAErqg");
	this.shape.setTransform(-1479.7232,528.7,1.5093,1,0,180,0);
	...
	// Layer_2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("EkLhCP/MAAAkf9MIXDAAAMAAAEf9g");
	this.shape_1.setTransform(-58.925,491.275);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(92));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2742.4,-963.6,4947.8,3618.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(501.2,-85.4,0.9552,0.9552,0,0,0,18.2,96.9);
	this.instance.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(81).to({_off:true},1).wait(2));

	// an_sc2_num
	this.instance_1 = new lib.an_sc2num("synched",0,false);
	this.instance_1.setTransform(-264.25,110.35,1.1492,1.1492);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).wait(78).to({startPosition:29},0).to({_off:true},1).wait(2));

	// an_sc2_vc
	this.instance_2 = new lib.an_sc2vc("synched",0,false);
	this.instance_2.setTransform(-505.8,36.85,1.1492,1.1492);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(3).to({_off:false},0).wait(78).to({startPosition:59},0).to({_off:true},1).wait(2));

	// an_sc2_bg
	this.instance_3 = new lib.an_sc2bg("synched",0,false);
	this.instance_3.setTransform(0,0,1.1803,1.1803);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(81).to({startPosition:81},0).to({_off:true},1).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1103.9,-954.2,2392.2,2263.1000000000004);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(224.35,-48.95);
	...
	this.shape.setTransform(-131.575,-32.9);
	...
	this.shape_5.setTransform(-395.075,-32.9);
	...
	this.shape_6.setTransform(-113.225,-81.2);
	...
	this.shape_9.setTransform(-238.125,-83.35);
	...
	this.shape_10.setTransform(-282.175,-83.325);
	...
	this.shape_11.setTransform(-326.7,-83.5);
	...
	this.shape_12.setTransform(-371,-83.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgFB4IAAjvIALAAIAADvg");
	this.shape_13.setTransform(-407.425,-81.2);
	...
	this.instance_1.setTransform(246.55,-6.55,1.2668,1.2668);
...
p.nominalBounds = new cjs.Rectangle(-864.1,-1255.6,2180.3,1656.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(439.15,220.75,1.1608,1.1608);
	this.instance._off = true;
	...
	this.instance_1.setTransform(301.15,80.35,1.5231,1.5231);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(185.65,-168.1,1.5231,1.5231);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(392.55,-75.5,1.5231,1.5231,0,0,0,0.1,-0.1);
	...
	this.instance_4.setTransform(-107.2,122.65,0.7081,0.7081);
...
p.nominalBounds = new cjs.Rectangle(-608.8,-699.3,1562.5,1012.6999999999999);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(518.25,-47.4,1.0494,1.0494,0,0,0,18.3,97.5);
	this.instance.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(99).to({_off:true},1).wait(2));

	// an_sc3_tt
	this.instance_1 = new lib.an_sc3tt("synched",0,false);
	this.instance_1.setTransform(-499.6,146.55,1.3994,1.3994);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(2).to({_off:false},0).wait(97).to({startPosition:22},0).to({_off:true},1).wait(2));

	// an_sc3_bg
	this.instance_2 = new lib.an_sc3bg("synched",0,false);
	this.instance_2.setTransform(23.95,-202.15,0.3804,0.3804);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(99).to({startPosition:91},0).to({_off:true},1).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1111.5,-561.5,1921.3,1369.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-522,-306,0.8922,0.8922);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(313).to({_off:false},0).to({alpha:1,mode:"synched",loop:false},3).to({startPosition:80},80).to({_off:true},1).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(243).to({_off:false},0).to({alpha:1,mode:"synched",loop:false},3).to({mode:"single",startPosition:59},67).to({_off:true},1).wait(92));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(142).to({_off:false},0).to({alpha:1,mode:"synched",loop:false},4).to({mode:"single",startPosition:81},100).to({_off:true},1).wait(159));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(56).to({_off:false},0).to({alpha:1,mode:"synched",loop:false},8).to({startPosition:59},82).to({_off:true},1).wait(259));

	// sc1
	this.instance_5 = new lib.sc1("synched",0,false);
	this.instance_5.setTransform(67.4,-0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({startPosition:43},64).to({_off:true},1).wait(341));

	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("Ehb5AxIMAAAhiPMC3zAAAMAAABiPg");
	this.shape.setTransform(63.325,-6.65);
...
p.nominalBounds = new cjs.Rectangle(-1044.1,-1256.1,2427.7,2545.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(529.2,314.05,1.05,1.05,0,0,0,0,0.1);
...
p.nominalBounds = new cjs.Rectangle(32.9,-691.5,1949,2359);
// library properties:
lib.properties = {
