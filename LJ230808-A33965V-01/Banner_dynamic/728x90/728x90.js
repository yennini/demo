...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(42).to({x:-728},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-728,-90,1474,180);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:586.9,y:-315.2},55).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-1085.7,-36.6,2033.4,251.4);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:2.9964,scaleY:2.5042,x:-565.25,y:683.75,alpha:0.7539},41).to({regX:-0.1,scaleX:2.3529,scaleY:2.3529,x:-602.05,y:695,alpha:1},50).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-782.7,-95,1556.2,192.4);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(154.0895,14.6806,1.108,1.108);
	...
	this.shape_1.setTransform(81.2107,14.6806,1.108,1.108);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgfDeIAAm7IA/AAIAAG7g");
	this.shape_2.setTransform(23.8162,14.6806,1.108,1.108);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgfDeIAAmAIioAAIAAg7IGPAAIAAA7IioAAIAAGAg");
	this.shape_3.setTransform(-24.6034,14.6806,1.108,1.108);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AieDeIAAm7IBAAAIAAGAID9AAIAAA7g");
	this.shape_4.setTransform(-73.9649,14.6806,1.108,1.108);
	...
	this.shape_5.setTransform(-137.8689,14.6806,1.108,1.108);
	...
	this.shape_6.setTransform(174.4214,-38.8359,1.108,1.108);
	...
	this.shape_7.setTransform(134.1732,-41.3566,1.108,1.108);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhfBcIAAgPIBRAAIAAinIAOAAIAABCIBSAAIAAAPIhSAAIAABWIBgAAIAAAPg");
	this.shape_8.setTransform(85.061,-41.6613,1.108,1.108);
	...
	this.shape_9.setTransform(36.0319,-41.2181,1.108,1.108);
	...
	this.shape_10.setTransform(-12.7755,-41.1904,1.108,1.108);
	...
	this.shape_11.setTransform(-62.1093,-41.3843,1.108,1.108);
	...
	this.shape_12.setTransform(-111.1938,-41.2735,1.108,1.108);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgFB4IAAjvIALAAIAADvg");
	this.shape_13.setTransform(-151.5527,-38.8359,1.108,1.108);
...
p.nominalBounds = new cjs.Rectangle(-1242.8,-946.2,2546.6,1095.3);
...
p.nominalBounds = new cjs.Rectangle(-1902.8,-945.2,3292.3999999999996,1833.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(331.8,45.25,0.4806,0.4806,0,0,0,0.1,0.2);
...
p.nominalBounds = new cjs.Rectangle(-218.7,-364.1,1204.7,836.1);
// library properties:
lib.properties = {
