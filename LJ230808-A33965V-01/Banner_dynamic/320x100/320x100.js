...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(128.6468,0.2672,1.3229,1.3229);
	...
	this.shape_1.setTransform(92.3,0.2011,1.3229,1.3229);
	...
	this.shape_2.setTransform(55.5232,0.8625,1.3229,1.3229);
	...
	this.shape_3.setTransform(18.8456,-0.295,1.3229,1.3229);
	...
	this.shape_4.setTransform(-17.7989,-0.0635,1.3229,1.3229);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhoAMIAAgXIDRAAIAAAXg");
	this.shape_5.setTransform(-54.7411,-0.2289,1.3229,1.3229);
	...
	this.shape_6.setTransform(-92.3116,0.0688,1.3229,1.3229);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhoAMIAAgXIDRAAIAAAXg");
	this.shape_7.setTransform(-128.2947,-0.3611,1.3229,1.3229);
...
p.nominalBounds = new cjs.Rectangle(-142.2,-14.2,284.7,28.7);
...
p.nominalBounds = new cjs.Rectangle(-300,-250,640,200);
...
p.nominalBounds = new cjs.Rectangle(-302,-250,646,201.9);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(14).to({_off:true},1).wait(15));
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(-302,-96,0.9612,0.9609);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-235.5,45.25,0.6389,0.6389,0,0,0,-0.1,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-243.9},55).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-492,-256.8,846.2,693.5);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_79 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:162.5886,y:-134.2301}).wait(79).to({graphics:mask_graphics_79,x:162.5886,y:-134.2301}).wait(1).to({graphics:null,x:0,y:0}).wait(4));
...
p.nominalBounds = new cjs.Rectangle(90.8,-194.4,143.7,118.2);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},11).to({scaleX:0.9891,scaleY:0.9891,y:5.2,startPosition:23},80,cjs.Ease.cubicOut).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(66.1,-187.1,144.70000000000002,137.1);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.6031,scaleY:1.3694,x:-436.5,y:451.35,alpha:0.7734},45).to({regX:0,regY:0,scaleX:1.3829,scaleY:1.3829,x:-155.95,y:507.95,alpha:1},46).wait(1));
	...
	this.instance_2.setTransform(-38.5,242.75,1.7951,1.7951,0,0,0,-0.1,-0.1);
	...
	this.instance_5.setTransform(157.75,-116.6,1,1,0,0,0,40.2,62.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(92));

	// sb_sc3_bg
	this.instance_6 = new lib.sb_sc3bg("synched",23);
	this.instance_6.setTransform(-39.45,243.3,1.7978,1.7978,0,0,0,-0.1,0.1);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_67 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:161.6417,y:-152.5036}).wait(67).to({graphics:mask_graphics_67,x:161.6417,y:-152.5036}).wait(1).to({graphics:null,x:0,y:0}).wait(16));
...
p.nominalBounds = new cjs.Rectangle(85.6,-210.8,152.1,116.70000000000002);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(196.75,130.95);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({startPosition:0},7,cjs.Ease.cubicOut).to({scaleX:1.1552,scaleY:1.1552,x:170.3,y:161.05},68,cjs.Ease.quintOut).wait(9));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(269.2,-82.5,175.7,134.8);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:0,scaleX:1.3829,scaleY:1.3829,x:-78.65,y:482.9},83).wait(1));
	...
	this.instance_2.setTransform(-60.3,70.8,0.9368,0.9368,0,0,0,196.3,24.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(56).to({startPosition:56},0).wait(28));

	// sb_sc2_bg
	this.instance_3 = new lib.sb_sc2bg("synched",0);
	this.instance_3.setTransform(-19,141.05,0.9375,0.9375);
...
p.nominalBounds = new cjs.Rectangle(-603.3,-776.7,1594.8,1715.6);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_50 = new cjs.Graphics().p("");
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-258.35,30.6,0.8333,0.8332,0,0,0,-0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-248.75},50).wait(1));

	// sb_sc1_bg
	this.instance_2 = new lib.sb_sc1bg("synched",21);
	this.instance_2.setTransform(4.1,31.55,1.0938,1.0938);
...
p.nominalBounds = new cjs.Rectangle(-539.4,-986,1306.1999999999998,1291);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-5.2,-1.35,0.7899,0.7899);
	this.instance._off = true;
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(257.75,-0.5,0.8427,0.8427,0,0,0,18.2,97.5);
	...
	this.instance_1.setTransform(-291.65,39.75,0.7484,0.7484);
	this.instance_1._off = true;
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(256.3,-4.25,0.7921,0.7921,0,0,0,18.2,96.9);
	this.instance.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);
	...
	this.instance_1.setTransform(-151.25,46.3,0.654,0.654,0,0,0,-0.1,0.1);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(-290.65,8.4,0.654,0.654,0,0,0,-0.1,-0.1);
	this.instance_2._off = true;
...
p.nominalBounds = new cjs.Rectangle(-602.6,-777.3,1594.6,1715.6);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(245.4098,16.763,0.8877,0.8877);
	...
	this.shape_1.setTransform(187.0237,16.763,0.8877,0.8877);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgfDeIAAm7IA/AAIAAG7g");
	this.shape_2.setTransform(141.0427,16.763,0.8877,0.8877);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgfDeIAAmAIioAAIAAg7IGPAAIAAA7IioAAIAAGAg");
	this.shape_3.setTransform(102.2517,16.763,0.8877,0.8877);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AieDeIAAm7IBAAAIAAGAID9AAIAAA7g");
	this.shape_4.setTransform(62.7062,16.763,0.8877,0.8877);
	...
	this.shape_5.setTransform(11.5102,16.763,0.8877,0.8877);
	...
	this.shape_6.setTransform(261.6985,-26.1113,0.8877,0.8877);
	...
	this.shape_7.setTransform(229.4541,-28.1307,0.8877,0.8877);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhfBcIAAgPIBRAAIAAinIAOAAIAABCIBSAAIAAAPIhSAAIAABWIBgAAIAAAPg");
	this.shape_8.setTransform(190.1083,-28.3748,0.8877,0.8877);
	...
	this.shape_9.setTransform(150.8292,-28.0197,0.8877,0.8877);
	...
	this.shape_10.setTransform(111.7275,-27.9975,0.8877,0.8877);
	...
	this.shape_11.setTransform(72.2042,-28.1529,0.8877,0.8877);
	...
	this.shape_12.setTransform(32.8807,-28.0641,0.8877,0.8877);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgFB4IAAjvIALAAIAADvg");
	this.shape_13.setTransform(0.5475,-26.1113,0.8877,0.8877);
	...
	// an_sc1_bg
	this.instance = new lib.an_sc1bg("synched",0,false);
	this.instance.setTransform(0,16.5,0.9666,0.9666);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(63).to({startPosition:50},0).to({_off:true},1).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-521.4,-936.6,1262.6,1247.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(212,78.1,0.6401,0.6401);
	this.instance._off = true;
	...
	this.instance_1.setTransform(145.15,35.15,0.7043,0.7043,0,0,0,0.1,0.1);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(124.2,-54.25,0.7043,0.7043);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(210.7,-14.5,0.565,0.565,0,0,0,0.2,-0.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-236,-92,0.4076,0.4076);
...
p.nominalBounds = new cjs.Rectangle(-793.9,-976.9,1805.4,1862);
...
p.nominalBounds = new cjs.Rectangle(-139.8,-421.5,804,944.3);
// library properties:
lib.properties = {
