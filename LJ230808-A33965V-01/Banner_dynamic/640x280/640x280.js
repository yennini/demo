...
p.nominalBounds = new cjs.Rectangle(-818,-254,1627.6,508.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-896,-255,2.5494,2.5494);
...
p.nominalBounds = new cjs.Rectangle(-896,-255,1631.6,509.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(17.45,-526.85,1.5246,1.5246);
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0.1,regY:-0.1,scaleX:1.7375,scaleY:1.498,x:-235,y:-611.9},87).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1.5184,scaleY:1.5184,x:306.25,y:-543.2},43).to({regX:0.1,regY:-0.1,scaleX:1.7375,scaleY:1.498,x:225.4,y:-529.05},44).wait(1));

	// sc5_bg
	this.instance_2 = new lib.sc5bg();
	this.instance_2.setTransform(-683,-252,2.5252,2.5252);
...
p.nominalBounds = new cjs.Rectangle(-808,-1105.6,1741.2,1358.6999999999998);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_79 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:251.2037,y:81.051}).wait(79).to({graphics:mask_graphics_79,x:321.4074,y:81.0505}).wait(1).to({graphics:null,x:0,y:0}).wait(4));
...
p.nominalBounds = new cjs.Rectangle(140.4,-70.5,362,298.9);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_67 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:202.8584,y:42.8818}).wait(67).to({graphics:mask_graphics_67,x:212.2818,y:42.8717}).wait(1).to({graphics:null,x:0,y:0}).wait(16));
...
p.nominalBounds = new cjs.Rectangle(18.9,-105.5,386.8,296.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-848.4,-37.3,0.7995,1.1946,0,0,0,0,-0.1);
	this.instance.compositeOperation = "lighten";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:0,scaleX:1.7514,scaleY:1.7514,x:-488.65,y:531.5},83).wait(1));

	// sb_circle
	this.instance_1 = new lib.sb_circle();
	this.instance_1.setTransform(417,-334,0.7995,1.1946,0,0,0,0,-0.1);
	this.instance_1.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1.3267,scaleY:1.3647,x:586.1,y:-282.1},75).to({regY:0,scaleX:1.3829,scaleY:1.3829,x:604.1,y:-276.45},8).wait(1));

	// an_sc2_car
	this.instance_2 = new lib.an_sc2car("synched",0);
	this.instance_2.setTransform(181.95,84.1,1,1,0,0,0,225.8,52.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},7,cjs.Ease.cubicOut).to({regY:53,scaleX:1.1515,scaleY:1.1515,y:95.7},68,cjs.Ease.cubicOut).wait(9));
...
p.nominalBounds = new cjs.Rectangle(-1112,-732.4,2172.1,1841.4);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_20 = new cjs.Graphics().p("");
	var mask_graphics_22 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:0.0174,y:-0.014}).wait(20).to({graphics:mask_graphics_20,x:0.0174,y:-0.014}).wait(1).to({graphics:null,x:0,y:0}).wait(1).to({graphics:mask_graphics_22,x:0.0174,y:-0.014}).wait(29));
...
p.nominalBounds = new cjs.Rectangle(-233.1,-120.9,600,217.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-50.5,157.3,1.0397,1.0397);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-37.6,mode:"single",startPosition:50},50).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-876.7,-986,1643.5,1307.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(0,82.75,1.9034,1.9034);
...
p.nominalBounds = new cjs.Rectangle(-823.9,-545.4,1468,1148.4);
...
if (reversed == null) { reversed = false; }
	...
	// sb_circle_copy
	this.instance = new lib.sb_circle();
	this.instance.setTransform(-764,87.7,1.3416,1.3537,0,0,0,-0.1,-0.1);
	this.instance.alpha = 0.5508;
	this.instance.compositeOperation = "screen";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0,regY:0,scaleX:1.9517,scaleY:1.9517,x:-247.1,y:661.5,alpha:1},91).wait(1));

	// sb_circle
	this.instance_1 = new lib.sb_circle();
	this.instance_1.setTransform(622.2,-301.35,0.4422,1.1946,-14.9989,0,0,0.1,-0.1);
	this.instance_1.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({regX:0.2,scaleX:0.5492,scaleY:1.4838,rotation:-2.7822,x:557.1,y:-217.55},91).wait(1));

	// sb_sc3_bgfront
	this.instance_2 = new lib.sb_sc3bgfront();
	this.instance_2.setTransform(264.3,-16.1,1.1482,1.1482);
	...
	this.instance_3.setTransform(231.65,74.45,1,1,0,0,0,255.3,48.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({startPosition:0},11).to({y:39.7},80,cjs.Ease.quadOut).wait(1));

	// an_sc3-line
	this.instance_4 = new lib.an_sc3line("synched",0,false);
	this.instance_4.setTransform(223.2,-128.3,1.3829,1.3829,0,0,0,40.1,62.6);
...
p.nominalBounds = new cjs.Rectangle(-1206.2,-719.4,2071.1,2024.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(506.4,-67.75,1.2802,1.2802,0,0,0,18.2,96.9);
	...
	this.instance_1.setTransform(-313.4,147.65);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(-523.6,83.7);
	this.instance_2._off = true;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["#000000","rgba(0,0,0,0)"],[0.427,0.969],-385.7,0,385.7,0).s().p("Eg8QAvuMAAAhfbMB4hAAAMAAABfbg");
	this.shape.setTransform(-273.175,30.375);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(74).to({_off:true},1).wait(9));
...
p.nominalBounds = new cjs.Rectangle(-1111.9,-732.4,2171.9,1841.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-207.15,86.8);
	...
	this.shape.setTransform(-74.375,-32.9);
	...
	this.shape_5.setTransform(-337.875,-32.9);
	...
	this.shape_6.setTransform(-56.025,-81.2);
	...
	this.shape_9.setTransform(-180.925,-83.35);
	...
	this.shape_10.setTransform(-224.975,-83.325);
	...
	this.shape_11.setTransform(-269.5,-83.5);
	...
	this.shape_12.setTransform(-313.8,-83.4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgFB4IAAjvIALAAIAADvg");
	this.shape_13.setTransform(-350.225,-81.2);
	...
	this.instance_1.setTransform(241.05,0);
...
p.nominalBounds = new cjs.Rectangle(-635.7,-986,1643.5,1307.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(379.05,37.6,1.2886,1.2886);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(290.4,-172.65,1.2886,1.2886);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(465.45,-94.2,1.2886,1.2886,0,0,0,0.1,0);
...
p.nominalBounds = new cjs.Rectangle(-826.4,-1107.1,1766.6,1358.6999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(520.2,-99.75,1.2271,1.2271,0,0,0,18.2,97.5);
	this.instance.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);
	...
	this.instance_1.setTransform(-545.4,63.85,1.3994,1.3994);
	this.instance_1._off = true;
...
p.nominalBounds = new cjs.Rectangle(-1206.1,-706.1,2015.6999999999998,2011.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-522,-256,0.8922,0.8922);
...
p.nominalBounds = new cjs.Rectangle(-1138.7,-1106.1,2225,2410.6);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(282.25,140.3,0.56,0.56,0,0,0,0,0.1);
...
p.nominalBounds = new cjs.Rectangle(-35.4,-337.3,925.9,1208);
// library properties:
lib.properties = {
