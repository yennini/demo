...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(376.3447,18.4478,0.9999,0.9999);
	...
	this.shape_1.setTransform(296.702,19.3227,0.9999,0.9999);
	...
	this.shape_2.setTransform(218.4092,20.0976,0.9999,0.9999);
	...
	this.shape_3.setTransform(138.9193,19.0871,0.9549,0.9549);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#CCCCCC").s().p("AAlDVIAAhLIjsAAIABhPQBKh0CXibIB8AAQioClhDBkIB5AAIAAhcIBjAAIAABcIA/AAIAABWIg/gBIAABLg");
	this.shape_4.setTransform(65.2482,18.5228,0.9999,0.9999);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.sc4nissan, new cjs.Rectangle(45.3,-5.6,356,49.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-627.15,-175.5,1.5246,1.5246);
	this.instance.compositeOperation = "lighter";

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0.1,regY:-0.1,scaleX:1.7375,scaleY:1.498,x:-328.75,y:-517.9},87).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1.5184,scaleY:1.5184,x:306.25,y:-543.2},43).to({regX:0.1,regY:-0.1,scaleX:1.7375,scaleY:1.498,x:79.9,y:-580.55},44).wait(1));

	// sc5_bg
	this.instance_2 = new lib.sc5bg();
	this.instance_2.setTransform(-300,-250);
...
p.nominalBounds = new cjs.Rectangle(-1129.8,-1074.3,1938,1401.5);
...
p.nominalBounds = new cjs.Rectangle(-189.2,-43.1,391,84);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	var mask_graphics_12 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(12).to({graphics:mask_graphics_12,x:4.6836,y:-14.0022}).wait(16));
...
p.nominalBounds = new cjs.Rectangle(-189.3,-88.1,391.1,170.5);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_79 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:48.2105,y:58.6347}).wait(79).to({graphics:mask_graphics_79,x:48.2105,y:58.6347}).wait(1).to({graphics:null,x:0,y:0}).wait(4));
...
p.nominalBounds = new cjs.Rectangle(-81.5,-50,259.5,217.3);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(0,-16.1,1.1482,1.1482);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({startPosition:0},11).to({scaleX:0.9891,scaleY:0.9891,y:-4.65,startPosition:23},80,cjs.Ease.cubicOut).wait(1));

	// sb_sc3-bgline
	this.instance_4 = new lib.sb_sc3bgline("synched",0);
	this.instance_4.setTransform(-28.9,-84.5,0.5025,0.5025,0,0,0,-0.4,-0.4);
	this.instance_4.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:0.5024,scaleY:0.5024},27).to({regY:-0.6,y:-84.6,alpha:1,startPosition:23},10).to({regY:-0.4,y:-84.5,alpha:0.4609,startPosition:0},4).to({alpha:1,startPosition:13},8).wait(43));
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("");
	var mask_graphics_67 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:0.9012,y:12.5146}).wait(67).to({graphics:mask_graphics_67,x:0.9012,y:12.5146}).wait(1).to({graphics:null,x:0,y:0}).wait(16));
...
p.nominalBounds = new cjs.Rectangle(-166.2,-115.7,334.29999999999995,256.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({startPosition:0},7,cjs.Ease.cubicOut).to({regX:-0.1,regY:0.1,scaleX:1.1743,scaleY:1.1743,rotation:0.4631,x:-44.1,y:36.1,startPosition:22},68,cjs.Ease.quintOut).wait(9));
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-63.3,157.3,1.0397,1.0397);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:-56.8,mode:"single",startPosition:50},50).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-539.4,-986,1306.1999999999998,1281.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(256.15,-115.65,1,1,0,0,0,18.2,97.6);
	...
	this.instance_1.setTransform(-296.5,189.25);
	this.instance_1._off = true;
...
p.nominalBounds = new cjs.Rectangle(-763.7,-614.1,1393.8000000000002,1578);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(256.3,-117.85,1,1,0,0,0,18.2,96.9);
	this.instance.shadow = new cjs.Shadow("rgba(0,0,0,1)",3,3,4);
	...
	this.instance_1.setTransform(-54.4,204.65);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(-298.4,151.1);
	this.instance_2._off = true;
...
p.nominalBounds = new cjs.Rectangle(-747.1,-776.7,1738.5,1715.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(17.9,-9.65);
	...
	this.shape.setTransform(240.725,-129.35);
	...
	this.shape_5.setTransform(-22.775,-129.35);
	...
	this.shape_6.setTransform(259.075,-177.65);
	...
	this.shape_9.setTransform(134.175,-179.8);
	...
	this.shape_10.setTransform(90.125,-179.775);
	...
	this.shape_11.setTransform(45.6,-179.95);
	...
	this.shape_12.setTransform(1.3,-179.85);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgFB4IAAjvIALAAIAADvg");
	this.shape_13.setTransform(-35.125,-177.65);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(192.05,225.75);
	this.instance._off = true;
	...
	this.instance_2.setTransform(89.65,-153.05);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(225.4,-92.15);
...
p.nominalBounds = new cjs.Rectangle(-1148.2,-1075.7,1937.9,1401.4);
...
p.nominalBounds = new cjs.Rectangle(-1062.4,-1074.7,2073.3,2038.1);
...
p.nominalBounds = new cjs.Rectangle(-296.7,-320.1,992.8,999.7);
// library properties:
lib.properties = {
