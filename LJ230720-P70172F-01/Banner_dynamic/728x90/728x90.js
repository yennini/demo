...
p.nominalBounds = new cjs.Rectangle(0,0,970,305);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:0,scaleX:1,scaleY:1,x:152.35,y:9.4,alpha:1},13,cjs.Ease.circInOut).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-172.2,-67.4,343,82);
...
p.nominalBounds = new cjs.Rectangle(-172.2,-181,797,354.7);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:0,scaleX:1,scaleY:1,x:-126.9,y:0,alpha:1},15,cjs.Ease.cubicOut).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-297.2,-17.5,1.3574,1.3574,0,0,0,-0.2,-0.1);
	this.instance._off = true;
	...
	this.instance_1.setTransform(792.4,65.3,1.2798,1.2798,0,0,0,201.6,38.6);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(241.45,-17.7,0.7063,0.7063,0,0,0,0.6,0.4);
	this.instance_2._off = true;
	...
	this.instance_3.setTransform(530.15,-30.05,0.9708,0.9708,0,0,0,216.7,72.2);
	this.instance_3._off = true;
	...
	// sc5_bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape.setTransform(625.6292,-74.9265,0.3729,1.8353,132.2436);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#C1E7FA","rgba(255,255,255,0)"],[0.357,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_1.setTransform(625.6292,-74.9265,0.3729,1.8353,132.2436);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape_2.setTransform(-284.2934,-143.9312,1.3696,1.4799,-20.4838);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#92D5F4","#E3F6FF","rgba(255,255,255,0)"],[0.071,0.482,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_3.setTransform(-284.2934,-143.9312,1.3696,1.4799,-20.4838);

	this.instance_4 = new lib.sc1bg();
	this.instance_4.setTransform(-1075,-413,1.9305,1.9304);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.instance_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},106).to({state:[]},1).to({state:[{t:this.instance_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},14).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1075,-854.2,2305,1420.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-293.5,-17.2,1.5871,1.5873);
	this.instance._off = true;
	...
	this.instance_1.setTransform(424.15,10.75,0.7554,0.7554,0,0,0,0.2,0.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).wait(42));

	// sb_frame
	this.instance_2 = new lib.sb_frame("synched",18);
	this.instance_2.setTransform(257.35,38.3,2.4587,2.0729,-18.5667,0,0,-0.2,0.3);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape.setTransform(537.5127,-192.5677,0.5888,1.8353,132.2436);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#C1E7FA","rgba(255,255,255,0)"],[0.357,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_1.setTransform(537.5127,-192.5677,0.5888,1.8353,132.2436);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape_2.setTransform(-526.7757,-194.624,0.9626,1.4799,-20.4838);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#92D5F4","#FFFFFF","rgba(255,255,255,0)"],[0,0.416,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_3.setTransform(-526.7757,-194.624,0.9626,1.4799,-20.4838);

	this.instance_3 = new lib.sc4bg();
	this.instance_3.setTransform(-850,-340,1.675,1.675);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(48));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1095.5,-845.2,2298.2,1301.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(460.2,13,1.5871,1.5873);
	this.instance._off = true;
	...
	this.instance_1.setTransform(-151.9,56.95,0.865,0.865,3.4518,0,0,-0.2,0.2);
	this.instance_1._off = true;
	...
	this.instance_2.setTransform(-168.35,59.8,1.0189,1.0187,-5.714,0,0,-0.4,0.2);
	this.instance_2._off = true;
	...
	// sb_frame
	this.instance_3 = new lib.sb_frame("synched",6);
	this.instance_3.setTransform(50.7,-160.2,2.4278,2.1186,24.4686);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(52).to({startPosition:18},0).to({_off:true},1).wait(7));

	// sc3_bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape.setTransform(329.8982,-40.2124,1.077,1.8353,132.2436);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#65C0EE","#C1E7FA","rgba(255,255,255,0)"],[0,0.533,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_1.setTransform(329.8982,-40.2124,1.077,1.8353,132.2436);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape_2.setTransform(-702.2341,41.618,0.7766,1.4799,-20.4838);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#3D3D3D","rgba(71,71,71,0.788)","rgba(100,100,100,0)"],[0.278,0.678,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_3.setTransform(-702.2341,41.618,0.7766,1.4799,-20.4838);

	this.instance_4 = new lib.sc3bg();
	this.instance_4.setTransform(-874,-366,1.7411,1.7411);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.instance_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},52).to({state:[]},1).wait(7));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1198,-827.8,2330.6,1575.1999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(675.9,-4.4,1.5863,1.5872,0,0,0,0.2,0);
	this.instance._off = true;
	...
	this.instance_1.setTransform(-393.8,-14.25,0.7948,0.7948,0,0,0,-0.1,0.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).wait(30));

	// sb_frame
	this.instance_2 = new lib.sb_frame("synched",19,false);
	this.instance_2.setTransform(-131.05,-5.05,2.3301,2.0525,0,-4.1913,175.809,-0.1,0.1);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape.setTransform(374.2952,-92.048,0.8878,1.8353,132.2436);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#98D4F3","#D6E9F3","rgba(255,255,255,0)"],[0,0.651,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_1.setTransform(374.2952,-92.048,0.8878,1.8353,132.2436);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape_2.setTransform(-628.3644,32.9604,0.5675,1.4799,-20.4838);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#E6DFD2","rgba(255,255,255,0)"],[0.129,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_3.setTransform(-628.3644,32.9604,0.5675,1.4799,-20.4838);

	this.instance_3 = new lib.sc2bg();
	this.instance_3.setTransform(-795,-336,1.683,1.683);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(36));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1042,-821,2165.7,1457.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-200.65,-26,1.2454,1.2454,0,0,0,-2.5,92.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(28));

	// an_sc1_car
	this.instance_1 = new lib.an_sc1_car("synched",0,false);
	this.instance_1.setTransform(562.55,-25.25,0.7334,0.7334,0,0,0,0.2,-0.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(7).to({_off:false},0).wait(21));

	// sb_frame
	this.instance_2 = new lib.sb_frame("synched",7,false);
	this.instance_2.setTransform(262.95,52.3,2.0304,2.0304,-13.9978,0,0,-2.4,2.6);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape.setTransform(541.1712,-113.0669,0.5752,1.8353,132.2436);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["#C1E7FA","rgba(255,255,255,0)"],[0.357,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_1.setTransform(541.1712,-113.0669,0.5752,1.8353,132.2436);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(255,255,255,0)").ss(1,1,1).p("EhBdg5TMCC7AAAMAAABynMiC7AAAg");
	this.shape_2.setTransform(-332.3465,-179.3215,1.2202,1.4799,-20.4838);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["#5196B9","#A9D9F2","rgba(248,252,255,0.839)","rgba(255,255,255,0)"],[0,0.231,0.769,1],-419,0,419.1,0).s().p("EhBdA5UMAAAhynMCC7AAAMAAAByng");
	this.shape_3.setTransform(-332.3465,-179.3215,1.2202,1.4799,-20.4838);

	this.instance_3 = new lib.sc1bg();
	this.instance_3.setTransform(-781,-308,1.6528,1.6531);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(28));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1002.2,-867.7,2204.8,1386.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-875,-179,1.0472,1.0472);
...
p.nominalBounds = new cjs.Rectangle(-1259,-905.1,2429.3,1579.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(394.65,76.75,0.4559,0.4559,0,0,0,0.2,0.4);
...
p.nominalBounds = new cjs.Rectangle(183.9,-291.6,744.8000000000001,676.1);
// library properties:
lib.properties = {
